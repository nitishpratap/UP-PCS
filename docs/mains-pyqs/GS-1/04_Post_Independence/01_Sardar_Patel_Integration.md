...
```mermaid
flowchart LR
  A[562 Princely States Aug 1947] --> B[Standstill Agreement]
  B --> C[Instrument of Accession]
  C --> D[Merger / Union creation]
  D --> E[Part of Indian Union 1950]
  C --> F[Holdouts: Junagadh Hyderabad Kashmir]
  F --> G[Plebiscite or Police Action]
  G --> D
```
