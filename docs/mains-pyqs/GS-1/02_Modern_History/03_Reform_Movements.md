...
```mermaid
flowchart TD
  C[Colonial critique + missionaries<br/>+ print + new middle class]
  C --> B[Bengal Brahmo<br/>Rammohan Roy · Vidyasagar]
  C --> A[Arya Samaj<br/>Dayanand 1875]
  C --> P[Phule Satyashodhak<br/>Pune 1873]
  C --> K[Narayana Guru<br/>Kerala Ezhava]
  B --> N[Nationalist public sphere<br/>Congress 1885]
  A --> N
  P --> N
```
...
```mermaid
flowchart LR
  R[Indian Renaissance<br/>reform + revival]
  R --> S[Social laws<br/>sati · widow · consent]
  R --> E[Education<br/>English + vernacular]
  R --> C[Culture<br/>press · prose · pride]
  R --> P[Political precursor<br/>public sphere → Congress]
  P --> I[Modern India<br/>nationalism · middle class]
```
