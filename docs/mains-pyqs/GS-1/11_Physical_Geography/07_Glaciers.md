...
```mermaid
flowchart TD
  W[Western / Karakoram<br/>cold · debris-covered] --> V[Variation in India]
  C[Central Himalaya<br/>clean valley glaciers] --> V
  E[Eastern Himalaya<br/>maritime · heavy snow] --> V
  V --> R[Retreat · GLOF · water supply change]
```
