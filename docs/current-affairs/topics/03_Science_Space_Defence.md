...
- Mission name, date, agency (often ISRO), rocket, and target body.

**For defence news**

- Weapon or system name, range, who made it (often DRDO), which force will use it, and where it was tested or shown.
...
| **Lunar Trailblazer** (NASA / Caltech) | **SpaceX Falcon 9** <br> (26 Feb 2025) | Planned lunar polar orbit (contact lost after launch) | • Smallsat mission to **detect and map water** (H₂O / OH / ice) on the Moon’s surface and in permanently shadowed regions.<br>• Instruments: **HVM3** spectrometer (JPL) and **Lunar Thermal Mapper (LTM)** (University of Oxford / UKSA).<br>• Rideshare with Intuitive Machines **IM-2**. Mission ended **31 July 2025** after two-way contact could not be restored.<br>• Primary objective in stems = **map lunar water**, not build a full 3D Moon model or test rovers. |
...
### Indigenous ATP and LCH names (high-yield)

- **Kavach** is India’s indigenous **Automatic Train Protection (ATP)** system for railway collision avoidance. It is **not** Rakshak / Tri-Netra / Traintel.
- **Prachand** is the IAF name of HAL’s indigenous **Light Combat Helicopter (LCH)**, inducted at **Jodhpur (October 2022)**. Dhruv / Rudra / Tejas / Cheetah are **different** platforms. If a stem asks for the LCH inducted into the IAF and **Prachand is not in the options**, the key is often **None of the above**.
...
- Maker: **DRDO**.
- User focus: **Indian Navy**.
- Reported range: about **1,500 km**.
...
- Maker: **DRDO**.
- Reported range: more than **3,500 km**.
- Platform: **INS Arighat**, India’s second nuclear-powered ballistic missile submarine in public discussion after Arihant.
- Why it matters: it strengthens the sea part of India’s nuclear triad (land, air, and sea).
...
- Special point: two missiles from one launcher in quick succession.
- Role in simple words: precise tactical strike missile.
...
### Budget push for deep tech manufacturing | 1 February 2026

These are Budget ideas, but they often appear in Science questions too. Full scheme cards are in [Schemes](02_Schemes_Policies.md).

- **ISM 2.0** for semiconductors.
- **Biopharma SHAKTI** for advanced biological medicines.
- **Rare Earth Corridors** in Odisha, Kerala, Andhra Pradesh, and Tamil Nadu.
- **Three Chemical Parks**.
- **Container Manufacturing** scheme.
- **CCUS** (Carbon Capture, Utilization and Storage) with about **₹20,000 crore** over five years.
...
- Use: better solar-cycle and space-weather understanding.
...
- More **S-400** long-range surface-to-air missile systems from Russia for the Air Force.
- **Medium Transport Aircraft** to slowly replace older transport planes such as **An-32** and help with **Il-76** class airlift needs. Indian companies will build them with a foreign technology partner.
- **Remotely Piloted Strike Aircraft** linked with DRDO’s **Ghatak** unmanned combat aircraft work. Value in reports is near **₹40,000 crore** for this line.
- More indigenous **Dhanush** 155 mm howitzer guns for the Army.
- Other Army items named in briefings: air defence tracked systems, better tank ammunition, high-capacity radio relay, and runway-independent aerial surveillance.
- Coast Guard also got approvals such as heavy-duty air cushion vehicles in coverage.

**Year context**

- In FY 2025–26, DAC AoN total was described as about **₹6.73 lakh crore** across 55 proposals — called a record year in official messaging.
...
- After this failure, the number of fully useful positioning satellites fell below the minimum **four** needed for reliable 3D fixes.
- The satellite can still be used for some one-way broadcast messaging.
...
- Sequence: third after **INS Arihant** and **INS Arighaat**.
- Project family: Advanced Technology Vessel (**ATV**) / Arihant-class line.
- Stronger second-strike capability is the strategic point.

**INS Taragiri**

- Fourth ship of **Project 17A** (**Nilgiri-class**) guided-missile stealth frigates.
...
- Foundation stone for a **Large Cavitation Tunnel** facility at DRDO’s Naval Science & Technological Laboratory.
...
- Features: low-level sea-skimming, fire-and-forget, all-weather use.
...
- Technology: **MIRV** (Multiple Independently Targetable Re-entry Vehicle).
- Linked in coverage with the advanced **Agni-5** line, earlier called **Mission Divyastra** (first known MIRV test in **March 2024**).
- Agni-5 declared range memory: over **5,000 km**.
...
- Partner countries named: Bhutan, Cambodia, Indonesia, Laos, Malaysia, Maldives, Myanmar, Nepal, Philippines, Seychelles, Sri Lanka, Vietnam, and India.

### Exercise CINBAX 2026

- Edition: **2nd**.
- Countries: **India** and **Cambodia**.
- Place in coverage: **Kampong Speu**, Cambodia.

### First woman Cat-A flying instructor | IAF
...
- Lead user service: **Indian Air Force** (Navy shipborne version expected later).
- Development clearance memory: CCS outlay about **₹21,700 crore** (2022 window).
- Fits inside the wider **Mission Sudarshan Chakra** air-defence shield idea (target horizon noted around **2035**).
...
- Rocket: **Vikram-1**.
- Mission name: **Aagaman**.
- Place: **Sriharikota**.
- Meaning: private Indian orbital launch capability arrives.

### Navy / Coast Guard July platforms

- **INS Mahendragiri** — sixth **Project 17A** stealth frigate, Eastern Fleet, Visakhapatnam.
- **Machilipatnam (BY 529)** — seventh of eight ASW Shallow Water Craft from Cochin Shipyard.
- **Operation Southern Readiness 26-2** — multinational training at Southern Naval Command, **Kochi**, with Combined Maritime Forces / CTF 154.
...
- First uncrewed **Gaganyaan** test flight expected within about four months in ISRO messaging.
- Soft policy note: ISRO to step back from routine launch-vehicle manufacturing and hand more work to private / PSU partners, while focusing on research (IN-SPACe messaging).
...
- Maker: **Indo-Russian Rifles Private Limited (IRRPL)**.
- Claim in coverage: **100%** Indian components and materials.
- Aim: replace ageing **INSAS** rifles after Army trials.

### INS Nipun and India–USA EOD exercise
