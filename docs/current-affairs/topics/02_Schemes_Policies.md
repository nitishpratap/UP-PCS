...
| Ask yourself | Why |
|--------------|-----|
| When did it start / when does it end? | Year traps are common |
| Which ministry or body runs it? | Ministry vs NITI Aayog |
| Who gets the benefit? | Farmers, women, Divyangjan, states… |
| Any exact number? | Outlay, beneficiaries, sharing ratio |
| Was an old scheme renamed or merged? | Classic false-statement bait |
...
- Money to states may depend on reform progress. Reports gave about **30%** weight to reform milestones.
- Centre–state sharing in reports: **60:40** for most states, **90:10** for North-East and Himalayan states, and **100%** for Union Territories.

**Background**

- In October 2024, the Cabinet had already approved a large outlay for PMRKVY and KY.
...
- Full form used in the Budget: **Strategy for Healthcare Advancement through Knowledge, Technology and Innovation**.
- Aim: make India a strong base for **biologics and biosimilars** (advanced biological medicines).
- Outlay: **₹10,000 crore** over **five years**.
- Plan includes **3 new NIPER** institutes and upgrading **7** existing ones.
- Plan also includes more than **1,000** accredited clinical trial sites in India.
- **CDSCO** (drug regulator) is to be strengthened for faster and more global-standard approvals.
...
- A scheme to help states set up **3 Chemical Parks**.
- A **Container Manufacturing** scheme with **₹10,000 crore** over five years.
- An integrated textile programme with five parts, including **Samarth 2.0**.
- Mega Textile Parks in challenge mode.
- **Mahatma Gandhi Gram Swaraj** initiative for khadi, handloom, and handicrafts. It also supports **ODOP** and rural youth.
- A scheme to revive **200** old industrial clusters.

### Skills, health, sports, and farming tools

- **Bharat-VISTAAR**: a multilingual AI tool to help farmers with good farming practices.
- **Divyangjan Kaushal Yojana** for skills and jobs.
- **Divyang Sahara Yojana** for good quality assistive devices.
- A high-powered **Education to Employment and Enterprise** Standing Committee for the services sector. The long-term aim noted is **10%** global share in services by **2047**.
- Support for states to set up **five Regional Medical Hubs** for medical tourism.
- **3 new All India Institutes of Ayurveda**.
- Upgrade of the **WHO Global Traditional Medicine Centre** at **Jamnagar**.
- A second **NIMHANS** (**NIMHANS-2**) planned in **North India**. Institutes at **Ranchi** and **Tezpur** are to be upgraded.
- Fisheries push: integrated work on **500 reservoirs and Amrit Sarovars**.
...
- The Commission’s recommendations were accepted for **2026–27 to 2030–31**.
- For FY **2026–27**, the Budget provides about **₹1.4 lakh crore** to states as Finance Commission grants (including local body and disaster-related grants in coverage).
...
- Aim includes developing about **100 new airports** from unused or weakly used airstrips, plus support (viability gap funding) for airlines on weak routes.
- Ministry link: **Civil Aviation**.
...
- Simple meaning: one digital system to track visas, entry, stay, and exit of foreigners for both security and ease of travel.
...
- It mixes extra war-risk cover and freight help so exporters do not stop shipments.
...
- Mascots named in compilations: **Pragati** and **Vikas**.
- Early rollout states/UTs included Andaman and Nicobar Islands, Goa, Karnataka, Lakshadweep, Mizoram, Odisha, Sikkim, and selected Delhi areas (NDMC and Delhi Cantonment).
- Phase 2 (**Population Enumeration**) is planned for **February 2027**.
- Reference date noted: **1 March 2027** (special dates for some snow-bound areas).
- Caste enumeration is planned in Phase 2 (first such nationwide caste count after **1931** in coverage).
- Approved outlay noted: about **₹11,718 crore**.
...
- About **₹4,317 crore** higher than the Kharif 2025 requirement in coverage.
...
- Period: about **five years** (**April 2026 to March 2031**).
- Ministry / department link: Food and Public Distribution.
- Aim: transparency, security, and sustainability across the PDS chain.
...
- Linked with agriculture and textiles productivity.
...
- Guarantee pattern in explainers: about **100%** for eligible MSME credit and about **50%** for specified non-MSME / airline cases.
...
- Aim includes cutting dependence on imported LNG, methanol, ammonia, and urea.

### Ayush Anudan Portal

- Launched by the **Ministry of Ayush** to manage funding proposals end-to-end (submit, verify, approve, monitor).
...
Odisha launched a **GO-EAST** investment facilitation push (Government of Odisha Eastern Investment Accelerator and Special Task Force) for eastern and north-eastern investment into backward districts.
...
- National launch place: **Mukkavaripalli**, Andhra Pradesh.
- Leaders at launch: Union Minister **Shivraj Singh Chouhan**, Andhra CM **N. Chandrababu Naidu**, Deputy CM **Pawan Kalyan**.
- Centre interim allocation noted: about **₹95,692 crore**.
- Total Centre + states in first-year coverage: about **₹1.51 lakh crore**.
- Five-year investment aim noted: about **₹7.5 lakh crore**.
- Funding pattern for most states: about **60:40** Centre–State (older wage bill was largely central).
- North-eastern and Himalayan states / UTs with legislature: about **90:10** in coverage.
- UTs without legislature: Centre bears full funding in coverage.
- Peak farm season pause allowed up to about **60 days**.
- New card name: **Gramin Rozgar Guarantee Card** (old e-KYC job cards stay valid until replaced).
...
|--------------|-------------|----------------|
| Days | 100 | **125** |
| Start of new law | — | **1 July 2026** |
| Most states’ money share | Centre paid almost all wages | About **60:40** |
| New worker card | Job card | **Gramin Rozgar Guarantee Card** |
...
- Money: about **₹84,084 crore**.
- Period: up to financial year **2030–31**.
- Simple aim: more home production of oil and gas so India imports less.
...
- Storage idea: projects need at least about **two hours** of battery storage (about **10,000 MWh** in total messaging).
- Support noted: up to about **₹1 crore per MW**.
...
### Soft education reform task force

A high-powered task force on examination reforms, led by **Nandan Nilekani**, was announced. Members named in coverage include Tapan Deka, S. Somanath, V. Kamakoti, Anita Karwal, and Amrit Lal Meena.
...
| # | Stream (easy name) | What it means |
|---|--------------------|---------------|
| 1 | Manufacturing Shakti | Make more goods in India for the world |
| 2 | Agriculture and food processing | Farm to export; brands for millets, spices, foods |
| 3 | Technology and innovation | AI, quantum, 6G, space, data centres |
| 4 | Gati Shakti | Faster roads, rail, ports, logistics |
| 5 | Raksha Shakti | Stronger home-made defence |
