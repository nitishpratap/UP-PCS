...
Before you finish reading any international news, answer these in simple words:

| Ask yourself | Why |
|--------------|-----|
| Where was it held? | City and country |
| Who went from India? | PM, President, External Affairs Minister, or someone else |
| What was decided? | Treaty, MoU, declaration, project |
| Is it binding? | Must follow, or only a promise |
| Any neighbour / trade angle? | Pipeline, bus, FTA, UPI, defence deal |
| Org head or membership? | HQ, chief, or “who is **not** a member” |
...
- India and the EU said they have **finished negotiations** on the **India–EU Free Trade Agreement**.
- Official messages called it India’s **largest FTA** with a big partner market.
- Finishing talks is **not** the same as the deal already being in force. Signature and ratification come later.
- Sensitive areas such as **dairy** and some **auto** items were described as protected in public briefings. Do not memorise fake duty tables until a clear official factsheet is locked.

**Other major outcomes**

- Both sides adopted a long-term plan titled **Towards 2030: A Joint India–European Union Comprehensive Strategic Agenda**.
- They signed a **Security and Defence Partnership**.
- They started talks on an India–EU **Security of Information Agreement**.
- They signed an MoU on **mobility** (skills, students, professionals). An EU **pilot Legal Gateway Office** in India was also announced.
- India’s **NDMA** and the EU’s disaster body **DG-ECHO** signed an arrangement on disaster risk management and emergency response.
- A **Green Hydrogen Task Force** was set up.
- The India–EU science and technology cooperation agreement was renewed for **2025–2030**.
- Exploratory talks began on India linking with the EU research programme **Horizon Europe**.
...
Trade numbers and the **RBI–ESMA** MoU are also kept under [Economy / Budget / Trade](10_Economy_Budget_Trade.md).
...
- India joined the US-led **Pax Silica Declaration**. This is about safer supply chains for critical minerals, semiconductors, and AI infrastructure.
...
The **Global Teacher Prize 2026** was announced around the same February window at the World Governments Summit in Dubai. Full card → [Awards](04_Awards.md).
...
- India, along with partners such as South Africa in coverage, opposed pushing the **Investment Facilitation for Development (IFD)** agreement in the way some members wanted.
...
- Also revise: IEP publishes the **Global Peace Index** too.
...
- Key areas named in coverage: shipbuilding, semiconductors, EV batteries, defence co-development, and a climate / clean-energy pillar.
- Both sides spoke of a time-bound review of the India–Korea **CEPA** (in force since **2010**).
...
- India is home to **five** of these (not jaguar or puma).
- HQ of IBCA: **New Delhi**.
- Seed funding memory from older notes: about **₹150 crore** for 2023–2028.
...
- Soft follow-up: France’s fuel-by-fuel exit roadmap (coal by 2030, oil by 2045, gas by 2050) appeared in the same news window.
...
- Treat exact clauses carefully; stems may twist who lifts what.
...
- Aim: relief supplies and rescue support.

### PM Modi’s June foreign honours

- **Slovakia:** **Order of the White Double Cross**, First Class (highest state honour).
- **Seychelles:** **Guardian of the Blue Horizon** (environment / sustainable development distinction in coverage).

### IBCA Summit postponed

The first **International Big Cat Alliance** Summit planned for about **1–2 June** in New Delhi was **rescheduled** so African partners could join more fully (linked with India–Africa Forum Summit timing). Theme planned for the summit: **Save Big Cats, Save Humanity, Save Ecosystem**. Expected outcome named earlier: a **Delhi Declaration**.
...
- Indian exports get duty-free access on about **99%** of trade value in explainers (up from a much smaller MFN share).
- Soft follow-up: about **7.5 lakh** Indians live in Oman in older population notes; bilateral trade is often put near **USD 12 billion**.
...
- Signed earlier: **24 July 2025** in London.
- About **99%** of Indian goods entering the UK get zero or lower duty in coverage; about **90%** of UK goods entering India get relief in UK messaging.
- **DCC** is separate: workers and employers pay social security in only one country for a period. Exemption period raised to **5 years** in Indian messaging.
...
### France social-media age ban

- France passed a bill barring children under **15** from social media (first EU country with a blanket ban in coverage). Encyclopaedias and educational sites stay open.
...
### Soft Hormuz and Nauru notes

- **Iran** and **Oman** agreed in coverage to reopen the **Strait of Hormuz** for about **60 days**, with inbound traffic near Iran and outbound near Oman.
- Pacific island **Nauru** changed its official name to the **Republic of Naoero** (code **NRO** in coverage). It remains among the world’s smallest countries.
