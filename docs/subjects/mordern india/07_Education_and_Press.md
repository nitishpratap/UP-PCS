...
> **Exam weight:** ★★★ — Wood–Hunter–Sadler–Hartog–Sargent order, Asiatic Society founder, UP newspaper places, Archbold trap, press-law sequence  
...
Two ladders run side by side: **education policy** (what got taught, and to whom) and **press control** (what got printed, and how freely). Hold both timelines first; every card below plugs into one line.
...
| Orientalist vs Anglicist | **1823–35** | Committee of Public Instruction split on how to spend the grant | Ends with **Macaulay's Minute, 1835** |
| English medium settled | **1835–54** | Downward filtration; no full system yet | Bentinck accepts the Minute |
| Full ladder | **1854** | Primary → secondary → college → university, grants-in-aid | **Wood's Despatch**; universities follow in **1857** |
| Primary review | **1882** | Local bodies, private effort encouraged | **Hunter Commission** (Ripon) |
| Tighter control | **1902–04** | Government grip on university senates | **Raleigh Commission → Universities Act 1904** (Curzon) |
| Nationalist counter-schooling | **1906** | Indians build their own colleges outside government control | **National Council of Education** (Swadeshi, Bengal) |
| University-stage fix | **1917–19** | Intermediate stage carved out; boards of secondary education | **Sadler Commission** |
...
| Press phase | Rough years | Method | Exam lock |
|-------------|-------------|--------|-----------|
...
**Why both ladders matter together:** exam stems often mix an education-body year with a press-law year in the same chronology question. Keep them on two separate mental tracks so a "1878" never gets mistaken for an education year and a "1882" never gets mistaken for Hunter's report year (Hunter is 1882 too — that is the one real overlap to watch).

> **Exam note:** Start every answer from the **phase**, not the isolated year. Macaulay is not the Despatch. Hunter is not Sadler. Hartog is not Sargent. Licensing is not liberation.

---

## 7.1 Development of Education — full timeline

- Company interest in Indian education grew after the **Charter Act of 1813**, which set aside **one lakh rupees** a year "for the revival and promotion of literature, and the encouragement of the learned natives... and for the introduction and promotion of a knowledge of the sciences."
- The same **1813 Act** allowed **Christian missionaries** into Company territory for the first time (the "pious clause"), which is why mission schools spread rapidly after this date.
...
- **National Council of Education, 1906** was the Swadeshi-era nationalist answer to Curzon's controls.
- **Sadler Commission (1917–19)** reviewed **Calcutta University** and higher education.
...
> **Exam note:** Wood is **1854**, not 1835. Sargent is **1944**, not Hunter. Hartog sits between Sadler and Wardha — **1917–19 → 1929 → 1937 → 1944**.

---

## 7.2 Orientalist–Anglicist controversy — full card

**Trigger:** the **1813 Charter Act's** ₹1 lakh grant did not say whether the money should fund classical Indian learning or English/Western learning. The **General Committee of Public Instruction (from 1823)** in Calcutta split into two camps that fought for over a decade.

**The Orientalist camp**

- Wanted the grant spent on **Sanskrit, Arabic and Persian** classical learning.
- Pointed to existing institutions worth funding: the **Calcutta Madrasa (1781)** and the **Sanskrit College, Banaras (1791)**, plus new bodies like the **Calcutta Sanskrit College (1824)**.
- Leading voice on the Committee was **H.T. Prinsep**. Earlier European orientalist scholarship (Sir **William Jones**, **H.T. Colebrooke**, **H.H. Wilson**) had already built prestige for Sanskrit and Persian studies through the **Asiatic Society**.
- Their argument: Indians already had rich learned traditions; the Company should patronise, not replace, them.
...
- Macaulay's Minute argued that a single good European library was worth more than "the whole native literature of India and Arabia," and pushed for English as the medium of higher instruction.
- He wanted a class of Indians "English in taste, in opinions, in morals, and in intellect" who would in turn spread knowledge downward to the masses — the idea later called **downward filtration**.
...
> **Exam note:** Grant (1792, early Anglicist voice) → Committee split (from 1823) → Ram Mohan Roy's 1823 letter (Indian Anglicist) → Macaulay's Minute (1835, resolution). Orientalists did **not** want English; Anglicists did **not** want Sanskrit/Arabic/Persian as the medium of higher learning.

---

## 7.3 Macaulay's Minute, 1835

- **Thomas Babington Macaulay** was Law Member of Bentinck's Council. He was not a Governor-General.
- His **Minute on Indian Education (2 February 1835)** argued for **English** as the medium of higher education.
- He wanted a class of Indians "English in taste" — the idea later called **downward filtration**.
...
> **Exam note:** Minute = **1835**. Despatch = **1854**. Hunter = **1882**.

---

## 7.4 Serampore Mission and William Carey — education outside Company control

**Serampore (Frederiksnagore)** was **Danish territory** in Bengal, so it sat outside direct Company jurisdiction — this is exactly why missionary education and printing could flourish there before the Company itself opened up.

- **William Carey**, **Joshua Marshman** and **William Ward** are together called the **Serampore Trio**, Baptist missionaries who settled at Serampore from **1800**.
- Before **1813**, the Company generally kept missionaries out of its own territory, fearing they would provoke unrest — that is exactly why the trio worked from **Danish** Serampore instead of Calcutta.
- They set up the **Serampore Mission Press (1800)**, which printed Bibles and grammars in numerous Indian languages and became one of the great early printing operations in India.
- Carey also served from **1801** as a professor of **Sanskrit, Bengali and Marathi** at **Fort William College**, the Company's own institution (Wellesley, 1800) for training young civil servants — so the same man worked inside and outside the Company system at once.
- In **1818** the trio founded **Serampore College**, meant for both theological training and general higher education, open to all faiths and communities.
...
> **Exam note:** Serampore is **Danish**, not French or British — do not confuse it with Chandernagore (French) or Chinsurah (Dutch). Carey's Fort William College post and his Serampore College are two separate institutions; keep them apart.

---

## 7.5 Wood's Despatch, 1854

- Issued in **1854** by **Sir Charles Wood**, President of the Board of Control, in **Dalhousie's** time.
- It is often called the **Magna Carta of English education in India**.
- It asked for a graded system: primary schools, secondary schools, colleges, and universities.
- It favoured **English** for higher education and **vernaculars** at the lower levels.
- It recommended setting up a **Department of Public Instruction** in each province.
- It supported teacher training (normal schools), vocational instruction, **grants-in-aid** to private schools, and encouragement of **women's education**.
...
> **Exam note:** Wood's Despatch is **1854**, under Dalhousie, not under Macaulay's 1835 Minute. Grants-in-aid and vernacular-at-lower-levels are Wood locks, not Hunter locks.

---

## 7.6 Hunter Commission, 1882

- The **Hunter Commission** is the **Indian Education Commission of 1882**, chaired by **William Hunter**.
- The Viceroy was **Ripon**.
- Its brief was to review progress since **Wood's Despatch (1854)**, with special attention to **primary education**.
- It recommended the government gradually withdraw from directly managing **secondary and collegiate** education, handing that over to private/missionary bodies with **grants-in-aid**, while focusing state effort and money on primary schooling.
- It proposed **two streams** at the secondary stage: one literary (feeding into university), one more practical/vocational (feeding into trades and administration).
...
> **Exam note:** Hunter **1882** = primary. Sadler **1917–19** = university. Hartog **1929** = primary audit again, but under the Simon Commission umbrella. Sargent **1944** = post-war plan.
...
## 7.7 Indian Universities Act, 1904

- Passed in **1904** under **Lord Curzon**.
- It followed the **Raleigh Commission (1902)**, chaired by **Thomas Raleigh**, which had reviewed university administration.
- It **reduced the size of university senates**, tightened the **affiliation** of colleges to universities, increased **government nominees** on governing bodies, and expanded official **inspection** powers.
...
> **Exam note:** Universities Act = **Curzon, 1904**, backed by the **Raleigh Commission, 1902**. First three universities = **1857**.
...
> **Exam note:** Sadler = **university-stage** reform, unlike Hunter's primary focus and Hartog's primary-wastage focus.
...
> **Exam note:** Hartog = **1929**, tied to the **Simon Commission**, primary-stage wastage. Do not confuse with Hunter (1882, also primary, but half a century earlier and not part of Simon Commission).
...
> **Exam note:** Wardha = **1937, Gandhi**. Sargent = **1944, official**. NCE = **1906, Swadeshi colleges**.
...
> **Exam note:** National Council of Education ↔ **1906, Bengal, Swadeshi**. Wardha ↔ **1937, Gandhi, craft-based primary**.
...
| Person | Linked institution | Exam tag |
|--------|--------------------|----------|
| **Jonathan Duncan** | Sanskrit College, Banaras (1791) | Did **not** found Asiatic Society |
| **David Hare** | Hindu College, Calcutta | Secular education campaigner |
| **J.E.D. Bethune** | Bethune School, Calcutta | Opened a pioneering girls' school |
| **Ishwar Chandra Vidyasagar** | Sanskrit College, Calcutta | Principal; reformer |
| **William Carey** | Fort William College + Serampore College | Both a Company teacher and an independent missionary founder |
| **William A.J. Archbold** | MAO College Aligarh; Government College Dacca; Muir Central College Allahabad | **Not** Principal of Lahore College (2024 Q136) |

> **Exam note:** Duncan = Banaras Sanskrit College, **not** Asiatic Society. Jones founded the Society. Archbold ≠ Lahore.
...
> **Exam note:** Founder = **Jones**. Hastings **declined**. Duncan = Banaras college.
...
**The control sequence, in order**

| Step | Year | Ruler / official | What it did |
|------|------|-------------------|-------------|
| **Censorship of Press Act** | **1799** | **Wellesley** | War-time **pre-censorship** of all printed matter, driven by fear of French Revolutionary ideas reaching India |
| **Licensing Regulations** | **1823** | **John Adam** (acting GG) | Required a **licence from the Governor-General-in-Council** to keep a press; used to deport editor **James Silk Buckingham** of the *Calcutta Journal* |
| **Press Act ("liberation")** | **1835** | **Charles Metcalfe** | **Repealed the 1823 licensing rule**; only a simple declaration of press location was needed — Metcalfe earned the title **"Liberator of the Indian Press"** |
| **Licensing Act** | **1857** | **Canning** | Temporary wartime licensing during the **Revolt of 1857**; lapsed after the emergency |
| **Vernacular Press Act** | **1878** | **Lytton** | Special curbs aimed only at **Indian-language** papers; required advance proof-checking |
...
> **Exam note:** First paper = **Hicky, 1780**. Licensing = **Adam 1823**. Liberation = **Metcalfe 1835**. Vernacular Press Act = **Lytton 1878**, repealed by **Ripon 1882**, not the other way round.

---

## 7.15 Newspapers and Journals

**UP match home (2022 Q117).** The local `pyq/2022` file prints "Kesari"; the standard paper is **Swadesh**.
...
**Other high-yield papers**

| Paper | Place / note |
|-------|----------------|
| Bengal Gazette | Calcutta, 1780 |
...
> **Exam note:** For 2022, lock **Swadesh–Gorakhpur**, not Kesari–Pune.
...
> **Exam note:** Tilak = Kesari (Pune). Gandhi = Young India / Harijan. Besant = New India. Buckingham = Calcutta Journal, deported 1823.

---

## Must-score locks — commission/act ↔ year ↔ core recommendation
...
7. **Archbold = Lahore College** → **incorrect** (2024 Q136). He did head Aligarh, Dacca and Muir Allahabad.
