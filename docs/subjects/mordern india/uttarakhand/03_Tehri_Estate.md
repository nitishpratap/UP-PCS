...
| Capital memory | **Tehri** (later associations also with **Narendra Nagar** under later rulers) |
...
| Early rulers sequence (ratta) | Sudarshan Shah → … → Bhawani Shah → **Pratap Shah** → … → **Narendra Shah** (20th c.) |
| End of princely order | Integration after Independence / Tehri merger politics (detail in freedom card) |
...
| Narendra Shah vs Pratap Shah | Twentieth-century ruler ≠ English-education starter |
...
## 3.2 Rulers and modernisation ratta
...
- **Bhawani Shah** sits in the middle of many lists and is a frequent wrong option on the education stem.
- **Narendra Shah** belongs to the twentieth century and is too late for the “start of English education” card.

---

## 3.3 Society and politics (bridge)

- Mission schools and state patronage slowly widen literacy in the estate.
- Praja Mandal / responsible-government demands appear in the late colonial decades — revise with Freedom Topic 4.
- After 1947 the estate’s merger into the United Provinces / later Uttar Pradesh map is the end of princely Tehri as a separate polity.
...
3. English education starts under **Pratap Shah**.
4. Narendra Shah is twentieth century — wrong for that education stem.
5. Do not answer Tehri education stems with Sudarshan Shah only because he is the founder.
...
3. **Narendra Shah started English schools** → too late.
