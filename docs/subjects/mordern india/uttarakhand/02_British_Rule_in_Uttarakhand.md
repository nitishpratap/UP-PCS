...
| Key early officer | **G. W. Traill**, Commissioner of Kumaon |
| Traill 1833 | Native doctors appointed at **Almora** |
| Nainital | Hill station rises later (**1841** tradition) — not Traill’s 1833 seat |
...
| Pair | Lock |
|------|------|
| Kamin vs Patwari (plains dump) | Hill **Kamin** = revenue collection from assigned villages |
| Traill 1833 Almora vs Nainital | Almora HQ; Nainital founded later |
...
## 2.2 Traill and early colonial administration

- **George William Traill** is the classic early Commissioner of Kumaon in coaching notes.
- In **1833** he arranges appointment of **native doctors at Almora**.
- Almora’s HQ status explains why medical appointments are not placed at Nainital in that year.
- Traill-era settlement work is the usual backdrop for later revenue vocabulary stems.

---

## 2.3 Village functionaries — Kamin

- The **Kamin** collects **land revenue** from villages assigned to him.
- He sits in the intermediary chain between cultivators and the colonial hill administration.
...
## 2.4 Labour and social burden

- Colonial hill rule relies heavily on unpaid or coerced porterage remembered as **Coolie-Begar**.
- The system becomes a mass political grievance in Kumaon and links this chapter to the national-movement card.
- Forest laws and begar together feed later people’s movements (Chipko ancestry is revised in Topic 5).

---

## Must-Score Facts

1. British hill rule from **1815**; Tehri separate.
2. Traill → native doctors at **Almora**, **1833**.
3. **Kamin** = revenue collection from assigned villages.
4. Nainital is later than Traill’s Almora medical stem.
5. Coolie-Begar is colonial labour politics — full agitation card in Freedom / People’s movements.
