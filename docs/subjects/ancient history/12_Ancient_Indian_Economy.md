...
Economy · Ancient Indian Coins · Gold Coins in India · Trade · Trade Organisations · Guilds (Shreni) · Ports · Inland Trade · Maritime Trade · Roman Trade

Taught in time-order: no coins in IVC → Vedic nishka → punch-marked silver → portrait gold → Gupta dinara.
...
**Early trade = rivers + warehouses | 2024 Q2 home**

- Texts and archaeology both show **river-ports**.
- Big towns store and pass goods. That is an **entrepot**.
- Both statements in 2024 are true.

**PYQ — UPPCS Prelims 2024, Q2**
...
**Ans: C.** Boat models = **Mohenjo-daro and Lothal**. Dockyard = Lothal.
...
- Harappan sea traffic runs from Lothal and the Makran toward the Gulf. Later west landings include Broach, Sopara, and Muziris. Later east traffic runs from Tamralipti toward Southeast Asia.
- Sailors use **monsoon** reversal. The Periplus knows that wind.
...
| Kannauj | Later entrepot (Harsha age) |
| Alamgirpur | IVC east end. **Not** a sea-port |
| Lothal / Muziris | **Not** UP |
