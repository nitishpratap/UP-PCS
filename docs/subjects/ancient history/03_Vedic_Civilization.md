...
> **Covers syllabus:** Vedic Period | Rigvedic Society | Later Vedic Society | Vedic Administration | Rigvedic Economy | Political Institutions | Sabha | Samiti | Vidhata | Vedic Literature | Four Vedas | Brahmanas | Aranyakas | Upanishads | Vedangas  
> **Sources baked in:** NCERT *Themes in Indian History* I (Ch 3–4), *Rigveda* translations, RS Sharma, UPPCS/UPSC PYQs  
> **Exam weight:** ★★★ High — Rigvedic vs Later Vedic contrast, assemblies, Vedic literature matching, Bhagadugha  
...
```
VEDIC PERIOD SPLIT:
  Early/Rigvedic ~1500–1000 BCE | Sapta Sindhu (Punjab) | Pastoral-nomadic
  Later Vedic ~1000–600 BCE | Ganga-Yamuna doab (UP heartland) | Agrarian-settled

RIGVEDIC SOCIETY:
  Pastoral | Cattle = wealth (gavishti = cattle raid) | Tribal jana/vis
  Rajan = chief (NOT absolute king) | Women: some education, public presence
  Varna concept emerging (NOT full caste system) | No iron, no coins

LATER VEDIC SOCIETY:
  Agrarian + iron plough | Janapadas (territorial kingdoms) | Landlordism begins
  4 Varnas rigid: Brahmana > Kshatriya > Vaishya > Shudra
  Women status declined | Upanishadic philosophy | Painted Grey Ware (PGW) culture link

POLITICAL INSTITUTIONS & ASSEMBLIES:
  Sabha = assembly of elders/nobles (later: exclusive)
  Samiti = general tribal assembly (people's voice)
  Vidhata = deliberative assembly (earliest; economic + martial matters)
  All three checked king's power in Rigvedic period

KEY OFFICIALS:
  Rajan = king/chief | Purohita = priest (Vasishtha/Visvamitra type)
  Senani = army commander | Gramani = village head
  Bhagadugha = revenue collector ← UPPCS 2023 Q26 answer D
  Sangrahitri = treasurer/chamberlain

FOUR VEDAS:
  Rigveda = oldest (1028 hymns, 10 mandalas) | Samaveda = melodies
  Yajurveda = sacrificial formulas | Shukla = Vajasaneyi ← 2018 Q13
  Krishna Yajurveda = Taittiriya, Kathaka, Maitrayani
  Atharvaveda = spells, medicine, daily life (newest)

VEDIC LITERATURE LAYERS:
  Samhitas → Brahmanas (ritual prose) → Aranyakas (forest) → Upanishads (philosophy)
  Vedangas (6): Shiksha, Kalpa, Vyakarana, Nirukta, Chhanda, Jyotisha

UP FOCUS:
  Later Vedic expansion into Kuru-Panchala, Kosala, Kashi (Varanasi), Videha (Bihar)
  Ganga-Yamuna doab = UP core of Later Vedic culture
  Iron Age + PGW sites in western UP (doab)
```
...
|------|---------------------|-------|
| **Rigvedic vs Later Vedic** | Pastoral-nomadic (Sapta Sindhu) vs agrarian-settled (Gangetic plain) | ऋग्वेदिक / उत्तर वैदिक |
| **Sabha vs Samiti** | Sabha = elders/nobles assembly; Samiti = general tribal assembly | सभा / समिति |
| **Sabha vs Vidhata** | Sabha = political-elite; Vidhata = deliberative (economic/martial matters) | सभा / विधाता |
| **Rajan vs Raja** | Rigvedic Rajan = elected chief; Later Vedic Raja = hereditary king | राजन् / राजा |
| **Shukla vs Krishna Yajurveda** | Shukla (White) = Vajasaneyi; Krishna (Black) = Taittiriya, Kathaka, Maitrayani | शुक्ल / कृष्ण यजुर्वेद |
| **Samhita vs Brahmana** | Samhita = hymns/mantras; Brahmana = ritual explanation prose | संहिता / ब्राह्मण |
| **Aranyaka vs Upanishad** | Aranyaka = forest ritual texts; Upanishad = philosophy (Brahman/Atman) | आरण्यक / उपनिषद |
| **Varna vs Caste** | Varna = four-fold occupational division (Later Vedic); Jati = birth-based caste (later) | वर्ण / जाति |
| **Gavishti vs Bali** | Gavishti = cattle raid/war; Bali = tax/tribute to king | गविष्टि / बलि |
| **Bhagadugha vs Sangrahitri** | Bhagadugha = revenue/share collector; Sangrahitri = treasurer | भागदुघ / संग्रहीतृ |

### Memory Tricks

| Trick | Remembers |
|-------|-----------|
| **R-L-P-A** | Rigvedic = Pastoral; Later Vedic = Agrarian (2020 Q21) |
| **S-S-V** | Sabha (elders), Samiti (people), Vidhata (deliberative) |
| **Bhaga = Share** | Bhagadugha collects king's share/revenue (2023 Q26) |
| **Shukla = White = Vajasaneyi** | 2018 UPPCS Shukla Yajurveda answer |
| **Krishna = Taittiriya** | Black Yajurveda schools |
| **R-S-Y-A** | Rig, Sama, Yajur, Atharva (age order) |
| **6 Vedangas = SKVKCJ** | Shiksha, Kalpa, Vyakarana, Nirukta, Chhanda, Jyotisha |
| **1028-10** | Rigveda: 1028 hymns, 10 mandalas |
| **Sabha lost power** | Later Vedic = assemblies weakened, king absolute |
| **Doab = UP Later Vedic** | Ganga-Yamuna = eastern shift |
...
| Term | Meaning |
|------|---------|
| **Vedic Period** | Era when Indo-Aryan culture and Vedic Sanskrit texts developed in the Indian subcontinent |
| **Early/Rigvedic Period** | c. **1500–1000 BCE** — oldest Vedic texts; Sapta Sindhu region |
| **Later Vedic Period** | c. **1000–600 BCE** — expansion to Gangetic plain; complex society |
| **Sapta Sindhu** | "Land of Seven Rivers" — Punjab region; Rigvedic heartland |
...
- Sapta Sindhu = Rigvedic heartland (Punjab)
- Later Vedic core = Ganga-Yamuna doab (UP)
- PGW culture = archaeological correlate
- Iron plough = Later Vedic marker
- Ends ~600 BCE with Mahajanapadas
- Vedic Sanskrit = liturgical language

### PYQs — Vedic Period

1. **(UPPCS Prelims 2020, Q21)** Society-economy match: Rigvedic = Pastoral; Later Vedic = Agrarian; IVC = Urban.  
   → **Option D (4-3-1-2):** IVC=Urban, Later Vedic=Agrarian, Rigvedic=Pastoral, Medieval=Landlordism.

2. **(UPSC Prelims 2019 — pattern)** The Later Vedic period is associated with:  
   → **Expansion into Gangetic plains, iron use, janapadas, rigid varna.**

### Examples (3.1)

| Example | Detail |
|---------|--------|
| **Sapta Sindhu** | Rigveda geographic core |
| **Kuru-Panchala** | Later Vedic kingdom in UP-Haryana |
| **PGW sites** | Hastinapur, Atranjikhera (doab) |
...
### PYQs — Rigvedic Society

1. **(UPPCS Prelims 2020, Q21)** C. Rigvedic Society — 1. Pastoral → **Rigvedic = Pastoral.**

2. **(UPSC Prelims 2018 — pattern)** Rigvedic society was primarily:  
   → **Pastoral and tribal.**
...
| Example | Detail |
|---------|--------|
| **Apala** | Rigvedic woman poet-sage |
| **Gavishti** | Inter-tribal cattle raids |
| **Purusha Sukta** | Varna origin hymn (Rigveda X.90) |
...
- Agrarian with iron plough
- Gangetic plain settlement (UP, Bihar)
- Janapadas emerge
- Varna system rigidified
- Women status declined
- Gotra exogamy rules
- Land grants to Brahmins begin
- Upanishadic philosophy emerges
- Assemblies (sabha/samiti) lose power

### PYQs — Later Vedic Society

1. **(UPPCS Prelims 2020, Q21)** B. Later Vedic Society — 3. Agrarian → **Later Vedic = Agrarian.**

2. **(UPSC Prelims 2017 — pattern)** Which development marks the Later Vedic period?  
   → **Iron plough, rigid varna, janapadas, Gangetic expansion.**

### Examples (3.3)

| Example | Detail |
|---------|--------|
| **Kuru-Panchala** | Later Vedic kingdom (UP-Haryana) |
| **Kashi (Varanasi)** | Emergent urban centre |
| **Brahmadeya grants** | Land to priests — landlordism seed |
...
### PYQs — Vedic Administration

1. **(UPPCS Prelims 2023, Q26)** Which officer was known as 'Bhagadugha' during Vedic administration?  
   A. Messenger  B. Chief Officer of Forests  C. Chief Officer of Gambling  D. Revenue Collector  
   → **D — Revenue Collector** (collected king's bhaga/share).

2. **(UPSC Prelims 2019 — pattern)** Purohita in Vedic period was:  
...
| Example | Detail |
|---------|--------|
| **Bhagadugha** | 2023 UPPCS direct question |
| **Vasishtha** | Legendary purohita of Sudas |
| **Gramani** | Village-level administration |
...
- Gavishti = economic-military cattle raids
- Barter economy
- Nishka = gold ornament (value standard)
- No coins, no iron
- Limited agriculture (barley)
- Dakshina = priestly fees
- Copper/bronze tools
- No private land ownership

### PYQs — Rigvedic Economy

1. **(UPPCS Prelims 2020, Q21)** Rigvedic = Pastoral economy type.

2. **(UPSC Prelims 2016 — pattern)** In Rigvedic period, wealth was measured in terms of:  
   → **Cattle (cows).**
...
| Example | Detail |
|---------|--------|
| **Gavishti** | Cattle raid as wealth acquisition |
| **Nishka** | Gold necklace as value unit |
| **Dakshina** | Priest payment after yajna |
...
- Tribal polity with elected elements
- Rajan + Purohita + Senani structure
- Sabha, Samiti, Vidhata check king
- Later Vedic = hereditary kingship
- Ashvamedha, Rajasuya royal rituals
- Janapada replaces tribal jana
- Custom-based law (dharma)
- No written constitution

### PYQs — Political Institutions

1. **(UPSC Prelims 2018 — pattern)** Vedic political institutions included:  
   → **Sabha, Samiti, Vidhata as assemblies limiting royal power.**

2. **(UPSC Prelims 2015 — pattern)** Ashvamedha sacrifice was performed to:  
   → **Assert royal sovereignty over territory.**

### Examples (3.6)

| Example | Detail |
|---------|--------|
| **Ashvamedha** | Territorial sovereignty ritual |
| **Janapada** | Territorial state unit |
| **Sudas vs Ten Kings** | Rigvedic Battle of Ten Kings (Dāśarājñá) |
...
1. **(UPSC Prelims 2019 — pattern)** In Rigvedic period, Sabha was:  
   → **Assembly of elders/nobles; women could attend.**

2. **(UPSC Prelims 2017 — pattern)** Which Vedic assembly was exclusive to nobles in Later Vedic period?  
   → **Sabha.**
...
| Example | Detail |
|---------|--------|
| **Sabha vadhu** | Woman participating in Sabha (Rigveda) |
| **Later exclusion** | Women barred in Later Vedic Sabha |
| **Modern trap** | Gram Sabha (73rd Amendment) ≠ Vedic Sabha |
...
- General tribal assembly
- Broader than Sabha
- Role in electing Rajan (early)
- Military and major policy decisions
- Popular freemen participation
- Declined in Later Vedic period
- Paired with Sabha to limit king
- Precursor to republican gana-sanghas

### PYQs — Samiti

1. **(UPSC Prelims 2018 — pattern)** Samiti in Vedic period was:  
   → **General assembly of the tribe; broader than Sabha.**

2. **(UPSC Prelims 2016 — pattern)** Which assembly elected the Rajan in early Vedic period?  
   → **Samiti** (with Sabha participation).

### Examples (3.8)

| Example | Detail |
|---------|--------|
| **Rajan election** | Samiti role in chief selection |
| **Battle of Ten Kings** | Samiti-level tribal coalition |
| **Licchavi gana** | Later republic echo of Samiti tradition |
...
- Deliberative assembly (Rigveda)
- Economic distribution and feasting role
- Women participated
- Military deliberation function
- Declined in Later Vedic period (earliest to fade)
- Distinct from Sabha and Samiti
- Collective tribal decision-making
- Rigvedic democratic institution

### PYQs — Vidhata

1. **(UPSC Prelims 2019 — pattern)** Vidhata in Rigvedic period functioned as:  
   → **Assembly for distribution of goods and deliberation; women participated.**

2. **(UPSC Prelims 2015 — pattern)** Which Vedic assembly declined first?  
   → **Vidhata** (among Sabha, Samiti, Vidhata).

### Examples (3.9)

| Example | Detail |
|---------|--------|
| **Rigveda hymns** | Women at Vidhata gatherings |
| **Post-raid distribution** | Economic redistribution function |
| **Early decline** | Absent from Later Vedic texts |
...
| Term | Meaning |
|------|---------|
| **Shruti** | "Heard" — revealed sacred literature (Vedas, Brahmanas, Aranyakas, Upanishads) |
| **Smriti** | "Remembered" — later traditional texts (not Vedic period but contrast term) |
| **Samhita** | Collection of hymns/mantras in each Veda |
...
- Oral transmission (shruti)
- Four layers: Samhita, Brahmana, Aranyaka, Upanishad
- Guru-shishpa parampara
- Vedic Sanskrit language
- Shakhas = regional recensions
- Sayana = medieval commentator (not Vedic)
- Chronology: Rigveda oldest
- Composed over centuries

### PYQs — Vedic Literature

1. **(UPSC Prelims 2018 — pattern)** Shruti literature includes:  
   → **Vedas, Brahmanas, Aranyakas, Upanishads.**

2. **(UPSC Prelims 2016 — pattern)** Vedic texts were preserved through:  
   → **Oral tradition (guru-shishya).**

### Examples (3.10)

| Example | Detail |
|---------|--------|
| **Oral chain** | Precise phonetic preservation |
| **Shakhas** | Regional Vedic schools |
| **Eastern composition** | Later texts in Gangetic kingdoms |

---

## 3.11 Four Vedas

### Four Vedas — Complete Table

| # | Veda | Content | Age | Speciality |
|---|------|---------|-----|------------|
| 1 | **Rigveda** | 1028 hymns, 10 mandalas | Oldest (~1500 BCE) | Praise of gods; Indo-Aryan entry evidence |
| 2 | **Samaveda** | 1549 verses (mostly from Rigveda) | Second | Sung during Soma sacrifice; melodies (saman) |
| 3 | **Yajurveda** | Sacrificial formulas (yajus) | Third | Ritual prose + mantras; Shukla vs Krishna |
| 4 | **Atharvaveda** | Spells, charms, medicine | Newest (~1000 BCE) | Daily life, magic, healing; 20 books |
...
- Rigveda: 1028 hymns, 10 mandalas (oldest)
- Samaveda: melodies from Rigveda
- Yajurveda: sacrificial formulas
- Shukla = Vajasaneyi | Krishna = Taittiriya, Kathaka, Maitrayani
- Atharvaveda: spells, medicine (newest)
- Gayatri Mantra = Rigveda
- Purusha Sukta = varna hymn
- Veda Vyasa = traditional compiler

### PYQs — Four Vedas

1. **(UPPCS Prelims 2018, Q13)** Which is a Samhita of Shukla Yajurveda?  
   A. Vajasanami  B. Maitrayani  C. Taittiriya  D. Kathak  
   → **A — Vajasaneyi** (Vajasanami = OCR typo). B/C/D = Krishna Yajurveda.

2. **(UPSC Prelims 2019 — pattern)** Which Veda is the oldest?  
   → **Rigveda.**
...
| Example | Detail |
|---------|--------|
| **Gayatri Mantra** | Rigveda III.62.10 |
| **Vajasaneyi** | 2018 UPPCS Shukla Yajurveda |
| **Atharvaveda iron** | Later technological reference |
...
### Brahmanas — Complete Table

| Brahmana | Attached Veda | Notable content |
|----------|---------------|-----------------|
| Aitareya | Rigveda | Rajasuya, royal rituals |
| Kausitaki (Shankhayana) | Rigveda | Funeral rites |
| Shatapatha | Yajurveda (Shukla) | Largest; 100 chapters; horse sacrifice |
| Taittiriya | Yajurveda (Krishna) | Agrarian rituals |
| Tandya (Panchavimsha) | Samaveda | Soma sacrifice |
| Jaiminiya | Samaveda | Ritual melodies |
| Gopatha | Atharvaveda | Only Atharva Brahmana |

### Exam Facts (raata)

- Prose ritual commentaries
- Shatapatha Brahmana = largest (100 chapters)
- Aitareya = Rigveda Brahmana
- Explain yajna procedures
- Later Vedic Sanskrit prose
- Priest role manuals
- Mythological ritual origin stories
- Bridge to Aranyakas/Upanishads

### PYQs — Brahmanas

1. **(UPSC Prelims 2018 — pattern)** Shatapatha Brahmana is attached to:  
   → **Yajurveda (Shukla/Vajasaneyi).**

2. **(UPSC Prelims 2016 — pattern)** Brahmanas are written in:  
   → **Prose (ritual explanation).**

### Examples (3.12)

| Example | Detail |
|---------|--------|
| **Shatapatha Brahmana** | Ashvamedha ritual details |
| **Aitareya Brahmana** | Rajasuya consecration |
| **Taittiriya Brahmana** | Krishna Yajurveda rituals |
...
- "Forest books" for hermits
- Transitional to Upanishads
- Aitareya, Taittiriya, Brihadaranyaka Aranyakas
- Symbolic/meditative ritual interpretation
- Vanaprastha ashrama context
- Secret/esoteric teachings
- Late Vedic prose
- Brihadaranyaka merges into Upanishad

### PYQs — Aranyakas

1. **(UPSC Prelims 2019 — pattern)** Aranyakas are:  
   → **Forest texts; bridge between Brahmanas and Upanishads.**

2. **(UPSC Prelims 2017 — pattern)** Brihadaranyaka is both Aranyaka and:  
   → **Upanishad** (attached to Shukla Yajurveda).

### Examples (3.13)

| Example | Detail |
|---------|--------|
| **Taittiriya Aranyaka** | Krishna Yajurveda forest text |
| **Brihadaranyaka** | Largest Upanishad origin |
| **Vanaprastha** | Life stage for Aranyaka study |
...
### Principal Upanishads — Complete Table

| # | Upanishad | Veda | Key teaching |
|---|-----------|------|--------------|
| 1 | Brihadaranyaka | Shukla Yajurveda | Brahman-Atman; Yajnavalkya-Maitreyi dialogue |
| 2 | Chandogya | Samaveda | "Tat Tvam Asi" (Uddalaka-Shvetaketu) |
| 3 | Isha | Shukla Yajurveda | Short; God in all things |
| 4 | Kena | Samaveda | Nature of Brahman |
| 5 | Katha | Krishna Yajurveda | Nachiketa-Yama; immortality |
| 6 | Mundaka | Atharvaveda | Knowledge vs ignorance |
| 7 | Mandukya | Atharvaveda | Om (AUM); consciousness states |
| 8 | Prashna | Atharvaveda | Six questions on cosmology |
| 9 | Taittiriya | Krishna Yajurveda | Five sheaths (koshas) |
| 10 | Aitareya | Rigveda | Creation of Atman |
...
- Question external ritualism

### PYQs — Upanishads

1. **(UPSC Prelims 2019 — pattern)** "Tat Tvam Asi" is from:  
   → **Chandogya Upanishad.**

2. **(UPSC Prelims 2018 — pattern)** Nachiketa appears in:  
   → **Katha Upanishad.**
...
| Example | Detail |
|---------|--------|
| **Yajnavalkya-Maitreyi** | Brihadaranyaka dialogue on immortality |
| **Nachiketa** | Katha Upanishad — death and afterlife |
| **Janaka of Videha** | Patron of Upanishadic debates |
...
|---|---------|---------|------------------|
| 1 | **Shiksha** | Phonetics/pronunciation | Panini's precursor texts; Pratishakhyas |
| 2 | **Kalpa** | Ritual sutras (Shrauta, Grihya, Dharma) | Baudhayana, Apastamba |
| 3 | **Vyakarana** | Grammar | **Panini** — Ashtadhyayi (classical, post-Vedic) |
| 4 | **Nirukta** | Etymology/word explanation | **Yaska** — oldest Indian etymology text |
| 5 | **Chhanda** | Prosody/meter | Pingala — Chandovichiti |
...
- Six limbs: Shiksha, Kalpa, Vyakarana, Nirukta, Chhanda, Jyotisha
- Yaska = Nirukta (etymology)
- Panini = Vyakarana (grammar)
- Kalpa = ritual sutras (3 types)
- Jyotisha = ritual astronomy
- Shiksha = phonetics
- Chhanda = meter/prosody
- Aid oral Vedic preservation

### PYQs — Vedangas

1. **(UPSC Prelims 2019 — pattern)** Which is NOT a Vedanga?  
   A. Shiksha  B. Kalpa  C. Upanishad  D. Jyotisha  
   → **C — Upanishad** (not Vedanga).

2. **(UPSC Prelims 2017 — pattern)** Nirukta (etymology) was composed by:  
   → **Yaska.**
...
| Example | Detail |
|---------|--------|
| **Yaska's Nirukta** | Vedic word dictionary |
| **Panini's Ashtadhyayi** | Sanskrit grammar |
| **Vedanga Jyotisha** | Vedic astronomical text |
...
|---------|------------------|-------------|
| Period | ~1500–1000 BCE | ~1000–600 BCE |
| Region | Sapta Sindhu (Punjab) | Ganga-Yamuna doab (UP) |
| Economy | Pastoral | Agrarian (iron plough) |
| Polity | Tribal chief (Rajan) | Hereditary king |
| Assemblies | Sabha, Samiti, Vidhata strong | Assemblies weakened |
| Women | Higher status; composed hymns | Declined status |
| Varna | Flexible | Rigid four-fold |
| Literature | Rigveda Samhita | Brahmanas, Aranyakas, Upanishads |
| Settlements | Nomadic/temporary | Permanent janapadas |

### Vedic Officials — Quick Match

| Officer | Function | PYQ |
|---------|----------|-----|
| Rajan | King/chief | — |
| Purohita | Priest-minister | — |
| Senani | Army commander | — |
| Gramani | Village head | — |
| **Bhagadugha** | **Revenue collector** | **2023 Q26** |
| Sangrahitri | Treasurer | — |

### Yajurveda Samhitas — Trap Table

| Samhita | Yajurveda type |
|---------|----------------|
| **Vajasaneyi (Madhyandina, Kanva)** | **Shukla (White)** ← 2018 Q13 |
| Taittiriya | Krishna (Black) |
| Kathaka | Krishna (Black) |
| Maitrayani | Krishna (Black) |

### UP Focus — Later Vedic in Uttar Pradesh

| Element | Detail |
|---------|--------|
| **Kuru-Panchala** | Core Later Vedic kingdom (western UP-Haryana) |
| **Kosala** | Eastern UP (Ayodhya region) |
| **Kashi** | Varanasi — emerging urban centre |
| **Videha** | Mithila (Bihar border) — Janaka's kingdom |
| **Doab** | Ganga-Yamuna = UP heartland of Later Vedic culture |
| **PGW sites** | Hastinapur, Atranjikhera, Kaushambi (UP) |
| **Iron Age** | Western UP doab — iron plough adoption |

### Literature Chronology

| Layer | Text type | Period |
|-------|-----------|--------|
| Samhitas | Hymns/mantras | Rigvedic–Later Vedic |
| Brahmanas | Ritual prose | Later Vedic |
| Aranyakas | Forest texts | Later Vedic |
| Upanishads | Philosophy | ~800–600 BCE |
| Vedangas | Auxiliary sciences | Late Vedic–post-Vedic |
...
**Q26.** Which officer was known as 'Bhagadugha' during Vedic administration?
...
**Q13.** Which of the following is a Samhita of Shukla Yajurveda?
...
**Pattern — Assemblies:** Sabha (elders), Samiti (general), Vidhata (distributive).

**Pattern — Oldest Veda:** Rigveda.

**Pattern — "Tat Tvam Asi":** Chandogya Upanishad.

---

## Common Traps — Don't Fall For These

1. **Bhagadugha = Revenue Collector** — NOT messenger/forest officer (2023 Q26).
2. **Shukla Yajurveda = Vajasaneyi** — NOT Taittiriya/Maitrayani (2018 Q13).
3. **Rigvedic = Pastoral** — NOT agrarian (2020 Q21).
4. **Later Vedic = Agrarian** — NOT pastoral (2020 Q21).
5. **Vedic Sabha ≠ Lok Sabha / Gram Sabha** — modern institutions trap.
6. **Taittiriya, Kathaka, Maitrayani = Krishna (Black)** Yajurveda.
7. **Upanishad is NOT a Vedanga** — it is Shruti/Vedanta.
8. **Rigvedic women had higher status** — decline is Later Vedic only.
9. **Nishka = gold ornament** — NOT a coin.
10. **Aranyaka ≠ Brahmana** — forest/hermit texts vs ritual prose.
11. **Atharvaveda = newest Veda** — NOT oldest.
12. **Sapta Sindhu = Punjab** — NOT Gangetic UP (that's Later Vedic).
13. **Vidhata ≠ Sabha** — different functions (economic vs political-elite).
14. **Charaka Samhita = medicine** — NOT Vedic (2023 Q25 trap in same paper).
15. **Assemblies weakened** in Later Vedic — king became hereditary and absolute.
