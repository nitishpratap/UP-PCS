...
- Keep this chapter focused on **capital, chronology band, and transition**; put detailed temple–administration dumps in the Medieval UK Katyuri file when that file is built.
...
3. Brahmapura (Hiuen Tsang) ≠ Kartikeyapur capital.
4. Kuninda coins come **before** Kartikepur kingship.
5. Full Chand/Parmar story = Medieval UK folder.
