# Topic 18 — Political Parties & Pressure Groups
...
- Until 1985, parties were almost entirely **extra**-constitutional.
- RPA: **s.29A** registration · **s.29B/29C** (bonds era / donation reports — bonds **struck Feb 2024**).
- Whip / defection: 52nd/1985 10th Sch; 91st merger needs 2/3.
- Funding: **s.29C** donation reports · IT **13A**. Electoral bonds **struck Feb 2024** (*ADR*). Corporate 7.5% cap was removed in 2017 — don’t write it as current law.

---

## Functions of a political party

- Interest **aggregation** — turns caste / region / class demands into a manifesto.
- Elite **recruitment** — supplies CMs, ministers, MPs.
- Government / opposition — majority **forms**; rest **criticises** (official opposition needs **10%** of the House).
- Political **socialisation** — cadres, campaigns, booth work.
- Link: citizen ↔ State. Without parties, FPTP still needs a **label + symbol**.

---

## Features of the Indian party system (the missing Laxmikanth card)
...
- **Poor inner democracy** — no binding statute. ECI guidelines on office-bearers / elections inside parties — **soft**.
- **Extra-constitutional origin** — parties older than the Republic (INC **1885**); Constitution caught up via **10th Schedule (1985)**.
- **Coalition arithmetic** — Centre **1989–2014** and again **2024**; States since **1967**.

---

## Registration vs recognition vs symbol

**s.29A registers; Symbols Order 1968 recognises.** Do not merge.

- **Register** — **s.29A** RPA 1951 → ECI. Result: **RUPP** — can contest, **no** reserved symbol.
- **Recognise** — **Election Symbols (Reservation and Allotment) Order, 1968**. Result: **National** or **State** party.
- **Symbol** — same Order. **Reserved** (recognised) vs **free** (RUPP + independents).
- **Split** — **Para 15** of the Order. ECI allots **name + symbol** (*Sadiq Ali*). Legislature majority is **a** test, not the only test.
...
**Election Symbols (Reservation and Allotment) Order, 1968** — ECI, **324 + RPA**. Not an Act of Parliament.

- **Reserved:** national party = **same symbol in every State**. State party = reserved **in that State**; elsewhere it is a free/other symbol.
- **Free:** independents + RUPPs pick from the State free list.
- **Para 15** split: ECI decides which faction gets **name + symbol** (*Sadiq Ali* 1972). Tests: party constitution, legislative majority, organisational majority — **not** Speaker.
- BSP–Assam: **elephant** is reserved for BSP **except Assam** (already reserved there for another party historically).
- SP = **bicycle** (not “cycle” as a separate symbol).
- A national reserved symbol is **never** a free symbol in any State.
...
**Ans: A.** TDP **1982** → BSP **1984** → SP **1992** → TMC **1998**.
...
**India is a multi-party system** (Duverger: FPTP *tends* to two parties — India is the exception because of **region, caste, language**).

- **1952–67** — Rajni Kothari’s **Congress system**: one dominant party, opposition fragmented.
- **1967** — first big **non-Congress** coalitions in States (SVD). Congress majority at Centre survives.
- **1977** — first **non-Congress** Centre — Janata (coalition).
- **1989–2014** — **coalition era** at the Centre (NF / UF / NDA / UPA).
- **2014–19 / 2019–24** — BJP **single-party majority** (still a multi-party *system*).
- **2024** — BJP **240**, short of 272. **NDA coalition** government.

**Types of party system (Sartori / textbook):** one-party · two-party · **multi-party** · dominant-party. India = **multi-party** with **bipolar coalitions** at the Centre in some decades (NDA vs UPA), **not** a two-party system.

**Not** a two-party system. **Not** a one-party State. Dominant-party **phases** ≠ one-party *system*.

---

## Coalition government

**Two or more parties share the Council of Ministers** (or a party governs with **outside** support).

- **Pre-poll** — alliance **before** counting (NDA, UPA as brands).
- **Post-poll** — bargain **after** a hung House.
- **Minority govt** — cabinet from one/few parties; majority on the floor from **outside** support (e.g. UF 1996–98).
- Centre markers: **1977** Janata · **1989** National Front · **1996** United Front · **1998–2004** NDA · **2004–14** UPA · **2024** NDA again without a BJP solo majority.
- Cost: Common Minimum Programme · gathbandhan instability · policy veto by a small ally.
- State: same logic. Floor test = *Bommai* (majority on the floor, not Raj Bhavan).
...
**SP (1992) and BSP (1984)** — UP’s two regional poles. BSP **is** national; SP is a **State** party.

- BSP: national party; elephant; Kanshi Ram → Mayawati. Four UP CM terms: 1995, 1997, 2002–03, **2007–12** (majority).
- SP: **bicycle** symbol; Mulayam → Akhilesh. CM 1990s / 2003 / 2012.
- Coalitions in UP: **1993** SP–BSP · **1995 / 2002** BSP–BJP · 2017 onwards BJP-led.
- RLD: **1996**, Ajit Singh — western UP Jats; often a coalition add-on.
- Apna Dal (S) / NISHAD: smaller UP allies of BJP after 2017.
- 2022 chronology PYQ built on **TDP + BSP + SP + TMC** — two of four are UP parties.

---

## Pressure groups & interest groups

| | **Political party** | **Pressure / interest group** |
|--|--------------------|-------------------------------|
| Aim | Win **office** | Influence **policy** without (usually) contesting |
| Accountable | To voters via elections | To members / donors |
| Programme | Wide manifesto | Narrow interest |

**Interest group** = organised around a shared interest. It becomes a **pressure group** when it **pressures** the government (lobby, strike, PIL, media, dharna). Indian papers often treat the two as **near-synonyms** — still learn the distinction.
...
**Farm 2020–21 (SKM)** = associational pressure; three farm laws **repealed Nov 2021**. Business chambers after **1991** liberalisation = classic protective groups.

**Indian map (learn 2 per row):**

- Business: **FICCI 1927** · ASSOCHAM **1920** · CII (rebrand **1992**; roots 1895) · NASSCOM **1988**.
- Labour: AITUC / INTUC / BMS / CITU — union card below.
- Farmers: AIKS **1936** · BKU · Shetkari Sanghatana (Sharad Joshi) · SKM **2020–21**.
...
- **AITUC — 31 Oct 1920** (oldest central) — **CPI**.
- **INTUC — 1947** — **INC**.
- **HMS — 1948** — socialists.
- **UTUC — 1949** — **RSP** (not CPI / CPI-M).
...
**Q1.** With reference to political parties in the constitutional scheme, which of the following statements is/are correct?

1. Main hooks include Article 19(1)(c), the Tenth Schedule, and Article 324.
2. Parties were largely extra-constitutional until the 52nd Amendment inserted anti-defection.
...
**Logic:** Sparse constitutional naming + 52nd milestone.
...
1. National party route — 6% votes in four States plus four Lok Sabha seats (one route)
2. State party route — 8% of votes even with zero seats (one route)
3. Reserved symbol — unrecognised parties and independents
...
**Ans: B.** Pair 3 is wrong — reserved symbols go to recognised parties.

**Logic:** Free symbols for unrecognised/independents.

</details>

**Q4.** Given below are two statements, one labelled as Assertion (A) and the other as Reason (R).

Assertion (A): As of the 2024–26 teaching set there are six national parties including AAP, BSP, BJP, CPI(M), INC, and NPP.

Reason (R): CPI lost national status in 2023; NPP was the first north-eastern national party (2019).
...
**Ans: D.** Both true and R supports the current six-party national roster described in A.

**A/R logic:** Roster + CPI drop + NPP first NE national.
...
**Logic:** Do not swap AITUC/CITU or INTUC/BMS.

</details>

**Q6.** Arrange the following party founding years in correct chronological order:
...
**Ans: B.** 1982 → 1984 → 1992 → 1998.

**Logic:** TDP → BSP → SP → TMC.
...
**Q9.** With reference to Sarkaria’s invite order for a hung House, which of the following is/are correct?

1. Pre-poll alliance → largest single party → post-poll alliance, then floor test.
2. After Bommai, majority is tested on the House floor, not by Raj Bhavan arithmetic alone.
...
**Logic:** Invite order + floor test.

</details>

**Q10.** Given below are two statements, one labelled as Assertion (A) and the other as Reason (R).

Assertion (A): A political party contests elections and seeks office; a pressure group usually does not contest and seeks to influence policy.

Reason (R): An interest group becomes a pressure group when it presses the State.
...
**Ans: D.** Both true and R fits the interest→pressure transition next to A’s party/pressure distinction.

**A/R logic:** Party vs pressure vs interest vocabulary.

</details>

**Q11.** How many of the following labour-history facts are correct?

1. First trade union commonly locked as Madras Labour Union (1918).
2. AITUC formed in 1920 with Lala Lajpat Rai as president.
3. Right to strike is a Fundamental Right under Article 19(1)(c).
...
**Logic:** 19(1)(c) is form associations/unions — strike is not an FR.
...
**Q13.** Consider the following pairs of national-party symbols in the teaching set:
...
1. UTUC (1949) — linked to RSP
2. CITU (1970) — linked to CPI
3. BMS (1955) — linked to BJP/RSS
...
**Ans: A.** Pair 2 is wrong — CITU links to CPI(M).

**Logic:** AITUC=CPI; CITU=CPI(M).

</details>

**Q15.** With reference to electoral bonds and funding neighbours, which of the following is/are correct?

1. Electoral bonds were struck down in February 2024 (ADR).
2. Party funding transparency remains a live neighbour to registration and recognition.
...
**Logic:** Struck-down scheme + transparency theme.

</details>

**Q16.** Given below are two statements, one labelled as Assertion (A) and the other as Reason (R).

Assertion (A): A hung Assembly automatically means President’s Rule under Article 356.

Reason (R): The constitutional path is invitation based on likely majority, then floor test; 356 is a last resort.
...
**Logic:** Three different tools — do not merge.
...
**Ans: A.** 1920 → 1947 → 1955 → 1970.

**Logic:** AITUC → INTUC → BMS → CITU.
...
**Q20.** Consider the following statements about pressure groups:

1. They include business associations, farmer bodies, trade unions, and professional lobbies.
...
1. Coalition government — common programme + support arithmetic
...
Assertion (A): The Tenth Schedule creates the Election Commission’s recognition rules for national parties.

Reason (R): Registration, recognition, and defection are three different tools.
...
**A/R logic:** Tenth Schedule = defection; recognition = Symbols Order.

</details>

**Q23.** With reference to State-party routes, which of the following is/are correct?

1. One route is 6% votes plus two MLAs or one MP.
2. Another route is 3% of Assembly seats or three seats, whichever is higher.
...
**Logic:** Classic State-party thresholds.

</details>

**Q24.** How many of the following are true?

1. Indian party-system features often include multi-party competition and regionalisation after 1967.
2. Weak inner-party democracy is a frequently noted feature.
3. The Constitution comprehensively defines party constitutions in Part XV.
...
**Logic:** Parties remain thinly named in the constitutional text.

</details>

**Q25.** Which of the following is/are NOT correctly matched?

1. Political party — contests; seeks power
2. Pressure group — normally does not contest; seeks to influence
3. Interest group — identical in meaning to national party under the Symbols Order
...
**Logic:** Interest group ≠ national party.

</details>

**Q26.** With reference to Uttar Pradesh high-yield neighbours, which of the following statements is/are correct?

1. BSP and SP founding years sit in the standard founding-order drill with TDP and TMC.
2. National roster and UP regional set should be kept separate in revision.
...
**Logic:** Founding order + separate national/UP sets.

</details>

**Q27.** Consider the following statements:

1. A registered party without recognition remains a RUPP with a free symbol.
2. Reserved symbols are for recognised parties.
...
**Q29.** With reference to coalition arithmetic after 2024, which of the following is/are correct?

1. 2024 produced an NDA coalition with the BJP on 240 seats in the teaching set.
2. Multi-party democracy can still produce stable majorities.
...
**Logic:** 2024 NDA + multi-party ≠ permanent instability.

</details>

**Q30.** Which of the following pairs is/are correctly matched?

1. First trade union fact — Madras Labour Union (1918)
...
India’s party system is **multi-party** because FPTP sits on **region + caste + language**. **1952–67** was a Congress *system*, not a one-party State; **1989–2014** was coalition arithmetic; **2014** majority did not abolish other parties; **2024** returned a **coalition** Union. Close: parties **contest**, pressure groups **press** — and the 2022 paper still wants **TDP/BSP/SP/TMC years** and **BMS/INTUC** affiliations from memory.
