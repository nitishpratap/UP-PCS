...
> **Weight:** ★★★ — Preamble counts/words, quasi-federal scholars, Basic Structure cases, Parliamentary A/R, federalism match lists
...
### What India’s type of government means (frame)
...
- Today: about **470 Articles** (with insertions), **25 Parts**, **12 Schedules** (exact count moves with amendments — fact “expanded far beyond 1950”).
- Reasons for length:
...
| Scholar | Label for Indian federalism | Description (coaching fact) |
|---------|----------------------------|-----------------------------|
...
### Match-list quick fact (2024 PYQ pattern)
...
**Inline PYQ — UPPCS Prelims 2020, Q126Assertion (A):** Indian federalism is called 'Quasi-federal'.
...
| Point | Parliamentary (India) | Presidential (USA) |
|-------|----------------------|--------------------|
| Executive | From legislature; responsible to it | Separate; fixed tenure |
| Head of state / govt | Dual — President + PM | Single — President |
| Ministers | Usually MPs | Need not be legislators |
...
- **K.M. Munshi** called it the **political horoscope** of our sovereign democratic republic.
- **Pt. Thakur Das Bhargava** and many coaching notes call the Preamble the **soul** of the Constitution.
- **Subhash Kashyap:** if the Constitution is the body, the Preamble is the soul; if the Constitution is a building, the Preamble is the foundation stone.
- **Sir Alladi Krishnaswami Ayyar:** the Preamble expresses what we had thought or dreamt so long.
- Helps courts interpret ambiguous provisions; reflects Basic Structure ideals (*Kesavananda*).
- Idea of a Preamble is borrowed from the **USA**; language of the Preamble from **Australia**.

### Soul / heart traps (do not swap)
...
- **Berubari Union (1960):** SC held Preamble **not** part of the Constitution (earlier view); also called it the key to the minds of the makers.
- **Golaknath (1967):** coaching notes treat the Preamble as the **core / soul** of the Constitution in that debate line — do not confuse with Basic Structure invention (*Kesavananda*).
- **Kesavananda Bharati (1973):** Preamble **is part** of the Constitution; aids interpretation; basic features reflected in Preamble.
- **S.R. Bommai (1994):** SC again treated the Preamble as part of the Constitution.
- **LIC of India (1995):** reaffirmed Preamble is part of the Constitution.
- Preamble is **non-justiciable** — **not directly enforceable** like Fundamental Rights; it has **no legal effect independently** of other parts (*IAS 2020* line).
- Preamble **can be amended** under Art. 368 (**42nd** did — only amendment of the Preamble so far) but cannot destroy **Basic Structure**.
- **42nd** Preamble words followed the **Swaran Singh Committee** recommendations line.
- Words **Federal**, **Public Welfare**, **Religious Justice** and **Economic Liberty** are **not** in the Preamble.
- Word **“People’s”** is **not** in India’s Preamble (China’s constitution uses that style).
...
| Ideal | Components | Count |
|-------|------------|------:|
| **Justice** | Social, Economic, Political | **3** |
| **Liberty** | Thought, Expression, Belief, Faith, Worship | **5** |
| **Equality** | Status and Opportunity | **2** |
| **Fraternity** | Assuring dignity of the individual + unity **and integrity** of the Nation | **1** (ideal) |

Order asked: Justice, Liberty, Equality, Fraternity → **3, 5, 2, 1**.

### 1950 status fact

- Exact constitutional status on **26 January 1950** = **Sovereign Democratic Republic** only (UPSC Prelims 2021 fact).
- **Socialist** and **Secular** enter only via **42nd Amendment, 1976**.
- Commonwealth membership does **not** curtail India’s sovereignty.
...
### Case / amendment chronology (must fact)

| Case / Event | Year | Holding (key fact) |
|--------------|------|---------------------|
...
- Details of acquisition/loss → Citizenship Act, 1955 (Citizenship topic); here fact only **single citizenship as a salient feature**.
...
|---------|-------|-----|----|------------------------|
| Form of govt | Parliamentary | Presidential | Parliamentary | Canada parliamentary |
| Constitution | Written, lengthy, supreme | Written, short, supreme | Unwritten + Parliamentary sovereignty | Canada written federal |
| Citizenship | Single | Dual (federal + state) | — | Single like Canada |
| Residuary powers | Centre | States | — | Centre like Canada |
| Federation | Strong Centre / quasi-federal | Classical dual federalism | Unitary | Canada federal |
| DPSP | Yes (Ireland) | No equivalent | — | Ireland source |
| Judicial review | Strong | Strong | Limited / different | — |
| Amendment | Rigid + flexible blend | Mostly rigid | Flexible (sovereignty of Parliament) | — |
| Rights | FR justiciable + DPSP | Bill of Rights | Common law + statutes + HRA later | — |
| Head of State | Elected President (Republic) | Elected President | Hereditary monarch | — |
...
- PIL expands access to justice for weaker sections → linked to Rule of Law s.

**Inline PYQ — UPPCS Prelims 2025, Q47Assertion (A):** Public Interest Litigation is essential for the rule of law in India.
...
- Judiciary is more separated; judicial review polices the other organs.
...
**Inline PYQ — UPPCS Prelims 2021, Q54 (cross-topic fact)**
...
## Ghatnachakra Extra Drill — Preamble, Governance & National Symbols

Teaching sits in **N.1A–N.11**. Full MCQs from Ghatnachakra so you need not reopen the book. UPPCS-tagged stems appear with other papers; UKPCS stems are also collected again at the end.

### Section A — The Preamble

**Q1. IAS (Pre) 1997**

In the following quotation,
“WE THE PEOPLE OF INDIA, having solemnly resolved to constitute India into a Sovereign, Socialist, Secular, Democratic, Republic … In our Constituent Assembly, this ‘X’ do hereby adopt, enact and give to ourselves this Constitution.”, ‘X’ stands for:
...
**Logic:** Preamble date line is the adoption date, not Republic Day.

**Ans: B.** ‘X’ is the **twenty-sixth day of November, 1949** — the date of adoption of the Constitution. Full commencement was **26 January 1950**.
...
**Logic:** Part of Constitution, but no independent legal effect.

**Ans: D.** The Preamble is **part** of the Constitution (*Kesavananda*). It has **no legal effect independently** of other parts.

</details>

**Q2. UPPCS (Pre) 2018**

How many types of justice, liberty, equality and fraternity in that order has been mentioned in the Preamble of the Constitution of India?
...
**Logic:** Keyword counts — Justice 3, Liberty 5, Equality 2, Fraternity 1 package.

**Ans: A.** **Justice** has three limbs (social, economic, political). **Liberty** has five. **Equality** has two. **Fraternity** is one unity–dignity package. Code is **3, 5, 2, 1**.
...
**Logic:** Federal is not a Preamble word.

**Ans: D.** The Preamble describes India as a **Sovereign Socialist Secular Democratic Republic**. The word **Federal** is not in the Preamble.
...
**Logic:** Preamble is non-justiciable / not enforceable like a Fundamental Right.

**Ans: B.** The Preamble is **non-justiciable**. It cannot be enforced in a court like a Fundamental Right.
...
**Logic:** 42nd Amendment added Socialist and Secular (and integrity with unity).

**Ans: D.** The **42nd Amendment, 1976** added **Socialist** and **Secular** to the Preamble. It also inserted **integrity** with unity of the Nation. **Sovereignty** and **Republic** were already present.
...
**Logic:** Welfare State ideal is mainly DPSP; Preamble sets goals but DPSP operationalises welfare.

**Ans: B.** The **welfare state** ideal is primarily embodied in the **Directive Principles of State Policy**. The Preamble states broad goals; Part IV guides State policy.

</details>

**Q7. UPPCS (Pre) 2008**

The date mentioned in the Preamble of the Constitution of India is
...
**Logic:** Preamble date line = adoption date 26 November 1949.

**Ans: B.** The Preamble records **26 November 1949** — the date of adoption of the Constitution. Full commencement was **26 January 1950**.

</details>

**Q8. UP RO/ARO (Pre) 2016**

What was the exact constitutional status of India on 26 January 1950?
...
**Logic:** On 26 Jan 1950 only Sovereign Democratic Republic — no Socialist/Secular yet.

**Ans: B.** On **26 January 1950** India was a **Sovereign Democratic Republic**. **Socialist** and **Secular** were added by the **42nd Amendment, 1976**.

</details>

**Q9. MPPCS (Pre) 2017**

Which one of the following correctly describes the nature of the Indian State on the commencement of the Constitution?
...
**Logic:** Commencement status = Sovereign Democratic Republic.

**Ans: B.** At commencement the Preamble read **Sovereign Democratic Republic** only.

</details>

**Q10. BPSC (Pre) 2019**

Who among the following called the Preamble as the ‘Political Horoscope’ of the Indian Constitution?
...
**Logic:** Munshi = political horoscope; Palkhivala = identity card.

**Ans: A.** **K.M. Munshi** called the Preamble the **political horoscope**. **N.A. Palkhivala** called it the Constitution’s **identity card**.

</details>

**Q11. UPPCS (Mains) 2010**
...
**Logic:** Palkhivala identity-card label.

**Ans: A.** **N.A. Palkhivala** described the Preamble as the **identity card** of the Constitution.
...
A. The Preamble of the Constitution is a source of power to the legislature
B. The Preamble is a part of the Constitution and is enforceable
C. The Preamble is not a part of the Constitution
D. The Preamble indicates the objects which the Constitution seeks to establish and promote

<details>
<summary>Show answer</summary>

**Logic:** Preamble states objects; it is not a source of legislative power and is not enforceable.

**Ans: D.** The Preamble indicates the **objects** the Constitution seeks to establish and promote. It is **not** a source of power for the legislature and is **not enforceable**.

</details>

**Q13. UPPCS (Pre) 2012**

The Preamble of the Indian Constitution serves as a key to

A. open the minds of the makers of the Constitution
B. open the minds of the people of India
C. open the minds of the judges
D. open the minds of the Presidents of India

<details>
<summary>Show answer</summary>

**Logic:** Preamble as key to the mind of the makers.

**Ans: A.** Courts and commentators treat the Preamble as a key to open the **minds of the makers** of the Constitution.

</details>

**Q14. Jharkhand PCS (Pre) 2016**

‘We, the People of India’ in the Preamble means

A. the people of India as a whole are the source of the Constitution
B. the Constituent Assembly alone is the source of the Constitution
C. the British Parliament is the source of the Constitution
D. the President of India is the source of the Constitution

<details>
<summary>Show answer</summary>

**Logic:** Popular sovereignty — authority from the people.

**Ans: A.** **“We, the People of India”** declares that the **people** are the source of the Constitution’s authority.

</details>

**Q15. UKPCS (Pre) 2012**

Which one of the following is correct about the Preamble of the Indian Constitution?

A. It is justiciable
B. It is non-justiciable
C. It is partly justiciable
D. It becomes justiciable after 42nd Amendment

<details>
<summary>Show answer</summary>

**Logic:** Preamble remains non-justiciable.

**Ans: B.** The Preamble is **non-justiciable**. Courts may use it for interpretation, but it cannot be enforced as a right.
...
**Logic:** Order: Sovereign Socialist Secular Democratic Republic.

**Ans: A.** Present order is **Sovereign, Socialist, Secular, Democratic, Republic**.

</details>

**Q17. UPPCS (Pre) 2006**

Which of the following is not a feature of the Preamble of the Indian Constitution?
...
**Logic:** Economic liberty is not listed; Liberty limbs are thought, expression, belief, faith, worship.

**Ans: B.** **Economic liberty** is not in the Preamble. Liberty covers **thought, expression, belief, faith and worship**.
...
**Logic:** Public welfare is not a Preamble phrase.

**Ans: D.** **Public welfare** is not mentioned in the Preamble. Justice, liberty, equality, fraternity and dignity are.

</details>

**Q19. MPPCS (Pre) 2014**

Which one of the following is not included in the Preamble of the Indian Constitution?
...
**Logic:** Justice limbs are social, economic, political — not religious.

**Ans: C.** **Religious justice** is not in the Preamble. Justice means **social, economic and political** justice.

</details>

**Q20. RAS/RTS (Pre) 2013**
...
**Logic:** Federal absent from Preamble.

**Ans: C.** The word **Federal** does not appear in the Preamble.
...
**Logic:** After Kesavananda: part of Constitution and amendable (without destroying basic structure).

**Ans: C.** Both are correct. After ***Kesavananda***, the Preamble is a **part** of the Constitution. It can be amended under **Article 368**, as done by the **42nd Amendment**, subject to basic structure.
...
2. The Preamble has no legal effect independently of other parts of the Constitution.
...
**Logic:** IAS 2020 — part + no independent legal effect.

**Ans: C.** Both statements are correct. The Preamble is **part** of the Constitution but has **no independent legal effect** apart from other parts.

</details>

**Q23. UPPCS (Mains) 2007**

In which of the following cases did the Supreme Court hold that the Preamble is not a part of the Constitution?
...
**Logic:** Berubari 1960 = not part; later overruled on this point.

**Ans: A.** In the ***Berubari Union* case (1960)** the Court held the Preamble is **not** a part of the Constitution. Later ***Kesavananda*** held that it **is** a part.
...
**Logic:** Kesavananda held Preamble is part of the Constitution.

**Ans: B.** ***Kesavananda Bharati* (1973)** held that the Preamble is a **part** of the Constitution. ***S.R. Bommai*** later reaffirmed related principles including secularism as basic.

</details>

**Q25. UPPCS (Pre) 2016**

The doctrine of Basic Structure was propounded by the Supreme Court in
...
**Ans: B.** The **Basic Structure** doctrine was propounded in ***Kesavananda Bharati vs State of Kerala* (1973)**.
...
**Logic:** Economic justice = Preamble + DPSP.

**Ans: B.** **Economic justice** appears in the **Preamble** and is elaborated in the **Directive Principles of State Policy**.
...
**Logic:** Economic liberty not in Preamble liberty list.

**Ans: B.** **Economic liberty** is not embodied in the Preamble’s liberty clause.
...
**Logic:** Secular via 42nd Amendment 1976.

**Ans: A.** **Secular** was added by the **42nd Constitutional Amendment Act, 1976**.

</details>

**Q30. MPPCS (Pre) 2018**

The word ‘Socialist’ was inserted into the Preamble by which Amendment?
...
**Logic:** Socialist also via 42nd.

**Ans: A.** **Socialist** was inserted by the **42nd Amendment, 1976**.

</details>

**Q31. UPPCS (Pre) 2013**

Which of the following was not added to the Preamble by the 42nd Amendment?
...
**Logic:** Sovereignty was original; 42nd added Socialist, Secular, integrity.

**Ans: D.** **Sovereignty** was already in the original Preamble. The **42nd Amendment** added **Socialist**, **Secular**, and **integrity**.

</details>

**Q32. RAS/RTS (Pre) 2016**

‘Integrity’ of the nation was added in the Preamble by

A. the 42nd Amendment
B. the 44th Amendment
C. a Presidential Order in 1975
D. the 24th Amendment

<details>
<summary>Show answer</summary>

**Logic:** Integrity not a 1975 insert — it came with 42nd Amendment 1976.

**Ans: A.** **Integrity** was added with unity by the **42nd Amendment, 1976**. It was **not** inserted by a 1975 order.
...
B. all religions are treated as State religions
C. Hinduism is the State religion
D. the State patronises only minority religions

<details>
<summary>Show answer</summary>

**Logic:** Secular = no State religion; equal respect / non-discrimination.

**Ans: A.** India is **secular** in the sense that there is **no State religion** and the State does not discriminate on grounds of religion.
...
**Logic:** LIC 1995 reaffirmed Preamble is part; Berubari said not part.

**Ans: C.** ***LIC of India* (1995)** reaffirmed that the Preamble is a **part** of the Constitution. ***Berubari*** had earlier said it was not.

</details>

**Q35. BPSC (Pre) 2020**

In S.R. Bommai vs Union of India, the Supreme Court held that

A. secularism is a basic feature of the Constitution
B. the Preamble is not a part of the Constitution
C. Fundamental Rights can be amended freely
D. President’s Rule cannot be reviewed by courts
...
**Q36. UPPCS (Mains) 2015**

Which of the following is true about the Preamble?

A. It is justiciable and cannot be amended
B. It is non-justiciable but can be amended
C. It is justiciable and can be amended
D. It is non-justiciable and cannot be amended

<details>
<summary>Show answer</summary>

**Logic:** Non-justiciable yet amendable (42nd).

**Ans: B.** The Preamble is **non-justiciable** but **amendable**, as shown by the **42nd Amendment**.
...
B. the Preamble and the Directive Principles of State Policy
C. the Fundamental Rights and the Seventh Schedule
D. the Directive Principles alone

<details>
<summary>Show answer</summary>

**Logic:** Same economic-justice pairing — Preamble + DPSP.

**Ans: B.** **Economic justice** is stated in the **Preamble** and pursued through the **Directive Principles**.

</details>

**Q38. UPPCS (Pre) 2005**

Which one of the following liberties is not mentioned in the Preamble of the Indian Constitution?
...
**Logic:** Liberty of action not listed among five liberty limbs.

**Ans: D.** **Liberty of action** is not named in the Preamble. The five limbs are thought, expression, belief, faith and worship.
...
A. dignity of the individual and unity and integrity of the Nation
B. only dignity of the individual
C. only unity of the Nation
D. equality before law alone

<details>
<summary>Show answer</summary>

**Logic:** Fraternity = dignity + unity and integrity.

**Ans: A.** **Fraternity** assures the **dignity of the individual** and the **unity and integrity** of the Nation.
...
A. Republic — Head of State is hereditary
B. Republic — Head of State is elected
C. Republic — Head of State is nominated by the judiciary
D. Republic — Head of State is appointed by the UN

<details>
<summary>Show answer</summary>

**Logic:** Republic = elected Head of State.

**Ans: B.** A **Republic** means the Head of State is **elected**, not hereditary.

</details>

**Q41. CGPSC (Pre) 2018**

Democracy in the Preamble means

A. only political democracy
B. political, social and economic democracy
C. only social democracy
D. only economic democracy

<details>
<summary>Show answer</summary>

**Logic:** Democratic ideal covers political, social and economic democracy.

**Ans: B.** **Democracy** in the Indian constitutional sense covers **political, social and economic** democracy, not ballot alone.

</details>

**Q42. UPPCS (Pre) 2004**

Which one of the following is not a correct statement about the Preamble?

A. It is based on the Objectives Resolution
B. It was adopted after the rest of the Constitution was enacted
C. It can override Fundamental Rights
D. It states the ideals of the Constitution

<details>
<summary>Show answer</summary>

**Logic:** Preamble cannot override Fundamental Rights.

**Ans: C.** The Preamble **cannot override** Fundamental Rights. It is based on the **Objectives Resolution** and states constitutional ideals.

</details>

**Q43. BPSC (Pre) 2015**

The source of authority of the Constitution of India is
...
**Logic:** We the People = source of authority.

**Ans: A.** The source of authority is the **People of India**, as declared in the opening words of the Preamble.

</details>

**Q44. UPPCS (Pre) 2020**

Which of the following expressions is not found in the Preamble of the Indian Constitution?

A. Justice — social, economic and political
B. Liberty of thought, expression, belief, faith and worship
C. Equality of status and of opportunity
D. Federal character of the Union

<details>
<summary>Show answer</summary>

**Logic:** Federal character phrase not in Preamble text.

**Ans: D.** The Preamble does **not** speak of a **federal character**. Justice, liberty and equality phrases are present.

</details>

**Q45. IAS (Pre) 2005**

Which one of the following words was not included in the Preamble of the Indian Constitution as originally adopted?
...
**Logic:** Socialist was not original — added in 1976.

**Ans: B.** **Socialist** was not in the original Preamble. It was added by the **42nd Amendment**.

</details>

**Q46. UPPCS (Mains) 2012**
...
**Logic:** Munshi–horoscope; Palkhivala–identity card; Ambedkar–Art.32 heart/soul; Thakurdas–Preamble soul sometimes attributed.

**Ans: A.** **K.M. Munshi** — political horoscope. **N.A. Palkhivala** — identity card. **B.R. Ambedkar** — Article 32 as heart and soul. **Thakurdas Bhargava** is often linked with calling the Preamble the soul of the Constitution in Assembly debate framing.

</details>

**Q47. UKPCS (Pre) 2010**

The Objectives Resolution which formed the basis of the Preamble was moved by
...
**Logic:** Preamble is not a source of prohibition / power for legislature.

**Ans: B.** The Preamble is **not** a source of power or prohibition on the legislature. It aids **interpretation** and states philosophy. It has been amended **once** (42nd).

</details>

**Q49. MPPCS (Pre) 2020**

Which of the following statements about ‘Sovereign’ in the Preamble is correct?

A. India can acquire foreign territory and cede Indian territory in the exercise of sovereignty
B. India cannot acquire foreign territory because it is a member of the Commonwealth
C. India’s sovereignty is limited by the UN Charter alone
D. Sovereignty in the Preamble means only economic sovereignty

<details>
<summary>Show answer</summary>

**Logic:** Sovereign State can acquire/cede territory; Commonwealth membership does not curtail sovereignty.

**Ans: A.** **Sovereign** means India is not subject to any external authority. Membership of the **Commonwealth** does **not** curtail sovereignty. India can acquire or cede territory subject to constitutional process.

</details>

**Q50. UPPCS (Pre) 2016**

Which one of the following is correctly matched regarding equality in the Preamble?

A. Equality of status and of opportunity
B. Equality of income and of property
C. Equality of religion and of language
D. Equality of States and of Union Territories

<details>
<summary>Show answer</summary>

**Logic:** Equality limbs = status and opportunity.

**Ans: A.** The Preamble secures **equality of status and of opportunity**.
...
A. The Preamble is enforceable in a court of law like Article 32
B. The Preamble cannot be used even for interpretation
C. The Preamble may be used to interpret ambiguous provisions of the Constitution
D. The Preamble was deleted by the 42nd Amendment

<details>
<summary>Show answer</summary>

**Logic:** Interpretive use yes; independent enforcement no.

**Ans: C.** Courts may use the Preamble to **interpret** ambiguous provisions. It is **not** enforceable like **Article 32**.

</details>

### Section B — The Governance System
...
**Logic:** Parliamentary system first in UK.

**Ans: A.** The **parliamentary** form of government was first introduced in **Great Britain (UK)**.
...
**A/R logic:** A/R: parliamentary identity rests on executive responsibility to legislature.

**Ans: D.** **A** is true — India has a **parliamentary** system. **R** is true and explains **A** — the executive is **responsible to the legislature** (Lok Sabha).

</details>

**Q54. IAS (Pre) 2021**

Which of the following is/are the feature(s) of the parliamentary system of government in India?
...
**Logic:** Both parliamentary feature statements are correct.

**Ans: C.** Both statements are correct. India has a **nominal** President and a **real** Council of Ministers, and the executive is **collectively responsible** to the legislature.
...
**Logic:** Wheare = quasi-federal.

**Ans: D.** **K.C. Wheare** described the Indian Constitution as **quasi-federal**.
...
**Logic:** Austin cooperative; Morris-Jones bargaining; Wheare quasi; Jennings centralising.

**Ans: C.** **Granville Austin** — Cooperative federalism. **Morris-Jones** — Bargaining federalism. **K.C. Wheare** — Quasi-federalism. **Ivor Jennings** — Federalism with centralising tendency. Code **4 3 1 2**.
...
**A/R logic:** Quasi-federal is true; independent judiciary does not explain that label.

**Ans: B.** **A** is true — Indian federation is often called **quasi-federal**. **R** is true but does **not** explain **A**. Quasi-federal refers to a strong Centre and related unitary features.
...
**Logic:** Hallmark = collective responsibility to Lok Sabha.

**Ans: D.** India is parliamentary because the **Council of Ministers is responsible to the Lok Sabha**.
...
C. Fixed tenure of the Prime Minister independent of the House
D. Membership of ministers in the legislature

<details>
<summary>Show answer</summary>

**Logic:** PM tenure is not fixed independent of House confidence.

**Ans: C.** The Prime Minister does **not** have a fixed tenure independent of the House. Continuance depends on **confidence of the Lok Sabha**.
...
B. the Council of Ministers is responsible to the Parliament
C. there is a written Constitution
D. there is an independent judiciary

<details>
<summary>Show answer</summary>

**Logic:** Responsibility to Parliament defines parliamentary form.

**Ans: B.** India is parliamentary because the **Council of Ministers is responsible to Parliament** (Lok Sabha).

</details>

**Q62. UKPCS (Pre) 2015**

Which one of the following is not a feature of Indian Parliamentary system?

A. Majority party rule
B. Collective responsibility
C. Strict separation of powers like the USA
D. Leadership of the Prime Minister

<details>
<summary>Show answer</summary>

**Logic:** India does not follow USA-style strict separation.

**Ans: C.** India does **not** have **strict separation of powers** on the American Presidential model. Executive and legislature are fused through the Cabinet.
...
**Logic:** Preamble idea from USA.

**Ans: A.** The idea of a **Preamble** was borrowed from the **USA**.
...
A. India has a Presidential system of government
B. India has a Parliamentary system of government
C. India has a Collegial Swiss system only
D. India has no responsible government

<details>
<summary>Show answer</summary>

**Logic:** Not Presidential — Parliamentary.

**Ans: B.** India has a **Parliamentary** system of government, **not** a Presidential system.

</details>

**Q65. UPPCS (Pre) 2008**

According to Article 75(3) of the Constitution

A. the Council of Ministers is collectively responsible to the Lok Sabha
B. the Council of Ministers is individually responsible to the President only
C. the Council of Ministers is responsible to the Rajya Sabha
D. the Council of Ministers is responsible to the Supreme Court

<details>
<summary>Show answer</summary>

**Logic:** Art. 75(3) = collective responsibility to Lok Sabha.

**Ans: A.** **Article 75(3)** provides that the Council of Ministers shall be **collectively responsible to the Lok Sabha**.

</details>

**Q66. BPSC (Pre) 2019**

Cabinet responsibility means

A. collective responsibility of the Cabinet to the legislature
B. individual responsibility of each minister to the President only
C. responsibility of the Cabinet to the Supreme Court
D. responsibility of the Cabinet to the Election Commission

<details>
<summary>Show answer</summary>

**Logic:** Cabinet = collective responsibility to legislature.

**Ans: A.** **Cabinet / collective responsibility** means the Ministry stands or falls together before the **legislature** (Lok Sabha).

</details>

**Q67. UPPCS (Mains) 2009**

In the Indian Constitution, the powers of the President are

A. really the powers of the Union Council of Ministers in most cases of executive action
B. personal discretionary powers in all matters without advice
C. identical to the US President’s independent executive
D. exercised only by the Chief Justice of India

<details>
<summary>Show answer</summary>

**Logic:** Presidential powers ordinarily exercised on ministerial advice.

**Ans: A.** Formally vested in the **President**, executive powers are ordinarily exercised on the **aid and advice** of the Council of Ministers.

</details>

**Q68. MPPCS (Pre) 2015**

Which of the following are cardinal features of a parliamentary form of government?

1. Dual executive
2. Majority party rule
3. Collective responsibility
4. Separation of powers with unified authority of President alone
...
**Logic:** Cardinal features 1–3; not USA-style unified Presidential authority.

**Ans: A.** Cardinal parliamentary features include **dual executive**, **majority party rule**, and **collective responsibility**. **Unified Presidential authority** is not a parliamentary cardinal feature.

</details>

**Q69. UPPCS (Pre) 2014**

A Welfare State is a state which

A. promotes the economic and social well-being of citizens
B. is concerned only with defence and foreign affairs
C. abolishes all private property immediately
D. has no Directive Principles

<details>
<summary>Show answer</summary>

**Logic:** Welfare State = socio-economic well-being of citizens.

**Ans: A.** A **welfare state** aims to promote the **economic and social well-being** of its citizens, guided in India especially by the DPSP.

</details>

**Q70. RAS/RTS (Pre) 2012**

Republic in the Indian Constitution means

A. the Head of the State is elected
B. the Head of the State is hereditary
C. the Head of the State is nominated by the British Crown
D. there is no Head of the State

<details>
<summary>Show answer</summary>

**Logic:** Republic = elected head.

**Ans: A.** **Republic** means the Head of State is **elected**, not hereditary.
...
B. concentration of all powers in the Centre
C. concentration of all powers in the States
D. absence of a written Constitution

<details>
<summary>Show answer</summary>

**Logic:** Federal = distribution of powers between Centre and units.

**Ans: A.** **Federalism** implies a **distribution of powers** between the Centre and the States under a written Constitution.
...
A. The Constitution of India is both rigid and flexible
B. The Constitution of India is absolutely rigid
C. The Constitution of India is absolutely flexible
D. The Constitution of India is neither rigid nor flexible

<details>
<summary>Show answer</summary>

**Logic:** Partly rigid and partly flexible.

**Ans: A.** The Indian Constitution is a blend of **rigidity and flexibility** — partly rigid, partly flexible.

</details>

**Q73. UPPCS (Pre) 2006**

Single citizenship in India is a feature of

A. a unitary tendency / unitary feature
B. a classical confederation
C. the US Constitution alone
D. the Swiss Constitution alone

<details>
<summary>Show answer</summary>

**Logic:** Single citizenship is a unitary feature of the Constitution.

**Ans: A.** **Single citizenship** is treated as a **unitary feature** of the Indian Constitution (contrast dual citizenship in the USA).

</details>

**Q74. BPSC (Pre) 2014**

Who described the Indian Constitution as ‘a federation with a strong centralising tendency’?
...
**Logic:** Jennings = centralising tendency.

**Ans: A.** **Ivor Jennings** spoke of Indian federalism’s **centralising tendency**.
...
**Logic:** Austin = cooperative federalism.

**Ans: A.** **Granville Austin** described Indian federalism as **cooperative**.

</details>

**Q76. MPPCS (Pre) 2019**

Who described Indian federalism as ‘bargaining federalism’?
...
**Logic:** Morris-Jones = bargaining federalism.

**Ans: A.** **Morris-Jones** described it as **bargaining federalism**.

</details>

**Q77. UPPCS (Pre) 2013**

Ambedkar’s view on Indian federation was that

A. it is not a tight mould of classical federation and can work as unitary in emergency
B. States have a right to secede
C. it is identical to the USA federation
D. it prohibits any central legislation on State subjects always

<details>
<summary>Show answer</summary>

**Logic:** Ambedkar — not a tight mould; unitary flexibility in crisis.

**Ans: A.** **B.R. Ambedkar** said the Indian federation is **not a tight mould**. In normal times it can work federally; in Emergency it can work as nearly **unitary**.
...
B. Rights are independent of Duties entirely
C. Duties abolish Rights
D. Duties are enforceable like Fundamental Rights always

<details>
<summary>Show answer</summary>

**Logic:** Rights–Duties correlative idea in constitutional teaching.

**Ans: A.** In constitutional teaching, **Rights** and **Duties** are treated as **correlative** — though Fundamental Duties are not enforceable like Part III rights.

</details>

**Q79. UPPCS (Pre) 2009**

The concept of ‘Rule of Law’ is a contribution of
...
**Logic:** Rule of Law associated with Dicey.

**Ans: A.** The modern exposition of **Rule of Law** is associated with **A.V. Dicey**.
...
A. a government limited by the Constitution
B. a government without any limitations
C. a government based only on conventions
D. a government headed by the military

<details>
<summary>Show answer</summary>

**Logic:** Constitutional = limited government.

**Ans: A.** **Constitutional government** means government **limited by the Constitution**.

</details>

**Q81. UPPCS (Pre) 2007**

Liberty, in the political sense, means

A. opportunity to develop one’s personality without unjust restraints
B. absence of all laws
C. licence to do anything
D. dictatorship of the majority without rights

<details>
<summary>Show answer</summary>

**Logic:** Liberty = opportunity to develop personality under just restraints.

**Ans: A.** **Liberty** means the opportunity to develop one’s personality **without unjust restraints**, not absence of all law.
...
A. absence of special privileges for any person and equal subjection to ordinary law
B. equal income for all citizens
C. equal property for all citizens
D. absence of courts

<details>
<summary>Show answer</summary>

**Logic:** Equality = absence of special privileges (Diceyan sense).

**Ans: A.** **Equality before law** means **absence of special privileges** and equal subjection of all to ordinary law.

</details>

**Q83. UPPCS (Pre) 2016**

Pocket veto of the President is a feature common to the Constitutions of

A. India and USA
B. India and UK
C. USA and UK
D. India and France only

<details>
<summary>Show answer</summary>

**Logic:** Pocket veto common to India and USA (different mechanics/teaching label).

**Ans: A.** **Pocket veto** is commonly listed as a feature shared by the **Indian** and **US** Presidents in comparative polity teaching.
...
**Logic:** State definition — Garner.

**Ans: A.** **Garner’s** definition of the **State** stresses population, territory, government and sovereignty / independence of external control.

</details>

**Q85. UPPCS (Pre) 2005**

The most important element of the State is

A. Sovereignty
B. Territory
C. Population
D. Government alone without sovereignty

<details>
<summary>Show answer</summary>

**Logic:** Sovereignty is the most distinctive / important element.

**Ans: A.** **Sovereignty** is treated as the most important distinctive element of the State.

</details>

**Q86. BPSC (Pre) 2018**

India’s membership of the Commonwealth

A. does not curtail India’s sovereignty
B. makes the British Crown the Head of the Indian State
C. allows the UK Parliament to legislate for India
D. ends India’s status as a Republic

<details>
<summary>Show answer</summary>

**Logic:** Commonwealth membership does not curtail sovereignty.

**Ans: A.** Membership of the **Commonwealth** does **not** curtail India’s **sovereignty** as a Republic.

</details>

**Q87. IAS (Pre) 2021**

Which of the following factors constitutes an important feature of the Indian parliamentary system?

1. Presence of nominal and real executives
2. Leadership of the Prime Minister
3. Dissolution of the Lower House
4. Strict separation of powers between the executive and legislature
...
**Logic:** Both/several parliamentary statements true; strict separation false.

**Ans: A.** Statements **1, 2 and 3** are parliamentary features. **Strict separation** of powers is **not** an Indian parliamentary feature.
...
**Logic:** No secession right; advocacy of secession not protected free speech.

**Ans: A.** Statement **1** is correct — States have **no right to secede**. Statement **2** is incorrect.

</details>

**Q89. UPPCS (Pre) 2020**

When was the third tier added to the Indian Federal System?
...
**Logic:** 73rd/74th Amendments 1992 = third tier.

**Ans: C.** The **third tier** (Panchayats and Municipalities) was added by the **73rd and 74th Amendments in 1992**.
...
**Logic:** Basic Structure case = Kesavananda 1973.

**Ans: A.** ***Kesavananda Bharati* (1973)** propounded the **Basic Structure** doctrine.
...
**Logic:** 1967 → 1971 → 1973 → 1976.

**Ans: A.** Order: **Golaknath (1967)** → **24th Amendment (1971)** → **Kesavananda (1973)** → **42nd Amendment (1976)**.
...
**Ans: C.** Correct order is **Shankari Prasad (1951)** → **Sajjan Singh (1965)** → **Golaknath (1967)** → **Kesavananda (1973)**.
...
**Logic:** India has single citizenship — dual is USA feature.

**Ans: D.** India has **single citizenship**, not dual citizenship.
...
**Logic:** Single citizenship listed among unitary features.

**Ans: A.** **Single citizenship** is a **unitary feature**. Division of powers and independent judiciary support the federal side.
...
D. Flexibility of the Constitution alone

<details>
<summary>Show answer</summary>

**Logic:** Division of powers = federal feature.

**Ans: A.** **Division of powers** between Centre and States is a classic **federal** feature.

</details>

**Q96. UPPCS (Pre) 2012**

Judicial review in India is based on the procedure established by

A. the Constitution and is stronger than in the UK where Parliament is sovereign
B. the British convention that courts can strike all Acts freely
C. the idea that Parliament is supreme like in the UK
D. the absence of a written Constitution

<details>
<summary>Show answer</summary>

**Logic:** Judicial review India ≠ UK parliamentary sovereignty.

**Ans: A.** India has **judicial review** under a written Constitution. The **UK** follows **parliamentary sovereignty**, so Indian review is not the UK model.

</details>

**Q97. BPSC (Pre) 2020**

In India, the Constitution is supreme, whereas in the United Kingdom

A. Parliament is supreme
B. the Crown is above the Constitution in all matters of rights
C. courts can freely invalidate every Act without limits of parliamentary sovereignty doctrine
D. there is no legislature

<details>
<summary>Show answer</summary>

**Logic:** UK = parliamentary supremacy; India = constitutional supremacy.

**Ans: A.** In the **UK**, **Parliament** is traditionally supreme. In **India**, the **Constitution** is supreme.
...
**Logic:** No rigid USA-style separation in India.

**Ans: A.** India does **not** have **rigid separation of powers** as in the **USA**. The parliamentary model fuses executive and legislature.

</details>

**Q99. UKPCS (Pre) 2018**

Which of the following is true regarding the Indian Constitution?

A. It is the lengthiest written Constitution of any sovereign country
B. It is an unwritten Constitution
C. It has no Directive Principles
D. It rejects universal adult franchise

<details>
<summary>Show answer</summary>

**Logic:** Lengthiest written Constitution fact.

**Ans: A.** India’s Constitution is the **lengthiest written** Constitution of any sovereign country.
...
**Logic:** Not Presidential — Parliamentary is the salient feature.

**Ans: C.** India has a **Parliamentary**, not **Presidential**, form of government.
...
1. The Constitution of India has 395 Articles originally.
2. The Constitution of India has a Preamble.
...
**Logic:** Original ~395 Articles + Preamble both true in standard teaching.

**Ans: C.** Both are correct in standard teaching — originally about **395 Articles**, and there is a **Preamble**.
...
B. Independent judiciary
C. Division of powers
D. Flexible unwritten Constitution only

<details>
<summary>Show answer</summary>

**Logic:** Classical federation needs written/rigid tendency; ‘flexible unwritten only’ is not federal.

**Ans: D.** A classical federation needs a **written** Constitution with division of powers. **Flexible unwritten only** is not a federal feature.
...
A. a dual polity with a strong Centre
B. a confederation of sovereign States
C. a unitary State without States
D. a Presidential State without Parliament

<details>
<summary>Show answer</summary>

**Logic:** Dual polity + strong Centre = quasi-federal Union.

**Ans: A.** India establishes a **dual polity** with a **strong Centre** — often labelled quasi-federal.
...
A. The word ‘federation’ is not used in the Constitution; Article 1 says Union of States
B. Article 1 uses the word federation expressly
C. States have a constitutional right to secede
D. India is a confederation under Article 1

<details>
<summary>Show answer</summary>

**Logic:** Article 1 = Union of States; federation word not used.

**Ans: A.** **Article 1** describes India as a **Union of States**. The word **federation** is not used in the Constitution.

</details>

**Q105. BPSC (Pre) 2015**

Residuary powers under the Indian Constitution vest in
...
**Logic:** Residuary with Centre — Canada pattern.

**Ans: A.** **Residuary powers** vest in the **Union** (Canada pattern), not in the States as in the USA.

</details>

**Q106. UPPCS (Pre) 2018**

Which of the following is an Indian originality / not a borrowed feature in the usual list?

A. Basic Structure doctrine as judicial innovation / universal adult franchise politics as Indian choice
B. Parliamentary government borrowed label from UK
C. Fundamental Rights idea from USA
D. DPSP idea from Ireland

<details>
<summary>Show answer</summary>

**Logic:** UAF choice and Basic Structure politics treated as Indian originality.

**Ans: A.** Coaching lists **universal adult franchise** politics and later **Basic Structure** doctrine as **Indian** contributions, not mere copies of 1935.

</details>

**Q107. RAS/RTS (Pre) 2015**
...
**Ans: A.** The **Concurrent List** idea is borrowed from **Australia**.
...
**Ans: A.** **Directive Principles** are borrowed from the Constitution of **Ireland**.

</details>

**Q109. MPPCS (Pre) 2016**

Fundamental Rights in the Indian Constitution are largely inspired by
...
**Ans: A.** **Fundamental Rights** are largely inspired by the **USA** Bill of Rights tradition.
...
**Logic:** CAG pattern often listed from UK.

**Ans: A.** The **CAG** office is commonly listed as borrowed from the **UK** pattern.

</details>

**Q111. UPPCS (Pre) 2018**

Which one of the following is a correct statement about cooperative federalism in contemporary India?

A. GST Council and NITI Aayog are often cited as cooperative federalism institutions
B. States have a right to secede under cooperative federalism
C. Cooperative federalism abolishes the Union List
D. Cooperative federalism means dual citizenship

<details>
<summary>Show answer</summary>

**Logic:** GST Council / NITI as cooperative federalism examples.

**Ans: A.** **GST Council** and **NITI Aayog** are often cited as institutions of **cooperative federalism**.
...
A. Wheare — Quasi-federal
B. Austin — Cooperative federalism
C. Morris-Jones — Bargaining federalism
D. Jennings — Confederal India

<details>
<summary>Show answer</summary>

**Logic:** Jennings = centralising tendency, not confederal.

**Ans: D.** **Ivor Jennings** spoke of a **centralising tendency**, not a confederation.
...
A. the executive is not responsible to the legislature
B. the executive is collectively responsible to the lower house
C. the Prime Minister must be a member of the legislature
D. the Cabinet can be removed by a no-confidence vote in the ordinary parliamentary sense

<details>
<summary>Show answer</summary>

**Logic:** Presidential = executive not responsible to legislature.

**Ans: A.** In a **Presidential** system the executive is **not responsible** to the legislature in the parliamentary sense.
...
A. India has a synthesis of parliamentary sovereignty and judicial supremacy
B. India follows pure UK parliamentary sovereignty only
C. India follows pure USA judicial supremacy only without Parliament
D. India has no judicial review

<details>
<summary>Show answer</summary>

**Logic:** India synthesises parliamentary law-making with judicial review.

**Ans: A.** India is said to have a **synthesis** of **parliamentary sovereignty** and **judicial supremacy** — parliamentary law-making with constitutional judicial review.
...
B. The Indian Constitution is confederal in form
C. States may secede by a simple resolution
D. There is dual citizenship in India

<details>
<summary>Show answer</summary>

**Logic:** Ambedkar line — federal form, unitary spirit.

**Ans: A.** **B.R. Ambedkar** described the design as **federal in form but unitary in spirit**.
...
**Logic:** Judicial review is judicial, not a parliamentary House device.

**Ans: D.** **Judicial review** is a **judicial** power, not a parliamentary device like Question Hour or no-confidence.

</details>

**Q117. MPPCS (Pre) 2018**

Collective responsibility of the Council of Ministers is to
...
**Logic:** Collective responsibility → Lok Sabha.

**Ans: A.** Collective responsibility is to the **Lok Sabha**.

</details>

**Q118. UPPCS (Pre) 2012**

Which one of the following is a correct statement about Independent and Integrated judiciary?

A. Independent means free from organ control; integrated means one hierarchy under the Supreme Court
B. Independent means one hierarchy; integrated means free from organ control
C. Both mean the same thing
D. India has dual court systems like the USA

<details>
<summary>Show answer</summary>

**Logic:** Do not swap independent vs integrated meanings.

**Ans: A.** **Independent** judiciary means freedom from organ control. **Integrated** means **one hierarchy** under the Supreme Court. India does **not** use the USA dual-court model.

</details>

**Q119. IAS (Pre) 2016**

Which one of the following statements about India’s polity is correct?

A. India is a democratic republic with a parliamentary executive
B. India is an absolute monarchy
C. India is a Presidential dictatorship
D. India has no adult franchise

<details>
<summary>Show answer</summary>

**Logic:** Democratic republic + parliamentary executive.

**Ans: A.** India is a **democratic republic** with a **parliamentary** executive.
...
B. Secular — no State religion
C. Sovereign — external independence
D. Democratic — hereditary rule of one family only

<details>
<summary>Show answer</summary>

**Logic:** Democratic ≠ hereditary family rule.

**Ans: D.** **Democratic** does **not** mean hereditary family rule. That contradicts republic and democracy.
...
A. every adult citizen has the right to vote without discrimination of religion, race, caste or sex (subject to law)
B. only taxpayers can vote
C. only graduates can vote
D. only men can vote

<details>
<summary>Show answer</summary>

**Logic:** UAF = adult citizen vote without banned discriminations.

**Ans: A.** **Universal adult franchise** means every adult citizen can vote without discrimination on grounds of religion, race, caste or sex, subject to law.
...
**Logic:** Kesavananda 1973 again — high-yield repeat.

**Ans: B.** The doctrine was enunciated in the ***Kesavananda Bharati* case (1973)**.

</details>

**Q123. CGPSC (Pre) 2017**

Which of the following is true about emergency and federalism in India?

A. During Emergency the Constitution can work in a unitary manner
B. Emergency abolishes the Supreme Court
C. Emergency creates dual citizenship
D. Emergency deletes the Preamble

<details>
<summary>Show answer</summary>

**Logic:** Emergency = unitary working of an otherwise federal Constitution.

**Ans: A.** During **Emergency**, the Constitution can operate in a **unitary** manner while remaining federal in form.

</details>

**Q124. UPPCS (Pre) 2011**

Which one of the following is correct regarding amendment of the Constitution?

A. It is a blend of rigidity and flexibility with different procedures
B. Every provision needs a referendum
C. No provision can ever be amended
D. Only the President can amend by ordinance permanently

<details>
<summary>Show answer</summary>

**Logic:** Amendment blend — rigid cum flexible.

**Ans: A.** Constitutional amendment in India blends **rigidity and flexibility** through different procedures (including Article **368** and simple-majority paths).

</details>

**Q125. MPPCS (Pre) 2020**

Which of the following best describes Rule of Law?

A. No one is above the law; equality before law; predominance of legal spirit
B. The King is above the law
C. Military decrees replace all courts
D. Fundamental Rights are abolished

<details>
<summary>Show answer</summary>

**Logic:** Diceyan Rule of Law elements.

**Ans: A.** **Rule of Law** (Dicey) stresses that **no one is above the law**, equality before law, and predominance of the legal spirit.
...
A. Constitutional supremacy means the Constitution is the highest law
B. Constitutional supremacy means Parliament can never be limited
C. Constitutional supremacy means the President is above the Constitution
D. Constitutional supremacy means States may ignore Union laws always

<details>
<summary>Show answer</summary>

**Logic:** Constitutional supremacy ≠ parliamentary unlimited power.

**Ans: A.** **Constitutional supremacy** means the **Constitution** is the highest law of the land.
...
B. A dual judiciary
C. Three lists in the Constitution for distribution of powers
D. A federal Supreme Court to interpret the Constitution

<details>
<summary>Show answer</summary>

**Logic:** Common = federal apex court interpreting Constitution; not dual citizenship/judiciary/three lists as shared.

**Ans: D.** A **federal Supreme Court** interpreting the Constitution is a common feature. India has **single** citizenship and an **integrated** judiciary, unlike the USA.

</details>

**Q128. UPPCS (Pre) 2008**

Which of the following is not a feature of the Parliamentary government?

A. Collective responsibility
B. Political homogeneity
C. Fixed executive tenure independent of the legislature
D. Leadership of the Prime Minister

<details>
<summary>Show answer</summary>

**Logic:** Fixed executive independent of legislature = Presidential trait.

**Ans: C.** A **fixed executive tenure independent of the legislature** is a **Presidential**, not parliamentary, trait.

</details>

**Q129. BPSC (Pre) 2021**

The real executive authority in India is vested in

A. the Council of Ministers headed by the Prime Minister
B. the President alone in personal capacity always
...
**Logic:** Real executive = PM + Council of Ministers.

**Ans: A.** The **real executive** is the **Council of Ministers** headed by the **Prime Minister**. The President is the **nominal** executive.
...
A. Nominal executive — President; Real executive — Prime Minister and Council of Ministers
B. Nominal executive — Prime Minister; Real executive — President
C. Nominal executive — Speaker; Real executive — Chief Justice
D. Nominal executive — Governor only; Real executive — Election Commission

<details>
<summary>Show answer</summary>

**Logic:** Nominal vs real executive pairing.

**Ans: A.** The **President** is the **nominal** executive. The **Prime Minister** with the **Council of Ministers** is the **real** executive.
...
A. India is a Union of States as per Article 1
B. India is a Confederation of States as per Article 1
C. India is a League of States as per Article 1
D. India is a Dominion of States as per Article 1

<details>
<summary>Show answer</summary>

**Logic:** Article 1 Union of States.

**Ans: A.** **Article 1** declares India to be a **Union of States**.

</details>

**Q132. UPPCS (Pre) 2019**

Public Interest Litigation helps the Rule of Law mainly by
...
**Logic:** PIL widens access to justice — supports Rule of Law.

**Ans: B.** **PIL** supports the Rule of Law by widening **access to justice** for weaker sections.
...
A. India has adopted the Parliamentary system with a republican Head of State
B. India has adopted the Presidential system with a hereditary monarch
C. India has adopted the Swiss system exclusively
D. India has adopted the Chinese system exclusively

<details>
<summary>Show answer</summary>

**Logic:** Parliamentary + Republican Head.

**Ans: A.** India combines a **parliamentary** system with a **republican** elected Head of State.
...
A. Flexible Constitution — UK (largely)
B. Flexible Constitution — USA (entirely rigid only)
C. Rigid Constitution — UK (entirely)
D. Unwritten Constitution — India

<details>
<summary>Show answer</summary>

**Logic:** UK largely flexible/unwritten conventions; India written blend.

**Ans: A.** The **UK** Constitution is largely **flexible** (and unwritten in the classical sense). **India** has a written Constitution with a rigid–flexible blend.
...
A. In India, the same person cannot be a member of both Houses of Parliament at the same time
B. In India, the same person cannot be a member of Parliament and a State Legislature at the same time for long
C. A minister must be a member of the legislature within a constitutionally fixed period if not already
D. The Indian system is a Presidential system where ministers need not relate to the legislature

<details>
<summary>Show answer</summary>

**Logic:** Last option invents Presidential system — wrong.

**Ans: D.** India is **not** Presidential. Ministers are linked to the **legislature** through membership rules and collective responsibility.
...
B. Political parties only
C. Written Constitution only
D. Bicameral legislature only

<details>
<summary>Show answer</summary>

**Logic:** Four elements of State.

**Ans: A.** Essential elements of the **State** are **population, territory, government and sovereignty**.

</details>

### Section C — National Symbols
...
**Logic:** Anthem adopted 24 Jan 1950.

**Ans: A.** **Jana Gana Mana** was adopted as the National Anthem on **24 January 1950**.

</details>

**Q138. BPSC (Pre) 2016**

The Hindi version of the National Anthem was adopted on
...
**Logic:** Hindi version same date — 24 Jan 1950.

**Ans: A.** The Constituent Assembly adopted the Anthem (including the Hindi rendering context in teaching) on **24 January 1950**.
...
**Logic:** Full Anthem ≈ 52 seconds.

**Ans: A.** The full rendition of the National Anthem takes about **52 seconds**.

</details>

**Q140. MPPCS (Pre) 2014**

The State Emblem of India was adopted on
...
**Logic:** Emblem adopted 26 Jan 1950.

**Ans: A.** The **State Emblem** (Lion Capital of Sarnath) was adopted on **26 January 1950**.

</details>

**Q141. UPPCS (Pre) 2008**

The National Flag was adopted by the Constituent Assembly on
...
**Logic:** Flag adopted 22 July 1947.

**Ans: A.** The present **National Flag** design was adopted on **22 July 1947**.

</details>

**Q142. IAS (Pre) 2002**

The design of the National Flag was prepared by
...
**Logic:** Flag designer = Pingali Venkayya.

**Ans: A.** **Pingali Venkayya** designed the National Flag.

</details>

**Q143. UPPCS (Pre) 2015**

The Ashoka Chakra in the National Flag has
...
**Logic:** 24 spokes in the Chakra.

**Ans: A.** The **Ashoka Chakra** has **24 spokes**.

</details>

**Q144. BPSC (Pre) 2018**

The ratio of the length to the width (hoist) of the National Flag is
...
**Logic:** Flag ratio 3:2.

**Ans: A.** The ratio of length to width of the National Flag is **3 : 2**.

</details>

**Q145. UPPCS (Pre) 2016**

Which of the following sizes is not a standard size of the National Flag under the Flag Code of India?
...
**Logic:** Flag Code — 600×400 is not a listed standard size.

**Ans: A.** Under the **Flag Code of India**, **600 mm × 400 mm** is **not** among the standard sizes listed.
...
**Logic:** National animal = Tiger.

**Ans: A.** The **National Animal** of India is the **Tiger** (*Panthera tigris*).
...
**Logic:** National flower = Lotus.

**Ans: A.** The **National Flower** is the **Lotus**.
...
**Logic:** National bird = Peacock.

**Ans: A.** The **National Bird** is the **Indian Peacock**.

</details>

**Q149. BPSC (Pre) 2015**

The wheel in the National Flag / Ashoka Chakra symbolises
...
**Logic:** Wheel = Justice / Dharma Chakra.

**Ans: A.** The **Ashoka Chakra** symbolises **Dharma** / **justice** (movement and righteousness).

</details>

**Q150. UPPCS (Pre) 2014**

The National Calendar of India is based on

A. Saka Era
B. Vikram Era
C. Hijri Era
D. Gregorian Era alone without Saka

<details>
<summary>Show answer</summary>

**Logic:** National Calendar = Saka, not Vikram.

**Ans: A.** The **National Calendar** is based on the **Saka** Era, **not** the Vikram Era.

</details>

**Q151. MPPCS (Pre) 2019**

The National Calendar based on the Saka Era was adopted on
...
**Logic:** Saka calendar adopted 22 March 1957.

**Ans: A.** The **Saka**-based National Calendar was adopted on **22 March 1957**, along with use of the Gregorian calendar.
...
**Logic:** Motto from Mundaka Upanishad.

**Ans: A.** **Satyameva Jayate** is from the **Mundaka Upanishad**, written in Devanagari below the emblem.
...
**A/R logic:** Parliamentary form means nominal head + real executive collectively responsible to the Lok Sabha/legislature.
...
**Ans: C.** A-4, B-3, C-1, D-2 is correct.

**Logic:** Austin cooperative; Morris-Jones bargaining; Wheare quasi-federal; Jennings centralising tendency.
...
A. Ivor Jennings — Quasi-federal
B. K.C. Wheare — Quasi-federal
C. Granville Austin — Cooperative federalism
D. Morris-Jones — Bargaining federalism

<details>
<summary>Show answer</summary>

**Ans: A.** Jennings is linked to centralising tendency, not the quasi-federal label.

**Logic:** Quasi-federal is Wheare’s tag; do not swap with Jennings.
...
**Ans: B.** 1951 → 1967 → 1973 → 1980.

**Logic:** Basic-structure chronology: Shankari Prasad → … → Golaknath → Kesavananda → Minerva Mills.
...
1. Article 1 calls India a Union of States.
...
**Q11.** Match List-I (source) with List-II (feature):
...
| 3 | Procedure established by law (Art. 21 style) |
| 4 | Concurrent List |
...
**Logic:** USA FR; Ireland DPSP; Australia Concurrent; Japan procedure-established-by-law style.

</details>

**Q12.** Which one of the following pairs is NOT correctly matched?
A. Residuary powers — Canada pattern (Centre)
B. Concurrent List — Australia
C. Residuary powers — USA pattern (States)
D. DPSP — Ireland

<details>
<summary>Show answer</summary>

**Ans: C.** India follows Canada (Centre residuary), not USA (States).

**Logic:** Classic residual-source trap.

</details>

**Q13.** With reference to independent and integrated judiciary, consider the following statements:
1. Independent judiciary means freedom from organ control.
2. Integrated judiciary means one hierarchy under the Supreme Court.
...
**Logic:** India’s judiciary is integrated, not USA-style dual.

</details>

**Q14.** Consider the following statements about Basic Structure:
1. Kesavananda Bharati (1973) propounded the Basic Structure doctrine.
...
**Q16.** With reference to citizenship and franchise features, which of the following is/are correct?
1. India provides for single citizenship.
...
**Q17.** Arrange the following Preamble-related events/texts in order:
1. Adoption of the Constitution (Preamble date line)
2. Enforcement as Sovereign Democratic Republic
3. 42nd Amendment adding Socialist and Secular
...
**Ans: C.** 26 Nov 1949 → 26 Jan 1950 → 42nd Amendment (1976).

**Logic:** Adoption date line, enforcement status, then 42nd words.

</details>

**Q18.** Consider the following statements:
1. N.A. Palkhivala called the Preamble the Constitution’s identity card.
...
**Q19.** Which of the following pairs is/are NOT correctly matched?
1. Berubari (1960) — Preamble not part of the Constitution
2. Kesavananda (1973) — Preamble is part of the Constitution
3. Rule of Law — Constitution is the highest law (exact synonym of constitutional supremacy)
...
**Logic:** Rule of law ≠ identical to constitutional supremacy; related but distinct labels.

</details>

**Q20.** With reference to parliamentary features in India, which of the following is/are correct?
1. The President is the nominal executive.
2. The Prime Minister with the Council of Ministers is the real executive.
3. Collective responsibility is to both Houses equally for confidence voting.
...
**Logic:** Collective responsibility / confidence is to the Lok Sabha, not both Houses equally.

</details>

**Q21.** Consider the following statements about Emergency and federal design:
1. In normal times the system is meant to work federally.
...
**Q22.** Consider the following Assertion and Reason:

Assertion (A): India synthesises parliamentary law-making with judicial review.

Reason (R): India follows pure UK parliamentary sovereignty without judicial review of legislation.
...
**A/R logic:** India is neither pure UK parliamentary sovereignty nor pure USA judicial supremacy.

</details>

**Q23.** With reference to originally (1950) structural counts, which of the following is correct?
A. About 395 Articles, 25 Parts and 12 Schedules
B. About 448 Articles, 22 Parts and 8 Schedules
C. About 395 Articles, 22 Parts and 12 Schedules
D. About 395 Articles, 22 Parts and 8 Schedules

<details>
<summary>Show answer</summary>

**Ans: D.** The 1950 frame is about 395 Articles, 22 Parts and 8 Schedules.

**Logic:** Later expansion of Parts/Schedules/Articles is a distractor against the original frame.

</details>

**Q24.** Consider the following statements:
1. Fundamental Rights + DPSP + Fundamental Duties is part of the salient package.
...
**Q25.** Which one of the following is NOT a correct description of India’s polity?
A. Parliamentary form of government
B. Presidential system because of an elected President
C. Quasi-federal Union
D. Democratic Republic

<details>
<summary>Show answer</summary>

**Ans: B.** An elected President does not make India a Presidential system.

**Logic:** Type of government is parliamentary; polity structure is quasi-federal.

</details>

**Q26.** With reference to cooperative and competitive federalism, which of the following is/are correct?
1. Cooperative federalism stresses Centre–State collaboration (Austin’s line).
2. Competitive federalism stresses States competing for growth.
3. GST Council examples change the Constitution from quasi-federal to confederal.
...
**Logic:** CA examples illustrate modes; they do not rewrite the quasi-federal core.

</details>

**Q27.** Consider the following Assertion and Reason:

Assertion (A): Article 368 is the only path for every constitutional change including formation of new States under Articles 2–4.

Reason (R): Articles 2–4 changes are effected by simple majority and are outside Article 368.
...
**A/R logic:** A overstates 368 exclusivity; R correctly states the simple-majority Arts. 2–4 path.

</details>

**Q28.** Consider the following statements about criticisms of the Constitution:
1. Calling it a pure carbon copy of the GOI Act 1935 ignores republic, FR politics and Basic Structure.
...
**Q29.** How many of the following are correctly matched?
1. Equality in Preamble — two limbs
2. Fraternity — dignity of individual and unity and integrity of the Nation
3. Preamble date line — 26 January 1950
...
**Ans: A.** Only two are correctly matched.

**Logic:** Preamble date line is 26 November 1949; Equality 2 and Fraternity limbs are correct.

</details>

**Q30.** With reference to amendment tracks, which of the following statements is/are correct?
1. Some changes use simple majority of Parliament (e.g., Arts. 2–4, 169).
2. Federal provisions may need special majority plus ratification by half the States.
3. Article 368 is unused because India has only a flexible Constitution.
...
**Logic:** India blends rigidity and flexibility; Article 368 remains central for many amendments.
