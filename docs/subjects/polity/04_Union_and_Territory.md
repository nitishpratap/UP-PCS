# Topic 4 — Union & Territory
### ★ UPPCS Revision Sheet — Lucent / PW style (one block per theme · no repetition)

<details>
<summary><strong>Covers syllabus</strong> (click to expand)</summary>

Union and its Territory | Formation of States | State Reorganisation | States Reorganisation Act, 1956 | States Reorganisation Commission (Fazl Ali) | Union Territories | Administration of Union Territories | Lieutenant Governor | Article 239AA (Delhi Special Provisions) | Special Provisions for Puducherry | Acquisition of Territory | Cession of Territory | Article 1–4 | National Integration Council | Citizenship | Single Citizenship | Citizenship Act, 1955 | Modes of Acquisition of Citizenship | Modes of Loss of Citizenship | OCI / NRI / PIO (basic) | Citizenship Amendment Act (basic)
...
| **2** | Admission / establishment of new States | Parliament may by law **admit** into the Union, or **establish**, new States on such terms as it thinks fit. Used for territory that was **not already a State of the Union** (classic path: **Sikkim**). |
...
**Ans: D.** Altering the name = **Parliament under Art. 3**, not the State Legislature (State only gives non-binding views).

</details>

---

## Acquisition vs Cession of Territory
...
## State Reorganisation — Commissions & First Linguistic State
...
- Appointed **29 Dec 1953** (Nehru government). Report submitted **30 Sep 1955**; published 1955.
...
**Ans: B — 2 and 4.** SRC = Fazl Ali (chair) + Panikkar + Kunzru.
...
| **1961** | Goa, Daman & Diu liberated (**19 Dec**, Operation Vijay); 12th Amd 1962 (UT); DNH already UT |
| **1963** | **Nagaland** 16th State |
| **1966** | Punjab Reorganisation → **Punjab + Haryana**; **Chandigarh** UT; HP enlarged |
| **1971** | **Himachal Pradesh** State |
| **1972** | **Manipur, Tripura, Meghalaya** States; Mizoram & Arunachal become UTs |
| **1975** | **Sikkim** 22nd State (**36th Amendment**; 35th had made it associate State, 1974) |
| **1987** | **Goa, Mizoram, Arunachal Pradesh** States (Goa 30 May; Daman & Diu remained UT) |
| **2000** | **Chhattisgarh** 1 Nov · **Uttarakhand** (then Uttaranchal) **9 Nov** · **Jharkhand** 15 Nov |
| **2014** | **Telangana** 2 June (AP Reorganisation Act, 2014) |
...
- **Part VIII** (Arts. **239–241**). UTs are **not** States: they are administered by the **President** (Centre), not by a Governor under Part VI.
...
| Legislature + CoM | **Delhi (239AA)**; **Puducherry (239A)**; **J&K** (J&K Reorganisation Act, **2019**) | Elected Assembly + CM; LG remains the Centre’s appointee |
...
## Lieutenant Governor (vs Administrator / Governor)

| Point | Lieutenant Governor / Administrator (UT) | Governor (State) |
|-------|------------------------------------------|------------------|
| Source | **Art. 239** (President’s appointee; may be titled LG) | **Art. 155** |
| Tenure | Pleasure of the **President** | Pleasure of the President; normally 5 years |
| Aid & advice | Only where a CoM exists (Delhi / Puducherry / J&K) — and even then **discretion / reference to President** is wider | Art. 163 — aid & advice except constitutional discretion |
...
## Article 239AA — Delhi (NCT)

- Delhi was a **Part C State** → **UT (1956)** → **NCT** by **69th Constitutional Amendment, 1991** (Arts. **239AA, 239AB**). Working statute: **GNCTD Act, 1991**.
- **Trap:** 69th created **National Capital Territory**. **NCR** (National Capital **Region**) is a **planning** region under the **NCRPB Act, 1985** (Delhi + districts of Haryana, UP, Rajasthan). Papers sometimes say “Region” but the amendment answer is **69th**.
- **70th Amendment, 1992:** elected MLAs of NCT Delhi (and Puducherry) vote in the **Presidential election**.

**What 239AA actually provides**
...
- **GNCTD (Amendment) Act, 2023** (after 19 May 2023 Ordinance): **National Capital Civil Services Authority** (CM + Chief Secretary + Principal Home Secretary); **LG has the final say** on transfers/postings of specified officers. The 2023 Amendment Act was later repealed as a **spent/incorporated** law by the **Repealing and Amending Act, 2025** — the **text survives inside the 1991 principal Act**.

**PYQ — UPPCS Prelims 2022, Q131**
...
**Ans: D — 69th** (1991). Strict wording = **National Capital Territory**; 70th = Presidential electoral college.

</details>

---

## Special Provisions — Puducherry

- Four **non-contiguous** former French territories: **Puducherry, Karaikal** (Tamil Nadu coast), **Mahe** (Kerala coast), **Yanam** (Andhra coast).
...
### Delhi vs Puducherry vs J&K (UT-with-legislature)

| Point | Delhi (NCT) | Puducherry | J&K (from 31 Oct 2019) |
|-------|-------------|------------|------------------------|
| Article / law | **239AA** (69th Amd) | **239A** (14th Amd) | **J&K Reorganisation Act, 2019** (not 239AA) |
| Reserve subjects | Public order, police, **land** with Centre | No 239AA-style triplet | Police, public order, All-India Services etc. with LG / Centre (as in the Act) |
| Assembly size (order) | **70** | **30** elected (+ nominated) | **90** elected (24 PoK seats remain vacant as provided) |
| Presidential college | Yes (70th) | Yes (70th) | No Assembly vote in Art. 54 college in the Delhi/Puducherry way |
| Statehood | Never a full State after 1956 | Never a State | **Was a State** till 2019; Centre has said restoration is intended — **still UT (Aug 2026)** |
...
- **Part II = Arts. 5–11.** The Constitution does **not** contain a complete citizenship code — only commencement rules + **Art. 11** power. Working law = **Citizenship Act, 1955** (amended 1986, 1992, 2003, 2005, 2015, **2019**).
- Some FRs (e.g. Art. **15, 16, 19, 29, 30**) are mainly for **citizens**; Arts. **14, 20, 21, 22, 25–28, 32** also protect **non-citizens** (as interpreted).

### Single citizenship
- India = **one citizenship of the Union** for the whole country. **No** separate State citizenship (unlike **USA** — US citizen + State citizen).
- One civil-political status throughout India: an Indian can live, work and enjoy citizen-FRs in every State (subject to reasonable restrictions / special provisions like 371 / Inner Line where law so provides).
- **Does not** mean India allows **dual nationality** with a foreign country — that is banned (Art. 9 + termination under the 1955 Act). OCI is **not** a second citizenship.
...
| **6** | Migrants from Pakistan | Rights of citizenship of certain persons who migrated from Pakistan. Cut-off **19 July 1948** (after that: registration). |
| **7** | Migrants to Pakistan | Persons who migrated to Pakistan after 1 Mar 1947 generally **not** citizens; returning permit-holders may register. |
| **8** | Indians residing abroad | Persons of Indian origin abroad may register as citizens with Indian diplomatic/consular post. |
| **9** | Voluntary foreign citizenship | If a person voluntarily acquires citizenship of a foreign State, Arts. 5–8 **do not apply**. |
| **10** | Continuance | Citizenship continues subject to any law made by Parliament. |
| **11** | Parliament’s power | Parliament may make **any** provision on acquisition / termination / other matters of citizenship. |

**PYQ — UPPCS Prelims 2020, Q114**
...
**Ans: B — Part II.** Part I = Union and its Territory.

</details>

**PYQ — UPPCS Prelims 2022, Q100**
...
Five statutory modes (**ss. 3–7**). **Illegal migrant** (2003): entered without valid documents **or** overstayed — generally **barred** from birth / registration / naturalisation (CAA is a listed exception).

### 1. By birth (s. 3) — three clocks

| Born in India | Rule |
|---------------|------|
| **26 Jan 1950 – 1 Jul 1987** | Citizen by birth **irrespective of parents** (except children of enemy aliens / foreign diplomats as provided) |
| **1 Jul 1987 – 2 Dec 2004** | Citizen if **either parent** was an Indian citizen at birth (**1986** amendment) |
| **On/after 3 Dec 2004** | Citizen only if **both parents** are Indian citizens, **or** one is Indian and the other is **not an illegal migrant** (**2003** amendment) |

### 2. By descent (s. 4)
- Born **outside** India to an Indian-citizen parent.
- After **3 Dec 2004**, birth must ordinarily be **registered** at an Indian consulate within **1 year** (or later with permission). Descent through the father only was the old rule; **1992** amendment allowed the **mother** also.

### 3. By registration (s. 5)
Central Government may register (among others):
...
- Persons married to Indian citizens and resident **7 years**
- Minor children of Indian citizens
- OCI cardholders resident **5 years** and resident in India **1 year** before applying (as provided)
...
| **Deprivation (s. 10)** | **Central Government order** — only against citizenship obtained by **registration or naturalisation** | Grounds: fraud/false representation; disloyalty; unlawfully traded/communicated with the enemy in war; ordinary residence **outside India for 7 years** without the prescribed annual declaration |

> **Trap:** Birth-citizens are not “deprived” under s. 10 in the same way; they may still **renounce** or **terminate**.
...
Assertion (A): Cession of Indian territory requires a constitutional amendment.

Reason (R): Acquisition of territory can be provided by ordinary law.
...
**A/R logic:** Both are true Berubari-line facts, but acquisition rules do not explain why cession needs amendment.
...
| Code | Item |
|------|------|
| 1 | NCT Delhi special provisions |
| 2 | Union of States |
| 3 | UT administration via Administrator/LG |
| 4 | Puducherry legislature enabling |
...
**Ans: C.** A-3, B-4, C-1, D-2 is correct.

**Logic:** 239 UT admin; 239A Puducherry; 239AA Delhi; 1 Union of States.

</details>

**Q4.** Which of the following pairs is NOT correctly matched?
A. SRC Chair — Justice Fazl Ali
B. SRC member — K.M. Panikkar
C. SRC member — H.N. Kunzru
D. SRC member — P. Sitaramayya

<details>
<summary>Show answer</summary>

**Ans: D.** Sitaramayya belongs to JVP, not SRC.
...
1. Dhar Commission
2. Andhra as first linguistic State
3. States Reorganisation Act / 7th Amendment scheme
4. SRC (Fazl Ali Commission) set up
...
**Ans: A.** Dhar (1948) → SRC (1953) → Andhra (1953) → SRA/7th (1956).

**Logic:** Andhra (1 Oct 1953) follows SRC appointment; full SRA map is 1 Nov 1956.
...
**Q9.** With reference to present territorial map, which of the following is correct?
A. 29 States and 7 Union Territories
B. 28 States and 9 Union Territories
C. 25 States and 8 Union Territories
D. 28 States and 8 Union Territories

<details>
<summary>Show answer</summary>

**Ans: D.** India has 28 States and 8 Union Territories in the post-2019 teaching map.

**Logic:** J&K reorganisation and later UT mergers yield 28+8.

</details>

**Q10.** Which of the following pairs is/are NOT correctly matched?
1. NCT — constitutional territory under 69th Amendment
2. NCR — wider statutory planning region (1985 Act)
3. NIC — constitutional body under Article 263
...
**Logic:** National Integration Council is extra-constitutional; Article 263 is Inter-State Council.
...
| Code | Item |
|------|------|
| 1 | States + UT scheme / end of A-B-C-D Parts |
| 2 | Berubari cession |
| 3 | NCT Delhi |
| 4 | India–Bangladesh LBA / enclave exchange |
...
**Ans: B.** A-2, B-4, C-1, D-3 is correct.

**Logic:** 9th Berubari; 100th LBA; 7th reorganisation frame; 69th Delhi.

</details>

**Q12.** Consider the following statements about Andhra:
1. Andhra became the first linguistic State on 1 October 1953.
2. Its first capital was Kurnool.
3. Its first capital was Hyderabad.
...
**Logic:** First capital Kurnool, not Hyderabad.

</details>

**Q13.** With reference to modes of acquisition and loss of citizenship, which of the following is/are correct?
1. Acquisition modes include birth, descent, registration, naturalisation and incorporation of territory.
2. Loss modes include renunciation, termination and deprivation.
3. Renunciation is a Central order against a citizen, while deprivation is voluntary.
...
**Logic:** Renunciation is voluntary; deprivation is a Central order — do not swap.

</details>

**Q14.** Arrange the following in chronological order:
1. Operation Vijay (Goa)
2. Goa Statehood
3. Sikkim full Statehood (36th Amendment)
...
**Ans: A.** 1961 → 1975 → 1987.

**Logic:** Goa liberation 1961; Sikkim 1975; Goa State 1987.

</details>

**Q15.** Consider the following Assertion and Reason:

Assertion (A): NRI denotes an Indian citizen living abroad.

Reason (R): OCI denotes a foreign citizen of Indian origin with a card status.
...
**A/R logic:** Both definitions are true confused-pair facts; R does not explain what NRI means.

</details>

**Q16.** With reference to UT Assemblies in the usual teaching set, which of the following is/are correct?
1. Delhi has 70 MLAs.
...
A. CAA cut-off — 31 December 2014
B. Citizenship Act — 1955
C. CAA countries — five neighbouring countries in the core teaching fact
D. Article 11 — Parliament’s power to regulate citizenship

<details>
<summary>Show answer</summary>

**Ans: C.** Core CAA teaching uses three neighbouring countries, not five.

**Logic:** Three-country + 31 Dec 2014 cut-off is the standard fact.

</details>

**Q18.** Consider the following statements about SRC recommendations vs implementation:
1. SRC recommended 16 States and 3 UTs.
...
**Q19.** With reference to birth-citizenship clocks, which of the following is/are correct?
1. From 1987, one parent citizen became the working rule in teaching.
2. From 3 December 2004, both parents citizens, or one citizen and the other not an illegal migrant.
3. Birth in India alone always confers citizenship regardless of parents’ status after 2004.
...
**Logic:** Post-2004 rules tighten parentage; pure jus soli is not the rule.
...
|------|------|
| 1 | 371F |
| 2 | Rejected immediate linguistic States (1948) |
| 3 | Rejected language basis (Nehru–Patel–Sitaramayya) |
| 4 | Fazl Ali, Panikkar, Kunzru |
...
**Logic:** Dhar/JVP rejection lineage; SRC trio; Sikkim 371F.

</details>

**Q21.** Consider the following Assertion and Reason:

Assertion (A): India is described as a Union of States under Article 1.

Reason (R): States have a constitutional right to secede from the Union.
...
**A/R logic:** Union of States means no secession; Parliament may reorganise States.

</details>

**Q22.** Consider the following statements about French and Portuguese territories:
1. Goa, Daman and Diu joined after Operation Vijay (19 December 1961).
2. French establishments around Puducherry were de facto 1954 and de jure 1962.
3. Goa became a State in 1961 immediately on liberation.
...
**Logic:** Goa Statehood is 1987, not 1961.

</details>

**Q23.** With reference to Article 1(3), territory of India includes which of the following?
1. States
2. Union Territories
...
A. First linguistic State — Gujarat, 1960
B. Sikkim associate stage — 35th Amendment path teaching
C. Sikkim full State — 36th Amendment, 1975
D. First linguistic State — Andhra, 1953

<details>
<summary>Show answer</summary>

**Ans: A.** Andhra (1953) is the first linguistic State, not Gujarat.

**Logic:** Gujarat/Maharashtra split is later than Andhra’s formation.

</details>

**Q25.** How many of the following statements are correct?
1. State Legislature cannot itself change the State’s name under Article 3.
2. Names and territorial extent sit in the First Schedule.
3. Article 4 may amend the First and Fourth Schedules.
...
**Logic:** Name change via Parliament; Schedules + Art. 4 path.

</details>

**Q26.** Arrange the following citizenship-related items in the order they appear in the Constitution:
1. Article 5
2. Article 9
3. Article 11
...
**Ans: C.** Articles 5 → 9 → 11.

**Logic:** Ascending order within Part II.

</details>

**Q27.** With reference to JVP Committee, which of the following is/are correct?
1. It included Jawaharlal Nehru, Vallabhbhai Patel and Pattabhi Sitaramayya.
2. It favoured immediate linguistic reorganisation in 1948–49.
3. It rejected immediate linguistic reorganisation.
...
**Logic:** JVP rejected immediate language basis, like Dhar.

</details>

**Q28.** Consider the following Assertion and Reason:

Assertion (A): K.T. Shah was a member of the States Reorganisation Commission.

Reason (R): SRC members were Justice Fazl Ali, K.M. Panikkar and H.N. Kunzru.
...
**A/R logic:** K.T. Shah was not an SRC member; the correct trio is Fazl Ali, Panikkar and Kunzru.

</details>

**Q29.** Consider the following statements about Delhi and Puducherry:
1. Article 239AA is linked to the 69th Amendment.
2. Article 239A is linked to the 14th Amendment teaching for Puducherry legislature.
3. Both Delhi and Puducherry are full States under Part VI.
...
**Logic:** Both remain UTs with legislatures, not full Part VI States.

</details>

**Q30.** With reference to Jammu & Kashmir UT legislature strength in the usual teaching set, which of the following is correct?
A. 70 MLAs
B. 90 MLAs
C. 30 MLAs
D. 100 MLAs
...
**Ans: B.** Jammu & Kashmir UT Assembly strength in the usual set is 90.

**Logic:** Delhi 70 / Puducherry 30 / J&K 90 is the Assembly map trap set.
