# Topic 4 — SC/ST, Minorities & Official Language
...
1. **1969 or statehood year 2000 as ST notification** → **1967**.
2. **Adding Garhwali / Kumaoni as ST** → language groups ≠ the five STs.
3. **Raji not among five** → Raji is included.
