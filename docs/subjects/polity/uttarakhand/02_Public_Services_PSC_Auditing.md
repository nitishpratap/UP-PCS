...
| Pair | Key |
|------|-----|
| UKPSC vs UPSC | State recruitment vs Union recruitment |
...
## 2.3 Auditing and legislative scrutiny
...
**Logic:** Union vs state law officer titles.
...
3. **State Finance Commission = UKPSC** → different constitutional / statutory roles.
