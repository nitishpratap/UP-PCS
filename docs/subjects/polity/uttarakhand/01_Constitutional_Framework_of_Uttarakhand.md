...
| First Advocate General | **Nanda Ballabh Tiwari** (coaching pair — verify against distractors in Q135) |
...
- The Governor is the constitutional head; the Chief Minister and Council of Ministers exercise real executive power.
- UKPCS 2025 keyed **both** Governor-as-head and CM–CoM statements as correct for the state executive.

---

## 1.2 First office-holders ratta
...
- Coaching also remembers early Advocate General and Finance Commission names; test each pair, do not assume one person held every first post.

---

## 1.3 Legislature personalities
