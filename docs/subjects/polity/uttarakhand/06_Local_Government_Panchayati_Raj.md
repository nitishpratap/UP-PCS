# Topic 6 — Local Government & Panchayati Raj
...
| Asian Mayors’ Conference 2006 | **Dehradun** |
| Community development | CD blocks / schemes bridge Panchayats and line departments |
...
- Always read “not maintained by Panchayats” as an odd-one-out stem.
...
1. **Birth–death register not with Panchayat** → it is; health register is not.
2. **Mayors’ Conference at Mussoorie** → Dehradun.
3. **Grant register = odd one** → health register is the odd one.
