...
| Appropriation | Money from Consolidated Fund only after Assembly appropriation |
| Elections | State Assembly + local body elections under EC / SEC frameworks |
| Parties | National + state parties contest UK Assembly; anti-defection applies |
| State Finance Commission | Recommends devolution to Panchayats / municipalities — not UKPSC |
...
1. **All spending directly from Contingency Fund without later regularisation** → advances are later appropriated.
2. **SEC conducts Assembly elections** → ECI does.
