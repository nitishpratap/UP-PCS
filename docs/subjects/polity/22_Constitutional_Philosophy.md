# Topic 22 — Constitutional Philosophy
...
- India's version of this idea is **constitutional supremacy** (see the card below), not Dicey's parliamentary sovereignty.
- The UK shows constitutionalism **without** one supreme coded document: conventions, statutes, and courts still bind the Crown-in-Parliament *politically*, even though courts do not strike primary Acts in the classic Dicey picture.
- Ambedkar told the Constituent Assembly that a constitution is only as good as the people who **work** it — that is why **constitutional morality** sits right next to this idea.
...
> **Logic:** “Written = constitutionalism” is false. The UK is unwritten, still a constitutional *practice*. Some written charters are not.
...
- *Manoj Narula* **2014** — PM/CM should not load the Council with people facing serious criminal clouds — constitutional morality of **office**
- *Govt. of NCT of Delhi v UOI* **2018** (5-j.) — Delhi is not a full State, but the LG is **not** a parallel CM. **Aid and advice** of the elected Council binds the LG except where the Constitution/statute gives him a real discretion
- *Navtej Singh Johar* **2018** — IPC **§377** (consensual same-sex) struck. Constitutional morality **≠** majoritarian morality
- *Indian Young Lawyers (Sabarimala)* **2018** — exclusion of women 10–50 struck (as then held). Equality over a custom sold as “morality”
- *Joseph Shine* **2018** — IPC adultery struck; women are not the husband’s property
- NCT Delhi (services) **2023** (5-j.) — **services** (except public order / police / land) with the **elected government**, not the LG
...
> **Logic:** Constitutional morality ≠ 42nd / Art. 51A. ≠ public morality in Arts. 19/25.

---

## Rule of Law

**A.V. Dicey**, *Introduction to the Study of the Law of the Constitution* (1885). Three limbs — write all three, then **cut the third for India**.
...
**Exceptions — they are islands, not a repeal**

- **Article 361** says the President and Governors are **not answerable to any court** for their official acts, though a civil suit against a Governor is possible after he leaves office, as provided.
...
> **Logic:** Dicey’s three limbs do **not** all apply in India. **Limb 3 fails.**

---

## Procedure Established by Law vs Due Process of Law

Two syllabus bullets. **One fight.**
...
**Natural justice** (the Indian working of *procedural* fairness — not a separate syllabus heading)

- The **hearing** rule, *audi alteram partem*, requires that the other side be heard before a decision is taken against it.
- The **no-bias** rule, *nemo judex in causa sua*, disqualifies a person from being a judge in his own cause.
- The **speaking-order** rule requires reasons to be given; after *Maneka*, a passport impounding, a detention, or a blacklisting order without stated reasons is usually struck down on this ground.

*Maneka* facts (so the case is not a name-drop): passport impounded **without** giving her a chance to be heard. SC: Art. 21 procedure must be **fair, just and reasonable**; Arts. **14, 19, 21** move together (**golden triangle**). A law that is arbitrary fails **14**, and therefore fails **21**.
...
- *Gopalan* is **not** “still good law” on the silo/fairness point. The *lex* requirement (there must be a law) **survives**.
- What was later *read into* 21: livelihood, privacy, health, shelter, speedy trial. This card is the **standard of review** (fair, just, reasonable) — not the full 21 catalogue.

---

## Separation of Powers

**Montesquieu**, *The Spirit of the Laws* (**1748**): legislature / executive / judiciary — so that power is not concentrated.
...
- In *Ram Jawaya Kapur* (**1955**), the Supreme Court held that the Indian Constitution does **not** recognise separation of powers in the American **rigid** sense. Functions are **differentiated**, but some overlap between organs is expected.
- The same case also held that the executive can act without a prior law, **unless** a law is specifically required for that action — a cousin of the Rule-of-Law idea.
- In *Indira Nehru Gandhi v Raj Narain* (**1975**), the Court held that Parliament cannot, by a constitutional amendment, take an **election dispute** away from the courts and decide it itself. This case treats separation of powers and free and fair elections as part of the Basic Structure.
- Under **Articles 122 and 212**, courts cannot inquire into the *proceedings* of Parliament or a State legislature — this is a **check running the other way**, from the legislature onto the judiciary.
- **Article 361** gives the President and Governors immunity from court proceedings for their official acts.

**Overlap that is *meant* to exist** (not a repeal of SOP)
...
- A **statute** can be struck under **Article 13** for violating Articles 14, 19, or 21, or for being *ultra vires* the federal distribution of powers.
- An **executive action** can be struck for denying a hearing, for mala fide exercise of power, or for want of authority — the *Maneka* / natural-justice line.
- A **constitutional amendment** can be struck only if it hits the **Basic Structure** — the line running through *Kesavananda*, *Minerva Mills*, and the NJAC case.
...
> **Logic:** CAG/EC/UPSC are **constitutional** offices, not extra-constitutional extras. Judicial review ≠ judicial supremacy.

---

## Judicial Supremacy · Parliamentary Sovereignty · Constitutional Supremacy

Three syllabus bullets. **One triad.** India claims the **third**.
...
| Last word | Parliament can make / unmake **any** law; no court strikes an Act as *ultra vires* the constitution (classic) | Court as the real sovereign | **Constitution** is the highest law; **both** Parliament and Court are under it |
...
**Parliamentary sovereignty — what India refused**

- Under classic Dicey theory, no person or body can override an Act of the UK Parliament; a later Act simply repeals an earlier one, and courts do not strike primary legislation.
- India rejected this: Parliament is **supreme only within its own sphere**, not sovereign over the Constitution itself.
- **Article 13** and **Article 245** (which makes every law "subject to this Constitution") are the textual kill-shots against parliamentary sovereignty in India.
...
> **Logic:** Parliamentary *form* ≠ parliamentary *sovereignty*. 368 is constituent, not Dicey-unlimited. *Kesavananda* killed that.
...
**Socio-economic-justice State** — opposite of a **police / laissez-faire State** (only law, order, defence, tax). A welfare State uses law to secure **socio-economic justice**.

- In the Preamble, **Justice** — social, economic, and political — is the first listed ideal, and it points straight to the welfare idea.
- **Part IV**, the Directive Principles of State Policy, is the engine of the welfare State; **Article 37** says they are not enforceable in court, but are still **fundamental in governance**.
- **Article 38** is the lead article: it directs the State to secure a social order for the welfare of the people. **Article 38(2)**, added by the **44th Amendment (1978)**, directs the State to minimise inequalities of **income, status, facilities, and opportunities**.
...
> **Logic:** Welfare State ≠ 42nd invented Part IV. Part IV is **1950**. *Minerva*: you need **both** brakes (FR) and goals (DPSP).
...
> **Logic:** Socialist was **not** in the 1950 Preamble. 42nd did **not** turn India into a communist State.
...
|--|-----------------------------------|-----------------------------------|
| Idea | Equal **respect** and equal **freedom**; State has **no official religion** | Jefferson “wall” — State neither aids nor regulates religion |
| Reform | Art. **25(2)** — State **may** regulate secular activity of religious bodies and throw open Hindu institutions | Establishment clause fights State entanglement |
| Tax / school | Art. **27** no tax *for promotion* of a religion; Art. **28(1)** no religious instruction in wholly State-funded schools | School-prayer fights are the US paper |
...
> **Logic:** India was secular in **scheme** from 1950 (Arts. **25–28**). The **adjective** is 1976. Indian secularism ≠ US wall. *Kesavananda* listed secular character; *Bommai* applied it to **356**.
...
- **Internal sovereignty** means India is supreme *inside* its own territory, with no rival legal centre — the States are not independent republics, and Article **1** describes India as a Union of States.
- **External sovereignty** means India answers to no foreign master; membership of the UN or the Commonwealth does **not** compromise this sovereignty.
...
> **Logic:** Democracy ≠ whatever the majority wants today (*Navtej*: majority ≠ constitutional morality). Democracy answers *who* governs; republic answers *what the Head is*.
...
> **Logic:** Republic was **not** added by the 42nd. It was there in 1950. 2025 paper dangled it next to Socialist/Secular.

---

## Justice — Social, Economic, Political

**Three kinds of Justice** — social, economic, political (that is the “3” in 3-5-2-1). Preamble puts Justice **first** among the four big ideals. Art. **38** restates all three inside Part IV.

- **Social justice** means no hierarchy of caste or status, and dignity in society — carried by Articles **15** and **17** (abolition of untouchability) and Article **46** (protection of weaker sections).
...
> **Logic:** India prefixes **Justice** to the French triad. Political justice ≠ the whole Constitution.
...
> **Logic:** Preamble liberty = **5** (thought…worship). Art. 19 = **6** different list. Preamble does **not** list personal liberty (that is Art. **21**).

---

## Equality — Status and Opportunity

**Two Preamble equalities** — status and opportunity. Not five. Not equality of outcome.

- **Equality of status** is carried by Article **14** (available to any person) along with Articles **15** and **17**.
- **Equality of opportunity** is carried by Article **16**, which covers public employment for **citizens** only.
- Article 14 combines Dicey's equality before law with the US idea of equal protection: it permits reasonable **classification**, but forbids **class legislation**.
...
> **Logic:** Equality in the Preamble has **two** components. Art. **14** = any person; Art. **16** = citizens only.

---

## Fraternity and Dignity of the Individual

**One Preamble ideal, two promises** — fraternity **assuring** the dignity of the individual **and** the unity and integrity of the Nation.

- In his closing speech to the Constituent Assembly, Ambedkar warned that without **fraternity**, liberty and equality are only "a coat of paint" — brotherhood is what makes the other two live in practice.
...
> **Logic:** Fraternity does **not** have three numbered types like Justice. It is **1** Preamble ideal.

---

## Unity and Integrity of the Nation

**Hold-together of the Union** — 42nd inserted **integrity** into the fraternity clause (with Socialist and Secular). The *idea* is older than 1976.

- After the China war and secession slogans of the early 1960s, the **16th Amendment (1963)** wrote "sovereignty and **integrity** of India" into the restriction grounds of Article **19(2)/(3)/(4)**, and into the Third-Schedule oaths — so liberty was *expressly* bounded by integrity **before** the Preamble even printed the word.
...
> **Logic:** “Federal” is **not** in the Preamble. Integrity in the Preamble is **42nd**; in Art. **19** and the oaths it is already **16th Amd 1963**.
...
A. Constitutionalism — limited government under a higher law
B. Constitutional morality — fidelity to constitutional norms (Ambedkar CAD)
C. Rule by law — law binds the ruler too
D. Rule of Law — Basic Structure (Indira Gandhi, 1975)

<details>
<summary>Show answer</summary>

**Ans: C.** Rule by law is the trap opposite: ruler uses statutes as a whip.

**Logic:** Rule of Law = law binds the ruler; rule by law ≠ that.

</details>

**Q3.** Given below are two statements, one labelled as Assertion (A) and the other as Reason (R).

Assertion (A): Article 21’s text uses “procedure established by law”.

Reason (R): After Maneka Gandhi (1978), the procedure must be fair, just and reasonable, reading Articles 14, 19 and 21 together.
...
**Ans: A.** Both true; R does not rewrite the text of A.

**A/R logic:** Text remains Japan-sourced “procedure established by law”; Maneka imports due-process content without changing the words — so R does not explain why the text reads that way.
...
**Logic:** India takes Dicey limbs 1–2; rejects limb 3.
...
**Ans: B.** 1950 → 1973 → 1978 → 1994.

**Logic:** Gopalan precedes Basic Structure; Maneka after Emergency era; Bommai later.
...
2. The 42nd Amendment’s Articles 368(4)/(5) attempt to bar review of amendments was struck in Minerva Mills (1980).
...
**Logic:** Judicial review ≠ claim of judicial supremacy.

</details>

**Q8.** Given below are two statements, one labelled as Assertion (A) and the other as Reason (R).

Assertion (A): Indian secularism is a hard US-style wall of separation between State and religion.

Reason (R): Bommai (1994) treats secularism as Basic Structure; Articles 25–28 operated from 1950.
...
**A/R logic:** Indian secularism is positive/equal respect with Art. 25(2) reform power — not a US wall.

</details>

**Q9.** Which one of the following pairs is **NOT** correctly matched?

A. Preamble Liberty (5) — thought, expression, belief, faith, worship
B. Article 19 freedoms (6) — speech, assembly, association, movement, residence, profession
C. Equality of opportunity — primarily Articles 14/15/17
D. Equality of status — Articles 14/15/17 track

<details>
<summary>Show answer</summary>

**Ans: C.** Equality of opportunity links to Article 16; status to 14/15/17.

**Logic:** Do not swap status and opportunity articles.
...
**Q11.** With reference to democracy and republic, which of the following is/are correct?

1. Democracy concerns rule by the people with free and fair elections.
...
**Logic:** Justice three-way map; fraternity assures dignity and unity/integrity.

</details>

**Q13.** Given below are two statements, one labelled as Assertion (A) and the other as Reason (R).

Assertion (A): Political sovereignty rests with the people (“We, the People”).

Reason (R): Legal sovereignty in India rests with the Constitution rather than classic Dicey parliamentary sovereignty.
...
**Ans: A.** Both true; R is a related but distinct sovereignty plane.

**A/R logic:** People’s political sovereignty and Constitution’s legal sovereignty are both true; R does not cause A.

</details>

**Q14.** With reference to amending power, which of the following is/are correct?

1. Constituent power under Article 368 is not ordinary legislative power under Article 245.
2. The 24th Amendment inserted Article 13(4) so a 368 amendment is not “law” under Article 13.
3. Basic Structure still ceilings Article 368.
...
A. Checks and balances — judicial review, impeachment, no-confidence, ordinance return
B. Judicial review — court tests law against the Constitution
C. Judicial supremacy — India’s official claim that the Court is the sovereign
D. French triad — Liberty, Equality, Fraternity; India prefixes Justice

<details>
<summary>Show answer</summary>

**Ans: C.** India claims judicial review, not judicial supremacy as sovereignty.

**Logic:** Review tests; supremacy would make the Court the sovereign.

</details>

**Q16.** With reference to secularism naming vs code, which of the following is/are correct?

1. The word Secular entered the Preamble via the 42nd Amendment.
2. Articles 25–28 already operated from 1950.
...
**Logic:** Word in Preamble ≠ invention of the religious-freedom code.

</details>

**Q17.** Arrange: I. 42nd Amendment prints Socialist/Secular/integrity II. 44th thickens Art. 38(2) III. Puttaswamy privacy as FR IV. NCT Delhi services judgment teaching year 2023
...
**Ans: A.** 1976 → 1978 → 2017 → 2023.

**Logic:** 42nd precedes 44th; privacy 2017; NCT services 2023.

</details>

**Q18.** Given below are two statements, one labelled as Assertion (A) and the other as Reason (R).

Assertion (A): Constitutional morality under Articles 19/25 “morality” grounds is the same as Ambedkar’s constitutional morality.

Reason (R): Ambedkar’s constitutional morality means fidelity to constitutional norms, not majority street morality.
...
**A/R logic:** Public/social morality as a restriction ground ≠ constitutional morality as fidelity to the Constitution.

</details>

**Q19.** With reference to Article 21 expansion after Maneka, which of the following is/are correct?

1. Review is both procedural and substantive.
2. Privacy was treated as a Fundamental Right in Puttaswamy (2017).
3. Natural justice is poured into Article 21 even though the text still says procedure established by law.
...
**Q20.** With reference to police state vs welfare state, which of the following is/are correct?

1. A police state stops at law and order; a welfare state pursues socio-economic goals.
2. High-yield DPSPs include Articles 40, 44, 45, 47, 48 and 48A.
...
**Logic:** Part IV is the welfare instrument set.

</details>

**Q21.** Which one of the following is correct about Sovereign in the Preamble?

A. Covers internal supremacy and external independence; first word in the SSSDR chain
B. Means only external independence; excludes internal supremacy
C. Was added by the 42nd Amendment along with Socialist
D. Is identical to the word Federal in the Preamble

<details>
<summary>Show answer</summary>

**Ans: A.** Sovereign covers internal and external planes.

**Logic:** Sovereign was original; Socialist/Secular came via 42nd.
...
**Logic:** After Maneka, Indian Art. 21 review carries both procedural and substantive content.

</details>

**Q23.** With reference to fraternity, which of the following is/are correct?

1. Fraternity assures dignity of the individual and unity and integrity of the nation.
2. The 42nd Amendment added integrity to the Preamble theme.
3. Article 51A(c)/(e) duties echo fraternity themes.
...
Assertion (A): Merely having a written constitution booklet is enough to establish constitutionalism.

Reason (R): Constitutionalism requires limited government that is reviewable under a higher law.
...
**A/R logic:** Booklet ≠ constitutionalism; limited + reviewable power is the core.

</details>

**Q25.** With reference to Indian positive secularism, which of the following is/are correct?

1. Often summarised as equal respect / Sarva Dharma Sambhava.
...
**Q27.** With reference to Rule of Law Basic Structure, which of the following is/are correct?

1. Indira Gandhi (1975) treated Rule of Law as Basic Structure.
2. Free and fair elections themes also enter Basic Structure talk in that line.
...
**Logic:** Parliament cannot amend away Rule of Law.

</details>

**Q28.** Arrange vesting / organ map articles with functions: Executive–Parliament–Supreme Court corresponding to which sequence?
...
**Ans: A.** Art. 53 executive; 79 Parliament; 124 Supreme Court.

**Logic:** Standard vesting-line teaching.

</details>

**Q29.** Which one of the following pairs is **NOT** correctly matched?

A. Internal sovereignty — supreme inside the territory
B. External sovereignty — no foreign master
C. Legal sovereignty (India) — Constitution
D. Legal sovereignty (India) — classic Dicey Parliament as last word

<details>
<summary>Show answer</summary>

**Ans: D.** India’s legal sovereignty rests with the Constitution.

**Logic:** That is why India is not a Dicey-UK parliamentary-sovereignty State.

</details>

**Q30.** Given below are two statements, one labelled as Assertion (A) and the other as Reason (R).

Assertion (A): ADM Jabalpur (1976) is often taught as an anti-example where constitutionalism failed in practice.

Reason (R): Puttaswamy (2017) later treated the Jabalpur majority as wrongly decided.
...
**Ans: D.** Both true and R correctly elaborates the later judicial correction linked to A’s teaching point.
...
India wrote a **higher law** and then spent fifty years deciding how high. **Political sovereignty** = the people; **legal sovereignty** = the Constitution. **368** is constituent, not Dicey-unlimited. The Preamble *names* (42nd) what Parts III–IV already *did*: **welfare (Art. 38)**, **democratic socialism**, **positive secularism** (*Kesavananda* list → *Bommai* 356). Close with: **Preamble liberty ≠ Art. 21 person ≠ Art. 19’s six**; **Justice prefixes the French triad**; **Republic / Sovereign ≠ 42nd inserts**.
