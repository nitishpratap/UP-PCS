...
D. Tenth
1. Language
2. Disqualification on defection
3. Union/State/Concurrent Lists
...
**Q1.** With reference to the Election Commission’s remit, which of the following statements is/are correct?

1. Article 324 covers Parliament, State legislatures, President, and Vice-President elections.
2. Article 324 also covers Panchayat and municipality elections.
...
**Logic:** Local polls are SEC under 243K/ZA.
...
1. Voting age 21→18 — 61st Amendment (in force 1989)
2. One general electoral roll — Article 326
3. Adult suffrage — Article 326
...
**Ans: B.** Pair 2 is wrong — one roll is Article 325.

**Logic:** 325 = one roll; 326 = adult suffrage.
...
**Logic:** President/VP remain secret ballot; RS party voting uses open ballot.
...
1. NOTA (PUCL)
2. First EVM use (Kerala)
3. EPIC
4. First VVPAT use at Noksen
...
**Ans: B.** 1982 → 1993 → 2013 → 2013 (PUCL same year theme) with EVM→EPIC→VVPAT→NOTA teaching order.

**Logic:** Teaching chronology: EVM (1982) → EPIC (1993) → VVPAT (2013) → NOTA (2013).

</details>

**Q7.** With reference to bye-elections, which of the following statements is/are correct?

1. Ordinarily held within six months.
2. May be skipped if the remainder of the term is less than one year.
...
**Logic:** Six-month rule with <1 year skip.
...
1. National Voters’ Day is 25 January — founding day of the Election Commission in 1950.
2. First National Voters’ Day was celebrated in 2011.
3. Presidential MLA vote-value formula uses the 1971 population.
...
**Logic:** 25 Jan / 2011 / 1971 formula.
...
1. Registration of parties — RPA section 29A
2. Recognition as National/State party — Symbols Order, 1968
3. Star campaigners — recognised party up to 40; unrecognised up to 20
...
1. Election petition for MP/MLA — High Court within 45 days
2. President/VP election dispute — Article 71 (Supreme Court)
3. NOTA win — forces an automatic re-poll
...
**Logic:** NOTA does not force a re-poll even if it ‘wins’.

</details>

**Q15.** With reference to EVMs and VVPAT, which of the following is/are correct?

1. EVMs are made by BEL and ECIL; nationwide booth coverage by 2004.
...
Assertion (A): Electoral bonds were struck down by the Supreme Court in February 2024.

Reason (R): The scheme remains a valid statutory funding route for the next general election.
...
**A/R logic:** Do not treat electoral bonds as still valid.
...
**Logic:** 329 bar vs 330/332 reservation.
...
**Ans: A.** 1985 → 1988/89 theme → 2019 → 2023.

**Logic:** Anti-defection, voting age, Anglo-Indian/SC-ST extension, women reservation.

</details>

**Q19.** With reference to Uttar Pradesh electoral facts, which of the following is/are correct?

1. UP has 80 Lok Sabha seats and an Assembly of 403.
2. Local body polls in UP are run by the UP State Election Commission.
...
**Logic:** 80/403 + SEC for local polls.
...
1. Double-member constituencies ended — 1961
...
Assertion (A): A delimitation order has the force of law and Article 329 bars courts from questioning delimitation.

Reason (R): Election petitions for House seats also live under the 329 bar-and-petition scheme.
...
**Ans: D.** Both true and R is consistent with the 329 design explained by A.

**A/R logic:** 329 covers delimitation bar and election-petition pathway.

</details>

**Q23.** With reference to corrupt practices and petitions, which of the following is/are correct?

1. Corrupt practices are listed in RPA section 123.
2. Appeal from an election petition lies to the Supreme Court.
...
**Logic:** s.123 + SC appeal.

</details>

**Q24.** How many of the following are true?

1. MCC starts from announcement of the election schedule.
2. Free and fair elections rest on 324–329 design, adult suffrage, one roll, and independent machinery.
3. Article 324 is a blank cheque to ignore the RPAs and Rules.
...
**Logic:** 324 is not a blank cheque against statute.

</details>

**Q25.** Which of the following is/are NOT correctly matched?

1. Reserved symbol — recognised parties
2. Free symbol — RUPP / independents
3. Recognition — automatic on registration under 29A alone
...
**Q26.** With reference to Presidential election vote value, which of the following statements is/are correct?

1. An MLA’s vote value uses State population ÷ (elected MLAs × 1000).
2. The population figure in that formula is from the 2011 census.
...
**Logic:** Freeze year in the formula is 1971.

</details>

**Q27.** Consider the following statements:

1. First Past the Post elects Lok Sabha and Assemblies — most votes win, not PR.
...
Assertion (A): Women’s reservation under the 106th Amendment is linked to the next delimitation.

Reason (R): SC/ST reservation currently runs to 2030 under the 104th Amendment.
...
**A/R logic:** Two neighbouring reservation facts — not cause and effect.

</details>

**Q29.** With reference to ECI vs Delimitation Commission, which of the following is/are correct?

1. ECI conducts polls under 324.
2. Delimitation Commission draws seats as a statutory panel; CEC may sit on it.
...
**Logic:** Conduct vs draw — do not merge the bodies.

</details>

**Q30.** Which of the following pairs is/are correctly matched?

1. Major Delimitation Acts — 1952, 1962, 1972, 2002
