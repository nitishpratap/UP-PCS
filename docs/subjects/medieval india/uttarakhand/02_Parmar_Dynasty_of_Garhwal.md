...
- Legend places **Kanakpal**, a Parmara prince linked to Malwa, as the founder who marries into the Chandpur house and begins the Panwar line.
- Coaching dates for Kanakpal vary (often **888 CE** at Chandpurgarh in UKPSC notes; some ASI-linked lists print earlier centuries). Prefer the **founder + Chandpur** lock over fighting the year unless the stem prints one.

---

## 2.2 Ajay Pal and Srinagar

- **Ajay Pal** is the standard answer for the king who **united about 52 principalities (garhis)** into the Garhwal kingdom.
...
- Their descendants develop the **Garhwal miniature** style; **Mola Ram** is the best-known later master.
