...
> **Pair with:** Ancient UK [Kartikepur](../../ancient%20history/uttarakhand/04_Kartikepur_Dynasty.md) for the capital card.  
...
| Head | Lock |
|------|------|
| House | **Katyuri / Kattyuri** of central Himalaya |
...
- Rule of thumb: **capital identity** can be revised from Ancient Topic 4; **rise–fragment–succession** is revised here.

---

## 1.2 Capitals and geography

- Traditions place an early centre at **Joshimath**.
- The house later concentrates on **Kartikeyapura**, identified with **Baijnath** in the Katyur valley.
...
- Baijnath temple landscape preserves the Kartikeyapura memory for map stems.
...
1. Kartikeyapura = Baijnath.
2. Joshimath → Baijnath capital shift tradition.
3. Katyuri decline = fragmentation, not one neat “last battle” stem unless named.
4. Chand succeeds in Kumaon; Parmar consolidates Garhwal.
5. Kuninda is earlier — do not merge the two.
...
**Ans: B.** The Chand dynasty of Kumaon fills the post-Katyuri political space in eastern Uttarakhand.
...
1. **Katyuri = Kuninda** → wrong age.
2. **Baijnath only = modern temple town** → preserves Kartikeyapura.
