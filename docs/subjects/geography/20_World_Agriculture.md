...
| **Intensive** | High labour (or capital) **per hectare**; small farms | Monsoon rice; Dutch dairy; Japanese rice |
| **Extensive** | Low labour per hectare; **huge** farms, machines | Canadian Prairie, Australian Downs, Pampas |
...
**Ans: B** — Estate crop on tropical slopes. A/C/D are intensive or extensive field grains.
...
**Ans: C** — Winter rain + bright summer. Equatorial is too wet/cloudy. A/B are Himalayan distractors, not the *world* citrus belt.
...
| Type | Core belt |
|------|-----------|
| Nomadic herding | Sahara, Arabia, Gobi, tundra, C Asian drylands |
| Livestock ranching | Pampas, W USA, Australia, Veld |
| Shifting cultivation | Amazon, Congo, SE Asia hills, NE India, C America |
| Rudimentary sedentary tillage | Parts of tropics where plots are fixed but tools simple |
| Intensive subsistence — **rice dominant** | E / SE / S Asia deltas and coasts |
| Intensive subsistence — **without paddy rice** | N China, interior India wheat–millet, Nile |
| Commercial plantation | Caribbean, NE India–SL tea, Malaysia–Indonesia rubber/palm, Brazil coffee, W Africa cocoa |
| Mediterranean agriculture | Five west-coast patches (Med proper, California, C Chile, Cape, SW Australia) |
| Commercial grain farming | Prairies, Pampas, Downs, Ukrainian–Russian steppe |
| Mixed crop-and-livestock | W Europe, US Midwest Corn Belt edge |
| Subsistence crop-and-livestock | Parts of highlands / poorer temperate belts |
| Commercial dairy | NW Europe, Great Lakes, NZ |
| Specialised horticulture / market gardening | W Europe urban belt, California, Mediterranean coasts |

**Five Mediterranean west-coast patches** (same climate family as citrus/vine/olive):
...
Ranks **move**. Freeze a year only when the paper quotes it. Learn **climate + belt + producer vs exporter**.
...
| Trap | China is **not** the classic rice-export king — it **eats** the crop |
...
| Pampas | Argentina |
| Downs | Australia |
| Steppe | Ukraine / S Russia / Kazakhstan |
| N European plain | France (export), Germany |
| Indo-Gangetic rabi | India (volume, mostly domestic) |
...
| Crop | Climate / belt | Usual leaders |
|------|----------------|---------------|
| **Soybean** | Warm temperate | **USA, Brazil, Argentina** (export triangle). China = big user |
| **Groundnut** | Tropical / subtropical | China, India, Nigeria, USA |
| **Rapeseed / canola** | Cool temperate | Canada, China, India, EU |
| **Sunflower** | Temperate | Russia, Ukraine, Argentina |
...
**Colonial crop stories the paper likes**

| Place | Crop | Credit / trap |
|-------|------|----------------|
| Philippines | Coconut + sugarcane | **Spanish and Americans** (2023) — not Dutch |
| Indonesia / Java | Cane, coffee, rubber | **Dutch** (Hollanders) |
| Malaya | Rubber estates | **British** |
| NE India / Ceylon | Tea | British |
...
**Ans: C** — Kerala = India’s rubber state. Tea = Assam/WB/Nilgiri, not Gujarat. Jute = West Bengal, not UP. Wheat = PB–HR–UP, not Assam.
...
**Ans: B** — Brazil (C) → Vietnam (B) → Colombia (A) → Indonesia (D).

Trap **D** puts Colombia second. Trap **C** starts with Vietnam.
...
**Ans: A** — Paper spelling **coco** = cocoa. B, C, D are the West African belt. Latvia is the odd temperate state.
...
| **Indonesia** | Large |
| **Vietnam** | Fast growth |
| **Malaysia** | Classic **estate** region; **not** Kinta Valley |
| **India** | **Kerala** (Kottayam–Ernakulam); also TN, KA, Andamans, NE pockets |
...
**Ans: C** — Tin. A is the plantation trap because Malaysia *does* grow rubber — just not as “Kinta Valley”.
...
| **Citrus** | Med winter-rain + some subtropics | Spain, Italy, California, Brazil (orange juice) | **World belt name = Mediterranean** (2020) |
...
| Local name | Where |
|------------|-------|
| **Jhum / jhoom** | North-East India |
| **Podu** | Andhra / Odisha hills |
| **Bewar / dahia** | Madhya Pradesh |
