...
**Continents** (area · countries · elevation) | Mountains (fold / block / volcanic / residual) | Plateaus | Valleys | Plains | Volcanoes | Islands | Deserts | Grasslands | Vegetation | World Climatic Regions
...
3. The **Andes** are the world’s **longest** fold chain. The **Himalaya** are the **highest**. **Aconcagua** stands in the Andes of Argentina. Length ladder cue: Andes > Rockies > Great Dividing Range > Himalaya.
...
8. **Tibet** is the highest large plateau (~4500 m). The **Pamir** is the “**Roof of the world**”. The **Altiplano** is Bolivia–Peru. The **Meseta** / **Madrid** is Spain. **Patagonia Plateau** = mineral storehouse cue.
...
15. **Gibson** = Australia (not Brazil). **Sonoran** = USA. **Taklamakan** = China. **Karakum** = Turkmenistan (also Kazakhstan fringe lore).
...
24. Volcano facts: **Rainier** USA; **Etna** Italy; **Paricutin** Mexico; **Apo** Philippines; also Fuji (Japan), Pinatubo (Philippines), St Helens (USA).
...
28. **Arakan Yoma** = Myanmar (India–Myanmar hills: Naga, Chin, Patkai / Lushai — not Khasi as the boundary trio). **Golan Heights** = Middle East (SW Syria / occupied lore). **Black Forest** = Germany (east of Rhine; Vosges west).
...
1. Continents → mountains → plateaus → valleys → plains.
...
Seven continents by **area** (largest → smallest):

| Rank | Continent | Area cue (km²) | % of Earth’s land (Philip’s-type) | Countries (GC sheet) |
|------|-----------|----------------|----------------------------------|----------------------|
| 1 | **Asia** | ~44.6 million | ~29.8% | ~48 |
| 2 | **Africa** | ~30.1 million | ~20.3% | ~**54** (most of any continent) |
| 3 | **North America** | ~24.5 million | ~16.2% | ~23 |
| 4 | **South America** | ~17.8 million | ~11.8% | ~12 (Brazil largest) |
| 5 | **Antarctica** | ~14.2 million | ~9.2% | — |
...
| **Salt Range** | Pakistan | Block mountain lore |
...
**Length cue (surface ranges):** Andes (~7000–8900 km) > Rockies (~4800) > Great Dividing (~3700) > Himalaya (~2500).

**Orogeny age cues:** Alps, Andes, Himalaya, Rockies, Atlas = **Tertiary / young fold**. Appalachians = **Caledonian / old**. Aravalli = Pre-Cambrian. Black Forest / Vosges / Tien Shan type = Hercynian lore. **Sierra Nevada** = world’s most extensive **block** range framing (California) — **not** a young folded mountain like Rockies/Alps/Himalaya.

**Phrase:** **British Columbia** = “**Sea of Mountains**” (Molyneux St John / Dufferin tour lore).

**Golan Heights** = Middle East basaltic plateau (SW Syria; 1967 occupation lore) — not Central Asia / SE Asia / Central Africa.
...
| **Toubkal** | **Morocco** | Hoggar |
| **Stanley** | **Uganda** | Kilimanjaro |
| **Hoggar** | **Algeria** | Atlas / Toubkal |
| **Chimborazo** | **Ecuador** | Peru/Chile Andes dump |
...
Trap **A** swaps Apennine and Balkan (Italy would get Balkan). Trap **D** gives Spain–France the Balkans.
...
**Ans: A** — Atlas–**Morocco** (4) · Kilimanjaro–**Tanzania** (3) · Chimborazo–**Ecuador** (2) · Pyrenees–**France/Spain** (1).

Paper spellings **Kalimanjaro / Chimbrozo** are the same peaks. Trap **B** gives Kilimanjaro to France/Spain (that is Pyrenees). Trap **D** gives Atlas to France/Spain.
...
**Ans: B** — Kilimanjaro–Tanzania · Toubkal–Morocco · Stanley–Uganda · Hoggar–Algeria.

Do not park Toubkal in Algeria (that is Hoggar) or Kilimanjaro in Uganda (that is Stanley).
...
A plateau is an **elevated tableland** — flatter than a mountain range, higher than a plain. Rivers often **dissect** it into mesas and gorges.
...
| **East African / Ethiopian** | Africa | Rift lakes; Blue Nile from Ethiopia |
| **African (south)** | SA / Botswana / Namibia | High veld sits on it |
| **Colorado** | SW USA | **Grand Canyon** (Colorado River) cut into it |
| **Columbia** | Washington–Oregon–Idaho | **Lava** plateau |
| **Colorado Plateau ≠ Columbia** | — | Canyon vs lava — do not swap |
| **Mexican (Mesa Central)** | Mexico | |
| **Anatolian** | Türkiye | Interior of Asia Minor |
| **Iranian** | Iran | Dasht-e-Kavir / Lut on it |
| **Mongolian** | Mongolia | **Gobi** on the dry side |
| **Altiplano** | **Bolivia–Peru** | Highest inhabited Andean plateau; Lake Titicaca |
| **Meseta** | **Spain** | Interior tableland of Iberia |
| **Loess Plateau** | N China | Wind-silt; Hwang Ho yellow colour |
| **Kimberley / Western Plateau** | Australia | Old shield |
| **Ozark** | USA | Domed plateau lore |
| **Shan** | Myanmar | Fluvial / tableland lore |
| **Telegraphic Plateau** | **North Atlantic Ridge** (Newfoundland–Ireland lore) | **Not** Indian Ocean |
...
| **Taylor Valley** | **Antarctica** — “Valley of the Dead” (Scott 1903 lore) |
...
| **Great Plains / Prairie** | USA–Canada | Temperate grassland overlay |
| **Pampas** | **Argentina** (into Uruguay) | Temperate grassland **and** a plain. **Not Chile, not Brazil** |
| **Llanos** | Orinoco (Venezuela–Colombia) | Tropical grassland plain |
...
| **Popocatépetl** | Mexico | Pacific |
| **Paricutin** (paper: **Pericutine**) | **Mexico** | Cinder cone; born 1943. 2021 list |
| **Cotopaxi** | Ecuador | Andes / Pacific rim |
| **Krakatoa / Krakatau** | Indonesia | Sunda arc / Pacific |
| **Tambora** | Indonesia | 1815; “year without summer” |
| **Mauna Loa / Mauna Kea** | Hawaii (USA) | **Hot-spot shield**, not a collision arc |
| **Etna** | **Italy** (Sicily) | Med. 2021 list. **Not** Pacific |
| **Vesuvius** | Italy | Pompeii AD 79 |
| **Stromboli** | Italy | “Lighthouse of the Mediterranean” |
| **Kilimanjaro** | Tanzania | **Rift**. 2024 “which is NOT Ring of Fire” |
...
**Ans: C** — Kilimanjaro sits on the **East African Rift**. A, B, D are Pacific-rim.
...
**Ans: B** — A-4 USA · B-1 Italy · C-2 Mexico · D-3 Philippines.

Trap **A** gives Etna to Mexico (that is Paricutin). Trap **D** gives Etna to the Philippines (that is Apo).
...
| **Tasmania** | S of Australian mainland |
| **Sicily / Sardinia / Corsica / Crete / Cyprus** | Med islands. Sicily has **Etna** |
...
**World island desk (GC extras)**

| Island / group | Cue |
|----------------|-----|
| **Nuuk** | Capital of Greenland; elevation ~**1–3 m** |
| **Diego Garcia** | Largest of **Chagos** (Indian Ocean); UK/US base |
| **Socotra** | **Yemen**; UNESCO natural heritage **2008**; Guardafui / Arabian Sea mouth — **not Oman** |
| **Seychelles / Mauritius / Madagascar** | SW Indian Ocean set |
| **Falklands** | **South Atlantic** (UK), ~650 km E of S America — **not** Indian Ocean |
...
| **Saint Martin** | Caribbean salt-pan / lagoon coast cue |
| **Indonesia island count** | ~**17,500** islands (highest among common MCQ options; Sweden lore for absolute world count) |
...
**Ans: D** — Indonesia + Malaysia + Brunei. It sits on the **Sunda continental shelf**, not a Hawaii-type volcanic pile. Trap **B** is the “all Indonesia = volcano” dump.
...
| **Gobi** | **Mongolia + China** (Inner Mongolia, Gansu, Xinjiang fringe) | **Cold**. 2025: **Only 1 and 2**. **Not** Russia, **not** Kazakhstan |
| **Great Sandy** | **NW Australia** | Smallest of the 2023 four |
| **Great Victoria** | S/W Australia | Largest **Australian** desert by many lists |
| **Gibson** | **Australia** (between Victoria and Sandy) | **Not Brazil** (2018) |
| **Simpson** | Central Australia | Red dunes |
| **Sonoran** | **USA** + Mexico | 2018 correct pair. Cactus desert |
| **Mojave** | USA | Death Valley |
| **Chihuahuan** | USA–Mexico | |
| **Taklamakan** | **China** (Xinjiang) | Cold; Tarim basin. 2018 correct pair |
| **Karakum** | **Turkmenistan** | 2018 correct pair. **Not** Kazakhstan’s default dump |
| **Kyzylkum** | Uzbekistan–Kazakhstan | Red sand; separate from Karakum |
| **Kalahari** | Botswana / South Africa / Namibia | Bushman / San. Semi-desert |
| **Namib** | Namibia coast | Fog; among the oldest |
| **Atacama** | N **Chile** (into Peru) | Among the **driest** on Earth |
| **Patagonia** | **Argentina** | Cold rain-shadow. Not Chile’s Atacama |
| **Thar** | India–Pakistan | Pleistocene–recent sands |
| **Dasht-e-Lut / Kavir** | Iran | Hot interior; Lut = extreme surface-temperature fame (NASA Aqua lore) |
| **Great Basin** | USA | Cold interior |
| **Rubʿ al-Khali** | Arabian Peninsula | Largest contiguous sand sea |
| **An Nafud** | Saudi Arabia | |

**2023 size ladder (smallest → largest):** Great Sandy → **Gobi** → **Arabian** → **Sahara**. Code **I, IV, II, III**.

**Extra GC cues:** Deserts ≈ **< 25 cm** annual rain. Hot deserts on **western** margins ~**15–30°**. Knies lore — deserts receive more solar energy in ~6 hours than humanity uses in a year. **Thar** = most densely populated desert. **Europe** = least desertification problem among continents (essentially no true hot desert). Kalahari = **Southern Hemisphere** (Botswana + Namibia + SA). African–Eurasian desert belt sits under subtropical highs — **not** mainly warm currents.
...
**Ans: A** — Core Gobi = **Mongolia + northern China**. Trap **B** adds Kazakhstan; trap **C** adds Russia; trap **D** drops China.
...
Trap **A** puts Arabian before Gobi. Trap **B** starts with Arabian (too big).
...
**Latitude cues:** Tropical savanna ~**10–25°** N/S (between tropics). Temperate grasslands ~**30–45°** (can stretch toward **50°N** where landmass is wide).
...
**Ans: A** — Brazil = **Campos**. Chile = **matorral** / Andes rain-shadow (Atacama–Patagonia), not Pampas. Ecuador = Andes / Chimborazo, not a pampas country.
...
| **Tropical monsoon** | India, mainland SE Asia, N Australia | Teak, sal; sheds in dry season |
| **Savanna** | Sudan belt, Campos, Llanos, N Australia | Grass + scattered trees; **baobab** |
| **Hot desert / thorn** | Sahara, Thar, Australia | **Acacia**, cactus, xerophytes |
| **Mediterranean sclerophyll** | 5 west-coast patches (N.9) | Olive, vine, cork, **cedar**; shrubs below |
| **China type / laurel** | E coasts ~25–40° | Camphor, tea in hills; summer rain forest |
| **Temperate deciduous** | W Europe, E USA, N China | Oak, beech, maple |
| **Taiga / boreal** | Canada, Scandinavia, Siberia | **Conifer** — spruce, fir, pine, larch. **Not** treeless |
...
| **Fynbos** (paper: **Fynbus**) | **South Africa** (Cape) |
...
**Ans: A** — Maquis–Med · Fynbos–South Africa · Chaparral–California · Matorral–Chile.

Trap **B** starts Maquis on Chile. Trap **D** gives Fynbos to the Mediterranean.
...
Trap **C** swaps Engler and Hungary.
...
| **Tropical monsoon** | India, mainland SE Asia | **Summer** monsoon | Deciduous teak/sal |
| **Hot desert (BWh)** | Sahara, Arabia, Thar, Australia | Rare | Xerophytes |
| **Cold desert (BWk)** | Gobi, Taklamakan | Rare / snow | Sparse |
| **Steppe (BS)** | Ukraine to Mongolia; rain-shadow edges | Scanty | Short grass |
| **Mediterranean (Cs)** | **30–45° west coasts** — five patches below | **Winter** cyclonic | Olive, citrus, vine, cork, wheat, cedar, maquis |
...
5. **Cape** / Western Cape, South Africa
...
**Ans: D** — Winter rain is the definition. Belts follow the Sun, so NH winter solstice → shift **south** → westerlies over the Med. Trap **C** drops the belt-shift, which is the *why*.
...
**Ans: D** — Summer dry high / dry land winds keep the rain for winter. That is why the climate is “winter-rain”.
...
Which continent has the **maximum number of sovereign countries**?
...
**Ans: B.** **Africa** has about **54** countries — the highest count of any continent.

</details>

**Q-GC2. Ghatnachakra / standard**

Among the following, which is the **largest continent by area**?
...
**Ans: C.** **Asia** is the largest continent (~44.6 million km²), ahead of Africa and North America.

</details>

**Q-GC3. UPPCS / standard**

If **Asia is not listed**, which of the following is the **largest continent**?
...
**Ans: A.** After Asia, **Africa** (~30.1 million km²) is the largest among the remaining options.
...
**Ans: B.** **Guyana** lies on the **north-east coast of South America** (capital Georgetown). Do not place it with Gabon or Guinea in Africa.

</details>

**Q-GC5. Ghatnachakra / standard**

Arrange the following continents in **decreasing order of area** (largest first):
...
**Ans: A.** Correct order: **Africa → South America → Europe → Australia**.

</details>

**Q-GC6. Ghatnachakra / standard**

Which of the following gives the correct **descending area order** for four major continents?

A. Asia — Africa — North America — Europe

B. Africa — Asia — Europe — North America

C. Asia — North America — Africa — Europe
...
**Ans: A.** **Asia → Africa → North America → Europe** is the standard area ladder among these four.
...
**Ans: B.** **Australia** (~7.7 million km²) is the smallest of the seven continents.

</details>

**Q-GC8. Ghatnachakra / standard**

The **two smallest continents** among the classic seven are

A. Australia and Europe

B. Europe and Antarctica
...
**Ans: A.** **Australia** and **Europe** are the two smallest continents by area.

</details>

**Q-GC9. UPPCS / standard**

Which continent holds the **largest share of Earth’s land surface** among the options below?
...
**Ans: A.** **Africa** (~20.3% of land) exceeds North America (~16.2%), South America (~11.8%), and Europe (~6.8%).

</details>

**Q-GC10. Ghatnachakra / standard**

Which continent has the **maximum per capita land area** (coaching / World Bank-type cue)?
...
**Ans: A.** **Australia** as a continent-country unit tops per capita land among standard continent options.

</details>

**Q-GC11. Ghatnachakra / standard**

The continent with the **highest mean elevation** is
...
**Ans: B.** **Antarctica** averages about **2300 m** — highest mean elevation of any continent.

</details>

**Q-GC12. UKPCS / standard**

**South America** is characteristically associated with which of the following?

A. Andes mountain chain along the west

B. Brazilian Highlands and Guiana Highlands

C. Amazon basin lowland
...
**Ans: D.** **Andes**, **Guiana / Brazilian highlands**, and the **Amazon** basin together define South America’s physical frame.
...
**Ans: B.** The **Atlas** system runs through **Morocco, Algeria, and Tunisia** in **north-west Africa**.

</details>

**Q-GC14. Ghatnachakra / standard**

Among continents, **Europe** is noted for having the

A. highest mean elevation

B. highest percentage of plains in its total area
...
**Ans: B.** **Europe** has the **highest share of plains** relative to its area among the major continents.
...
**Ans: A.** **Aconcagua** — Argentina · **Serengeti** — Tanzania · **Gibson** — Australia · **Meseta / Madrid** — Spain.

</details>

**Q-GC16. Ghatnachakra / standard**

Animals adapted to **desert drought** — such as camels, kangaroo rats, and fennec foxes — are called
...
**Ans: B.** **Xerocoles** are **desert-adapted animals**; xerophytes are the matching drought-adapted plants.

</details>

**Q-GC17. Ghatnachakra / standard**

The **Darling Range** is located in

A. North-east Australia
...
**Ans: B.** The **Darling Range** lies along the **south-west coast** of **Western Australia**.
...
**Ans: A.** **British Columbia** in **Canada** is called the **Sea of Mountains** in coaching geography.

</details>

**Q-GC19. Ghatnachakra / standard**

The **highest peaks** on Earth belong mainly to which mountain family?
...
**Ans: B.** **Young fold mountains** such as the **Himalaya** and **Andes** carry the world’s **highest summits**.
...
**Ans: B.** The **Andes** (~7,000+ km) are the **longest** continuous fold chain, running through **South America**.

</details>

**Q-GC21. UPPCS / standard**

The **Andes** are located in
...
**Ans: B.** The **Andes** form the western spine of **South America**.

</details>

**Q-GC22. Ghatnachakra / standard**

**Sierra Nevada** (California) is best classified as a

A. young folded mountain like the Alps

B. block / fault-block mountain
...
**Ans: B.** **Sierra Nevada** is a classic **block mountain** — **not** a young fold like the Rockies or Himalaya.

</details>

**Q-GC23. Ghatnachakra / standard**

Approximately how long is the **Andes** chain?
...
**Ans: C.** The **Andes** extend roughly **7,000 km** along western South America.
...
**Ans: B.** The **Southern Alps** run along the **South Island of New Zealand** (Aoraki / Mt Cook).

</details>

**Q-GC25. Ghatnachakra / standard**

Arrange the following ranges in **decreasing order of length**:
...
**Ans: A.** **Andes → Rockies → Great Dividing Range → Himalaya** is the standard length ladder.

</details>

**Q-GC26. Ghatnachakra / standard**

The **Alps** are characteristically associated with

A. England

B. Switzerland and central Europe
...
**Ans: B.** The **Alps** span **Switzerland, France, Italy, and Austria** — **not England**.
...
**Ans: A.** **Andes** — South America · **Altai** — Central Asia · **Alps** — Europe · **Appalachians** — eastern USA.

</details>

**Q-GC28. Ghatnachakra / standard**

The **White Mountains** are located in

A. USA (New Hampshire / Maine)
...
**Ans: A.** The **White Mountains** lie in **New Hampshire and Maine**, **USA**.

</details>

**Q-GC29. Ghatnachakra / standard**

**Arakan Yoma** is a mountain system of
...
**Ans: B.** **Arakan Yoma** (Rakhine / Arakan hills) lies in **Myanmar**, along the Bay of Bengal flank.
...
**Ans: B.** The **Black Forest** (**Schwarzwald**) lies in **south-west Germany**, east of the Rhine.

</details>

**Q-GC31. Ghatnachakra / standard**

The **Black Forest** of Germany lies to the **east** of which river?
...
**Ans: B.** The **Black Forest** sits **east of the Rhine**; the **Vosges** lie west of the Rhine in France.

</details>

**Q-GC32. Ghatnachakra / standard**

The **Black Mountains** (Appalachian system) are in
...
**Ans: B.** The **Black Mountains** are part of the **Appalachians in North Carolina, USA** — not the German Black Forest.

</details>

**Q-GC33. Ghatnachakra / standard**

Which of the following is an **old, worn fold mountain** rather than a Tertiary young fold?
...
**Ans: C.** The **Appalachians** are **old Caledonian folds**, heavily eroded — unlike Alps, Andes, or Himalaya.
...
B. Caledonian / older orogeny

C. Quaternary glaciation only

D. Recent volcanic eruption

<details>
<summary>Show answer</summary>

**Ans: B.** **Appalachians** belong to **older (Caledonian-type) folding**, not the Tertiary belt.

</details>

**Q-GC35. Ghatnachakra / standard**

The **Andes** are **not** an example of

A. young folded mountains

B. Tertiary orogeny

C. old, highly denuded fold mountains

D. compressional origin

<details>
<summary>Show answer</summary>

**Ans: C.** The **Andes** are **young folds**, not old worn-down folds like the Appalachians.

</details>

**Q-GC36. Ghatnachakra / standard**

**Pennines**, **Appalachians**, and **Aravallis** are grouped as

A. young Tertiary fold mountains

B. old / residual fold mountains
...
**Ans: B.** All three are **old, worn, or residual** highlands — not young Alpine–Himalayan folds.

</details>

**Q-GC37. Ghatnachakra / standard**

The **Drakensberg** mountains are located in

A. East Africa

B. Southern Africa (South Africa / Lesotho)
...
**Ans: B.** The **Drakensberg** form the **south-eastern escarpment** of **South Africa and Lesotho**.

</details>

**Q-GC38. Ghatnachakra / standard**

The **Atlas Mountains** belong to which continent?
...
**Ans: B.** The **Atlas** chain lies in **north-west Africa** (Morocco–Algeria–Tunisia).
...
**Ans: A.** **Allegheny** — USA · **Cantabrian** — Spain · **Elburz** — Iran · **Mackenzie** — Canada.

</details>

**Q-GC40. Ghatnachakra / standard**

Match the **highest peak** with its continent:
...
**Ans: A.** **Kosciuszko** — Australia · **McKinley** — North America · **Elbrus** — Europe · **Kilimanjaro** — Africa.

</details>

**Q-GC41. Ghatnachakra / standard**

**Mount Elbrus** is the highest peak of
...
**Ans: B.** **Elbrus** in the **Caucasus (Russia)** is counted as **Europe’s highest peak** — not Asia’s Everest.
...
**Ans: A.** **Kilimanjaro** — Tanzania · **Toubkal** — Morocco · **Stanley** — Uganda · **Hoggar** — Algeria.
...
**Ans: A.** **Alps** — central Europe · **Vosges** — France · **Vindhyas** — India · **Fuji** — Japan.

</details>

**Q-GC44. Ghatnachakra / standard**

**Titlis** is a well-known peak / ski area of
...
**Ans: B.** **Titlis** lies in the **Swiss Alps** — a standard Alps–Switzerland association.

</details>

**Q-GC45. Ghatnachakra / standard**

The **Apennines** are the principal mountains of
...
**Ans: B.** The **Apennines** form the **spine of the Italian peninsula**.
...
**Ans: B.** The **Pyrenees** separate **Spain and France** (Andorra lies between them).
...
B. Middle East (SW Syria / Israel border zone)
...
**Ans: B.** The **Golan Heights** lie in the **Middle East**, on the **Syria–Israel** flank.

</details>

**Q-GC48. Ghatnachakra / standard**

**Mount Fuji**, **Mount Etna**, and **Cotopaxi** are examples of

A. block mountains

B. volcanic cone mountains

C. residual domes

D. fold mountains only

<details>
<summary>Show answer</summary>

**Ans: B.** All three are classic **volcanic cones** — a basic volcanic landform type.
...
**Ans: A.** **Elbrus** — Europe · **Kilimanjaro** — Africa · **Cook** — New Zealand · **McKinley** — North America.
...
**Ans: A.** **Atlas** — Morocco · **Kilimanjaro** — Tanzania · **Chimborazo** — Ecuador · **Pyrenees** — Spain–France.

</details>

**Q-GC51. Ghatnachakra / standard**

**Mont Blanc** is the highest peak of the **Alps**, located on the border of
...
D. Italy and Slovenia

<details>
<summary>Show answer</summary>

**Ans: A.** **Mont Blanc** (4,808 m) stands on the **France–Italy** border in the **Alps**.

</details>

**Q-GC52. Ghatnachakra / standard**

The average elevation of the **Tibetan Plateau** is approximately
...
D. 5,000 m (about 4,500 m+)

<details>
<summary>Show answer</summary>

**Ans: D.** The **Tibetan Plateau** averages about **4,500 m** — coaching keys often round to **~5 km**.

</details>

**Q-GC53. Ghatnachakra / standard**

The **Patagonian Plateau** of South America is often called a **storehouse of minerals** because

A. it is the world’s highest plateau

B. it holds rich coal, oil, and mineral deposits east of the Andes

C. it is entirely covered by rain forest

D. it lies in the equatorial belt

<details>
<summary>Show answer</summary>

**Ans: B.** **Patagonia** east of the **Andes** is a rain-shadow plateau noted for **mineral and hydrocarbon wealth** in coaching keys.

</details>

**Q-GC54. Ghatnachakra / standard**

**Madrid**, the capital of Spain, sits on the

A. Amazon lowland

B. Meseta (Central Plateau)
...
**Ans: B.** **Madrid** lies on the **Meseta** — the interior tableland of the Iberian Peninsula.

</details>

**Q-GC55. Ghatnachakra / standard**

The **Pamir Plateau** is known as the

A. Roof of the World

B. Bread Basket of Europe

C. Land of Midnight Sun
...
**Ans: A.** The **Pamir knot** is the classic **“Roof of the World”** — where Himalaya, Karakoram, Hindu Kush, and Tien Shan meet.

</details>

**Q-GC56. UPPCS / standard**

Which of the following is the **largest plateau** among the options given?
...
**Ans: B.** Among these **USA plateaus**, the **Colorado Plateau** is the **largest**; the world’s largest high plateau remains **Tibet**.

</details>

**Q-GC57. Ghatnachakra / standard**

The **Telegraphic Plateau** is associated with the
...
**Ans: B.** The **Telegraphic Plateau** lies on the **North Atlantic Ridge** (Newfoundland–Ireland submarine plateau lore).

</details>

**Q-GC58. Ghatnachakra / standard**

The **Telegraphic Plateau** is **not** found in the

A. North Atlantic Ocean

B. Indian Ocean

C. submarine ridge zone

D. North Atlantic Ridge belt

<details>
<summary>Show answer</summary>

**Ans: B.** The **Telegraphic Plateau** belongs to the **North Atlantic**, **not** the **Indian Ocean**.

</details>

**Q-GC59. Ghatnachakra / standard**

The **Altiplano** of Bolivia–Peru is an example of a(n)

A. intermontane plateau between fold ranges

B. coral atoll

C. delta plain

D. glacial moraine plain

<details>
<summary>Show answer</summary>

**Ans: A.** The **Altiplano** is a high **intermontane plateau** squeezed between **Andean cordilleras**.

</details>

**Q-GC60. Ghatnachakra / standard**

**Death Valley** in the USA is mainly a
...
**Ans: B.** **Death Valley** (California–Nevada) is a **rift / block valley** in the Basin-and-Range province.

</details>

**Q-GC61. Ghatnachakra / standard**

**Devil’s Golf Course** — a salt-pan landscape — is located in
...
**Ans: B.** **Devil’s Golf Course** is a famous **salt pan in Death Valley**, **California**, USA.

</details>

**Q-GC62. Ghatnachakra / standard**

**Death Valley** holds the record for extreme **heat** in
...
**Ans: A.** **Death Valley**, **California**, is among the **hottest places on Earth** (furnace-creek lore).

</details>

**Q-GC63. UKPCS / standard**

**Silicon Valley**, the global technology hub, is located in
...
**Ans: B.** **Silicon Valley** lies south of **San Francisco Bay** in **California**.
...
**Ans: B.** **Panjshir** lies north-east of **Kabul** in **Afghanistan**, in the Hindu Kush flank.

</details>

**Q-GC65. Ghatnachakra / standard**

**Taylor Valley** — the “Valley of the Dead” — is in
...
**Ans: B.** **Taylor Valley** is a dry valley in **Antarctica** (Victoria Land / McMurdo region).

</details>

**Q-GC66. Ghatnachakra / standard**

The **Great Artesian Basin** — a vast groundwater province — lies mainly in
...
**Ans: B.** The **Great Artesian Basin** underlies much of **eastern and central Australia**.

</details>

**Q-GC67. Ghatnachakra / standard**

The **Great Basin** is an endorheic region of

A. USA (between Rockies and Sierra Nevada)
...
**Ans: A.** The **Great Basin** covers much of **Nevada and adjoining USA states**, with no outlet to the sea.

</details>

**Q-GC68. Ghatnachakra / standard**

The **Valley of the Kings** — burial ground of pharaohs — is in
...
**Ans: B.** The **Valley of the Kings** lies on the **west bank of the Nile** near **Luxor**, **Egypt**.

</details>

**Q-GC69. Ghatnachakra / standard**

A **blind valley** that ends abruptly at a swallow hole is typical of

A. glacial terrain

B. karst (limestone) landscapes
...
**Ans: B.** **Blind valleys** form in **karst** where streams vanish into **sinkholes / caves**.

</details>

**Q-GC70. Ghatnachakra / standard**

**Sinkholes (dolines)** in limestone country are landforms of
...
**Ans: B.** **Sinkholes** are classic **karst** features formed by **underground dissolution of limestone**.

</details>

**Q-GC71. Ghatnachakra / standard**

The **Great Victoria Desert** — among the largest Australian deserts — lies mainly in
...
**Ans: A.** The **Great Victoria Desert** sprawls across **Western Australia and South Australia** — the largest desert by area in Australia in many lists.

</details>

**Q-GC72. Ghatnachakra / standard**

**Assertion (A):** Most hot deserts lie on the **western margins** of continents between about **15° and 30° latitude**.

**Reason (R):** Subtropical **trade-wind belts** and **cold ocean currents** suppress rainfall on those coasts.
...
**Ans: A.** **Horse-latitude subsidence** plus **west-coast cold currents** (Atacama, Namib logic) explain why hot deserts cluster on **western subtropical coasts**.

</details>

**Q-GC73. Ghatnachakra / standard**

**Assertion (A):** Deserts receive more **solar energy** in a few hours than humanity uses in a year.
...
**Ans: A.** **Cloud-free desert skies** concentrate solar input — the coaching **Knies-type** comparison with global energy use.

</details>

**Q-GC74. Ghatnachakra / standard**

A region is usually classed as a **desert** if annual rainfall is less than about
...
**Ans: B.** Standard geography uses **< 25 cm** annual precipitation as the desert threshold.

</details>

**Q-GC75. Ghatnachakra / standard**

Hot deserts are most widespread near latitude

A. 0° (Equator)

B. 23° N and S (subtropics)
...
**Ans: B.** **Subtropical highs** near **~23°–30°** create the global **hot-desert belt**.

</details>

**Q-GC76. UPPCS / standard**

Among continents, **desertification** is the **least serious problem** in
...
**Ans: C.** **Europe** essentially lacks a major hot desert and faces the **least desertification pressure** among these options.
...
**Ans: C.** The **Sahara** is the **largest hot desert**, covering much of **north Africa**.

</details>

**Q-GC78. Ghatnachakra / standard**

The **most densely populated desert** in the world is the
...
**Ans: B.** The **Thar** (India–Pakistan) supports the **largest desert population** among world deserts and is the **largest desert of South Asia**.
...
**Ans: B.** **Taklamakan** occupies the **Tarim Basin** of **north-west China (Xinjiang)**.
...
**Ans: B.** The **Gibson Desert** lies in **central–western Australia** — not Brazil.
...
**Ans: B.** The **Karakum** covers most of **Turkmenistan** (Karakum Canal lore).

</details>

**Q-GC82. Ghatnachakra / standard**

The **Lut Desert (Dasht-e Lut)** — among the hottest surface zones — is in
...
**Ans: B.** **Dasht-e Lut** lies in **south-east Iran** (Kerman / Sistan-Baluchestan belt).

</details>

**Q-GC83. Ghatnachakra / standard**

The **Gobi Desert** is chiefly a **cold desert** of
...
**Ans: B.** The **Gobi** spans **Mongolia** and **northern / north-west China** — not Russia or Kazakhstan in standard keys.

</details>

**Q-GC84. Ghatnachakra / standard**

Which sequence arranges these deserts from **smallest to largest** area?

A. Sahara — Arabian — Gobi — Great Sandy

B. Great Sandy — Gobi — Arabian — Sahara

C. Gobi — Great Sandy — Sahara — Arabian

D. Arabian — Sahara — Gobi — Great Sandy

<details>
<summary>Show answer</summary>

**Ans: B.** **Great Sandy < Gobi < Arabian < Sahara** is the standard hot-desert size ladder.

</details>

**Q-GC85. Ghatnachakra / standard**

The **Atacama Desert** extends along

A. southern Chile only

B. northern Chile and southern Peru (west coast of South America)

C. eastern Brazil

D. Patagonia, Argentina only

<details>
<summary>Show answer</summary>

**Ans: B.** **Atacama** lies on the **hyper-arid west coast** of **northern Chile into southern Peru** — not Patagonia alone.

</details>

**Q-GC86. Ghatnachakra / standard**

The **driest desert** on Earth is generally considered to be the
...
**Ans: B.** The **Atacama** records some of the **lowest rainfall** on the planet (Humboldt / Peru Current coast).

</details>

**Q-GC87. Ghatnachakra / standard**

**Patagonia** in Argentina is best described as a

A. tropical hot desert

B. temperate / cold rain-shadow desert

C. equatorial rainforest

D. Mediterranean scrubland only

<details>
<summary>Show answer</summary>

**Ans: B.** **Patagonia** east of the **Andes** is a **cold, rain-shadow semi-desert** — not a tropical hot desert.
...
1. Tropical deserts on **western continental margins** receive dry **trade-wind** subsidence.  
2. The **north-east Himalaya** receives heavy monsoon rain because moist winds rise on the windward slope.
...
**Ans: C.** Statement **1** is true for **west-coast subtropical deserts**; statement **2** is true for **monsoon-wet NE India / Himalaya**.

</details>

**Q-GC89. Ghatnachakra / standard**

The **Kalahari Desert** lies mainly in **Botswana and Namibia** and is located in the
...
D. Equatorial belt only

<details>
<summary>Show answer</summary>

**Ans: B.** The **Kalahari** spans **Botswana, Namibia, and north-west South Africa** — entirely in the **Southern Hemisphere**.

</details>

**Q-GC90. Ghatnachakra / standard**

The great **African–Eurasian desert belt** (Sahara–Arabian–Iranian–Thar fringe) is mainly caused by

A. warm ocean currents on west coasts

B. subtropical high-pressure cells and descending dry air

C. equatorial convection rain

D. polar front cyclones year-round

<details>
<summary>Show answer</summary>

**Ans: B.** **Subtropical highs** (~23°–30°) drive **descending dry air** — **not** warm currents, which actually suppress rain on **west** coasts via a different mechanism.
...
Older stems from Ghatnachakra CB–82+ (tropical vs temperate grasslands · local names · savanna). Teaching lives in Topic 18 N.7. Year-coded UPPCS stems already in Topic 18 (Pampas 2018, Land of Big Games 2019) are not repeated here.

**Q-GC1. Ghatnachakra / MPPCS 2020**
...
**Ans: C.** Steppes–Russia; Prairies–USA; Welds (Veld)–South Africa; Downs–Australia. Code **3 1 2 4**.

</details>

---

**Q-GC2. UPPCS Mains 2015 / standard**
...
**Ans: D.** Veld is in **South Africa**, not Australia. Australia’s temperate grassland = **Downs**.

</details>

---

**Q-GC3. UPPCS Mains 2016 / standard**
...
**Ans: A.** Llanos–South America; Steppe–Europe; Prairies–North America; Veld–Africa. Code **4 3 1 2**.

</details>

---

**Q-GC4. RAS 1992 / standard**
...
D. United States of America — the Steppe

<details>
<summary>Show answer</summary>

**Ans: B.** Pampas = Argentina (+ Uruguay / S Brazil). Campos = Brazil; Savanna = E Africa; Steppe = Eurasia.

</details>

---

**Q-GC5. UPPCS Mains 2011 / Pre 1993**

The Savannas are most widespread in —
...
**Ans: A.** Tropical savanna is most extensive in **Africa** (East Africa core), though Campos/Llanos also exist.

</details>

---

**Q-GC6. BPSC 2016 / standard**

What is the name of mid-latitude grassland in South America?
...
**Ans: B.** Mid-latitude / temperate grassland of South America = **Pampas**.
...
**Assertion (A):** The Pampas plain is the main region for cultivation in Argentina.

**Reason (R):** The fertile soil of Pampas and the temperate climate are very useful for growing crops and grasses.
...
**Ans: A.** Both true; fertile temperate Pampas soils explain why Argentina cultivates there.

</details>

---

**Q-GC8. UPPCS Pre 2005**
...
**Ans: B.** Pampas = South American temperate grasslands. **Selvas** = Amazon rainforest.

</details>

---

**Q-GC9. UPPSC GIC 2010**
...
**Ans: B.** Llanos = Venezuela–Colombia (Orinoco). Campos = mainly SE Brazil highlands; Pampas ≠ Chile; Selvas = Amazon rainforest.

</details>

---

**Q-GC10. UPPCS Mains 2002**
...
**Ans: A.** Downs are **temperate** grasslands of Australia, not tropical.

</details>

---

**Q-GC11. UPPCS Pre 2012 / Lower 2013**
...
**Ans: D.** Savanna is **tropical**. Pampas, Veld and Downs are temperate.

</details>

---

**Q-GC12. UPPCS Mains 2012**

In which one of the following countries are Pampas Grasslands located?
...
**Ans: C.** Mainly **Argentina** (also extends into Uruguay and S Brazil). Best single-country key = Argentina.

</details>

---

**Q-GC13. UPPCS Pre 2014**
...
**Ans: C.** Eurasian temperate grassland = **Steppes**. Downs = Australia; Veld = South Africa; Prairie = N America.

</details>

---

**Q-GC14. IAS 2021 / standard**

The vegetation of savannah consists of grassland with scattered small trees, but extensive areas have no trees. Forest development is generally kept in check by one or more of these conditions:
...
**Ans: C.** Lead trio = **fire + grazing herbivores + seasonal rainfall**. Burrowers/soil alone are not the standard key set.

</details>

---

**Q-GC15. UP RO/ARO Pre 2017**
...
**Ans: A.** Pampas–Argentina; Pustaz (Puszta)–Hungary; Veld–South Africa; Downs–Australia. Code **3 4 2 1**.
...
## Complete PYQ Bank — Ghatnachakra Islands (UPPCS / UKPCS / standard)

Older stems from Ghatnachakra CB–145+ (world islands). Teaching lives in Topic 18 N.5. Year-coded UPPCS Borneo 2022 (Only 1 — not volcanic) is already in Topic 18 teaching/bank and is not repeated here.

**Q-GC1. UP Lower 2015**

Which of the following islands are known as 'Sheep Islands'?
...
**Ans: C.** **Faroe Islands** (Denmark) = Sheep Islands.

</details>

---

**Q-GC2. UPPCS Mains 2015**

Which one of the following is the largest in area?
...
**Ans: C.** **NZ South Island** is largest among the four.

</details>

---

**Q-GC3. UPPCS Pre 1993**
...
**Ans: B.** **Greenland** is the largest island.

</details>

---

**Q-GC4. UKPCS Pre 2021 / 2010**
...
**Ans: C.** **New Guinea** is 2nd after Greenland.

</details>

---

**Q-GC5. UPPCS Mains 2012**
...
C. The elevation of Nuuk above the sea level is 3 metre

D. Greenland belongs to the U.S.A.

<details>
<summary>Show answer</summary>

**Ans: C.** Nuuk elevation ~**1–3 m**. Greenland = largest island; Denmark (not USA); Nuuk = capital.
...
**Ans: A.** Greenland = **Denmark** (autonomous).

</details>

---

**Q-GC7. UPPCS Pre 2010**

Which one among the following eastern islands is divided into three countries?
...
**Ans: A.** **Borneo** = Indonesia, Malaysia, Brunei.
...
Which one among the following is the largest island in area?
...
**Ans: A.** Among options **Borneo** is largest.
...
Kalimantan is a part of which of the following islands?
...
**Ans: B.** Kalimantan = Indonesian **Borneo**.

</details>

---

**Q-GC10. UK UDA/LDA 2007**
...
**Ans: A.** Madagascar sits in the **SW Indian Ocean**.
...
In the map of the Indian Ocean, four islands — Seychelles, Chagos, Mauritius and Socotra — are marked. The correct match order A B C D = Seychelles, Chagos, Mauritius, Socotra is:
...
**Ans: D.** GC key: Seychelles–3, Chagos–1, Mauritius–4, Socotra–2 → **3 1 4 2**.
...
Which of the following islands of the Pacific Ocean belongs to Melanesia group of islands?
...
**Ans: A.** **Solomon** = Melanesia. Gilbert/Marshall = Micronesia; Society = Polynesia.
...
**Ans: A.** Diego Garcia = **Indian Ocean** (Chagos).
...
The distance from Aceh in the far North West to Torres Strait in the east… The archipelago has ~14,000 islands… This description best fits:
...
**Ans: D.** **Indonesia** (Aceh → Torres Strait frame).
...
On an Atlantic map, islands marked 1–4 are respectively:
...
**Ans: C.** GC key order: **Azores, Cape Verde, Bahamas, Falkland**.

</details>

---

**Q-GC16. UPPCS Pre 1993**

Which of the following statement is not correct?

A. Falkland Archipelago is located in the Indian Ocean.
...
**Ans: A.** Falklands = **South Atlantic**, not Indian Ocean.
...
**Ans: B.** Fiji = **South Pacific**.

</details>

---

**Q-GC18. UP RO/ARO Mains 2021**

With reference to the 'Galapagos Islands' situated in the Pacific Ocean, which of the following statements is/are correct?

(1) They are formed due to volcanic activity.
(2) They are part of South American nation Peru.
...
**Ans: A.** Volcanic = true. Country = **Ecuador**, not Peru.

</details>

---

**Q-GC19. UPPCS Pre 1991 / BPSC 2020**
...
**Ans: D.** **Honshu** is Japan’s largest; Tokyo sits on it.

</details>

---

**Q-GC20. UP RO/ARO Pre 2017 / BEO 2019**

Which of the following represents the correct north to south sequence of the four major islands of Japan?
...
**Ans: C.** **Hokkaido → Honshu → Shikoku → Kyushu**.

</details>

---

**Q-GC21. UPPCS Pre 1990**

When was Macau island transferred to China?
...
**Ans: D.** Macau → China in **1999** (Hong Kong was 1997).
...
**Ans: A.** Balearics = **W Mediterranean** (Spain).
...
**Ans: C.** **Majuli** on the **Brahmaputra**.

</details>

---

**Q-GC24. UK UDA/LDA 2006**

Which of the following is an island continent?
...
**Ans: D.** **Australia** = island continent.

</details>

---

**Q-GC25. UKPCS Pre 2012**

Grenada is located in –
...
**Ans: C.** Grenada = SE **Caribbean** (“Island of Spices”).

</details>

---

**Q-GC26. UPPSC GIC 2017**

Which of the following islands is known for its Salt-Pan resources?

A. Isle of Man

B. Saint-Martin Island
...
**Ans: B.** **Saint Martin** = salt pans / lagoons cue.
...
**Ans: B.** Among options **Indonesia** (~17,500).

</details>

---

**Q-GC28. UPPCS Pre 2021**

With reference to Socotra Island which of the following statement is/are correct?
...
**Ans: B.** UNESCO 2008 true. Socotra = **Yemen**, not Oman.
...
**Ans: C.** **Madeira** = N Atlantic (Portugal).
...
Which of the following is not a part of Polynesia group of Islands?
...
**Ans: D.** **Tinian** (Marianas) is not Polynesia.
...
## Complete PYQ Bank — Ghatnachakra Forests World Climate (UPPCS / UKPCS / standard)

Older stems from Ghatnachakra CB–183+ (world forests · climatic regions · ENSO). Teaching lives in Topic 18 N.8–N.9. Year-coded UPPCS Mediterranean/El Niño stems already elsewhere are not repeated as identical year-coded entries.

**Q-GC1. UP BEO 2019**

Selva forests are characterized by:

A. Broad leaf evergreen
...
**Ans: A.** Amazon **Selva** = equatorial broadleaf **evergreen**.
...
**Ans: A.** **Temperate coniferous / taiga** covers the largest share.
...
Which of the following countries has a constitutional provision for maintaining 60% of its geographical area under forest?
...
**Ans: C.** **Bhutan** constitutional forest target.

</details>

---

**Q-GC4. UKPCS Pre 2002**

The evergreen rainforests are found in:
...
**Ans: B.** Classic Amazon/**Brazil** equatorial rainforest.
...
The world’s largest and most dense forests are in-
...
**Ans: D.** Among options **Japan** has the highest % forest cover.

</details>

---

**Q-GC7. UPPCS Pre 2001**
...
**Ans: A.** Amazonia = tropical evergreen, **not** taiga.
...
If tropical rain forest is removed, it does not regenerate quickly as compared to a tropical deciduous forest. This is because
...
**Ans: A.** Rainforest soils are **nutrient-poor** (fast recycling in biomass).
...
**Ans: D.** Soils are **poor**; decomposition statement is true.
...
**Ans: D.** Savanna = clear **wet and dry** seasons.
...
Warm and dry climate, mild and wet winter, evergreen oak trees — characteristics of:
...
**Ans: A.** **Mediterranean** Cs climate.
...
Each day is more or less the same… afternoon rain with thunder… describes:
...
**Ans: B.** **Equatorial** convectional afternoon rains.

</details>

---

**Q-GC13. UPPCS Pre 2022**
...
**Ans: D.** Both true; winter rain is mainly from **westerlies** shift — R is true but not the full/sole explanation in this key.
...
Climate is extreme, rainfall is scanty and the people used to be nomadic herders — best describes:
...
**Ans: B.** **Central Asian Steppe**.

</details>

---

**Q-GC15. UP UDA/LDA 2001**

The world’s wettest place is:
...
For short-term climatic predictions, which event is associated with occasional weak monsoon rains in the India sub-continent?
...
**Ans: C.** **El Niño / ENSO** weakens Indian monsoon.
...
1. La Nina is unusually cold ocean temperature in the equatorial Indian Ocean whereas El Nino is warm in equatorial Pacific.
2. El Nino has adverse effect on SW monsoon of India, but La Nina has no effect on monsoon climate.
...
**Ans: D.** Both statements are wrong (La Niña is Pacific cool phase; it can strengthen monsoon).
