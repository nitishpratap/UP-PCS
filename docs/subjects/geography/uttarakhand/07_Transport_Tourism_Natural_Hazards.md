...
> **Sources:** Survey of India, BRO (Border Roads Organisation), Wadia Institute of Himalayan Geology, Disaster Mitigation & Management Centre (DMMC) Dehradun, UKPCS PYQ stems (Silkyara tunnel length 2025 Q51, Airport mismatch 2025 Q103, SCCC 2011 Q106, Sinla Pass, Traill's Pass, Bedni Bugyal, Malpa landslide 1998, Kedarnath 2013).  
> **Pair with:** [Location & Relief](01_Location_Relief_Structure.md) · [Climate & Drainage](02_Climate_and_Drainage.md) · [National Disaster Geography](../../geography/13_Disaster_Geography.md)
...
```
      ...
      ┌────────────────────────────┼────────────────────────────┐
      ▼                            ▼                            ▼
[Uttarkashi Passes]         [Chamoli Passes]            [Pithoragarh Passes]
 • To Tibet: Thang-La,       • To Tibet: Niti, Mana,      • To Tibet: Lipulekh, Unta
   Muling-La, Tsang-Chok-La    Chorhoti, Kingri-Bingri      Dhura, Darma, Lampiya
 • To HP: Shringkanth        • To Uttarkashi: Kalindi     • To Bageshwar: Traill's Pass
 • To Chamoli: Kalindi       • To Bageshwar: Sunderdhunga • Between Valleys: Sinla (Darma-Byans)
```
...
## Alpine Meadows (Bugyals) of Uttarakhand

In the vernacular language of the Central Himalaya, gentle grassy slopes situated above the tree line (between 3,000 m and 4,500 m) are called **Bugyal** (in Garhwal) or **Payar / Bugyal** (in Kumaon):
...
## Natural Hazards & Historical Disaster Timeline

Uttarakhand's geologically active mountain slopes, fragile tectonic faults (Main Central Thrust - MCT, Main Boundary Thrust - MBT), steep gorges, and monsoon downpours make it exceptionally susceptible to recurring natural calamities:
...
**Q1 (UKPCS Prelims 2025, Q51).** The Silkyara Tunnel spanning ____ is expected to shorten the distance between Gangotri and Yamunotri by above 20 km.  
A. 2.531 km  
B. 3.531 km  
C. 4.531 km  
D. 6.531 km  
...
**Q2 (UKPCS Prelims 2025, Q103).** Which pair is NOT correctly matched?  
...
C. Both 1 and 2  
D. Neither 1 nor 2  
*Answer:* **A** (UAPCC drafting belongs to Environment/Forest authorities).

**Q4.** Which high-altitude mountain pass connects the Darma Valley with the Byans Valley in Pithoragarh district?  
A. Lipulekh Pass  
B. Sinla Pass  
C. Traill's Pass  
D. Unta Dhura Pass  
...
**Q5.** In which alpine meadow (Bugyal) of Uttarakhand is the traditional folk festival 'Anduri Utsav' (Butter Festival) celebrated?  
A. Bedni Bugyal  
B. Auli Bugyal  
C. Dayara Bugyal  
D. Chopta Bugyal  
*Answer:* **C** (Dayara Bugyal in Uttarkashi).
