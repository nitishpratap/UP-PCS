...
Ancient Indian Art | Ancient Indian Sculpture | Ancient Indian Architecture | Ancient Indian Agriculture | Ancient Indian Industries

</details>

> **Sources baked in:** NCERT An Introduction to Indian Art (Class 11), Themes I, UPPCS Prelims 2018–2025  
> **Exam weight:** ★★★ — IVC site ↔ state, sculpture school ↔ stone, first temple, crops, crafts  
> **Last verified:** August 2026  
> **Current Affairs:** No new lock that changes the IVC-UP list after **2025 Q87**. Dholavira remains UNESCO WHS **2021**. Sarnath WHS **2026** is a monument lock, not a new art-school.
...
- Harappan art is craft-heavy: seals, terracotta, beads and painted pottery. It is not only “religion.”
- **Steatite seals** show a unicorn or humped bull plus undeciphered script. They served as trade and identity marks.
- The **terracotta mother goddess** is a Harappan staple. It is distinct from the later stone Yakshi.
- IVC used wheel-thrown painted pottery. Brick was standardised and burnt.
...
> **Exam note:** **Bhimbetka = Wakankar + prehistoric**. **NBPW = Maurya**. **Seals = steatite**.
...
**Ans: A — Both 1 and 2.** Mauryan cultural-policy lock.
...
**Lock:** school — stone — one extra fact
...
- Amaravati-region stupas show a **platform with Aryaka-pillars**. This is the UPPCS **2022 Q80** lock.
...
> **Exam note:** **Mathura = red sandstone, UP**. **Gandhara = grey schist, Greco-Roman**. **Amaravati = limestone + Aryaka-pillars**.
...
- The **Great Bath** is at **Mohenjo-daro**. It is a watertight tank. It is not Harappa’s headline lock and not at Varanasi.
...
> **Exam note:** **Mandi + Hulas = UP**. **Rakhigarhi ≠ UP**. **Alamgirpur = eastern boundary**.
...
**Ans: B — Alamgirpur** (Meerut, UP). Manda = northern (J&K). Rakhigarhi = Haryana.
...
**Ans: D — III, IV.** Kalibangan = Rajasthan. Lothal = Gujarat.
...
- Terracotta **plough** models are known. The wooden plough had a simple share.
- **Kalibangan** preserves a **ploughed field**.
- Granaries in citadels (Harappa, Mohenjo-daro) indicate surplus storage.
- Irrigation used river flood and **wells**. Dholavira shows planned water storage.
- **Rigvedic** society is mainly **pastoral**. Cattle counted as wealth.
- **Later Vedic** society is more **agrarian**. Rice (*vrihi*) grows in the eastern Gangetic belt.
- The Mauryan state treats agriculture as the revenue base. The *Arthashastra* records land measure and irrigation officers.
- Iron tools (axe, sickle) spread widely by the Mauryan age and after. Forest clearance opens new fields.
...
> **Exam note:** **IVC = wheat + barley + cotton**. **Rigvedic = pastoral**. **Later Vedic = agrarian**. UPPCS **2020 Q21**.
...
- The **Dancing Girl** is **bronze**, made by **lost-wax (cire perdue)**, from Mohenjo-daro. It is not terracotta and not stone.
- IVC used copper–bronze tools. Gold and silver jewellery is also known.
- **Iron** becomes a mass tool-metal by Mauryan times. Pillars remain stone.
- **Wootz** is South Indian crucible steel. It had export fame (later “Damascus” raw).
- Cotton textiles are known from IVC onward. Indian cotton was known in Roman trade.
- Silk references thicken in Mauryan–Gupta texts. The *Arthashastra* knows silk cloth.
- **NBPW** is a Mauryan pottery industry, not a metal.
...
- **Manigrama** was a South Indian merchant guild with long-distance / overseas trade. It is the UPPCS **2018** foreign-trade lock.

> **Exam note:** **Beads = Chanhudaro**. **Dancing Girl = bronze**. **Punch-marked ≠ Gupta gold**. **Sreni ≠ Nanadesi**.
...
1. Gold dinaras are a coinage lock.  
...
2. Gupta temples are the first structural Hindu temples in the usual exam lock.  
...
**Q28.** Chunar sandstone is the usual material lock for:
...
**Q31.** Which of the following is/are Harappan industry locks?
...
| 2026 | Sarnath UNESCO WHS | Lion Capital / Gupta Buddha site is already the sculpture lock | UNESCO |
