# Topic 1 — Folk Culture of Uttarakhand
...
1. **Chholiya = Chhau** → different forms / regions.
2. **Aipan = Rajasthan Mandana only** → Aipan is the Kumaon card.
3. **Ramman = Ramlila of UP** → Garhwal UNESCO element.
