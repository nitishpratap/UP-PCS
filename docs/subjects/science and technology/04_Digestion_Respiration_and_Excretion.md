...
Digestive System Anatomy (Mouth, Teeth, Salivary Glands, Stomach, Liver, Gall Bladder, Pancreas, Small & Large Intestine) | Dental Formula & Tooth Structure (Enamel) | Digestive Enzymes & Juices (Ptyalin, Pepsin, Rennin, Bile, Trypsin, Lipase, Succus Entericus) | Digestion of Carbohydrates, Proteins, Fats, Starch & Cellulose | Absorption Mechanics (Villi, Lacteals, Chylomicrons) | Respiratory System (Airway Anatomy, Larynx, Trachea, Alveoli) | Breathing Mechanics (Diaphragm, Intercostal Muscles) & Lung Volumes (Tidal, Vital Capacity, Residual) | Gas Transport ($O_2$ Oxyhaemoglobin, $CO_2$ Bicarbonate, Bohr Effect) & Carbon Monoxide Poisoning | Cellular Respiration (Glycolysis, Krebs Cycle, ETS, ATP Yield, Lactic Acid Debt) | Excretory System Anatomy (Kidney, Nephron Structure, Malpighian Body, Tubules) | Urine Formation (Ultrafiltration, Selective Reabsorption, Tubular Secretion) | Counter-Current Mechanism & Hormonal Regulation (ADH, Aldosterone, RAAS, ANF) | Nitrogenous Wastes (Ammonotelic, Ureotelic, Uricotelic) | Excretory Disorders (Renal Calculi, Uremia, Gout, Dialysis)

</details>

> **Sources baked in:** NCERT Class 10 & 11 (Life Processes, Digestion and Absorption, Breathing and Exchange of Gases, Excretory Products and Elimination), Lucent General Science (Physiology & Enzymes), UPPCS Prelims PYQs (2018–2025) and UKPCS Prelims
> **Weight:** ★★★ High — heavily tested: site of initiation of protein digestion, stomach vs pancreatic enzymes, bile function, lung volumes, gas transport forms, nephron reabsorption sites, and nitrogenous waste types
...
29. **Carbon Dioxide Transport in Blood**:
    - **$\mathbf{\sim 70\%}$ is transported as Bicarbonate ions ($\mathbf{HCO_3^-}$)** dissolved in blood plasma.
    - **$\mathbf{\sim 20–25\%}$ is transported bound to haemoglobin as Carbamino-haemoglobin**.
    - **$\mathbf{\sim 7\%}$ is transported dissolved in blood plasma**.
30. The conversion of $CO_2$ and $H_2O$ into carbonic acid ($H_2CO_3$) and bicarbonate inside RBCs is catalysed by the zinc-containing enzyme **Carbonic Anhydrase**; balanced by the inward migration of chloride ions from plasma into RBCs (**Chloride Shift / Hamburger Phenomenon**).
31. **Bohr Effect**: Lowering of blood pH (acidosis) or elevated carbon dioxide tension ($pCO_2$) shifts the oxyhaemoglobin dissociation curve to the **right**, decreasing haemoglobin's oxygen affinity and promoting rapid unloading of oxygen to respiring tissues.
32. **Carbon Monoxide ($CO$) Poisoning**: Carbon monoxide has an affinity for haemoglobin **$\mathbf{200–250\text{ times greater}}$ than oxygen**; forms extremely stable **Carboxyhaemoglobin ($COHb$)**, permanently blocking oxygen binding sites, causing severe cellular asphyxiation, tissue hypoxia, and cherry-red skin discoloration.
33. **Regulation of Respiration**: Primary respiratory rhythm centre is located in the **Medulla Oblongata** of the brain stem; **Pneumotaxic centre** is in the **Pons Varolii**; central chemoreceptors are exquisitely sensitive to arterial **excess of $\mathbf{CO_2}$ and Hydrogen ions ($\mathbf{H^+}$)**, **not to low oxygen**.
34. Aerobic cellular respiration yields **36 or 38 molecules of ATP** per oxidized glucose molecule: Glycolysis in cytoplasm (net 2 ATP + 2 NADH) $\rightarrow$ Link reaction in mitochondrial matrix (2 NADH) $\rightarrow$ Krebs Cycle in mitochondrial matrix (2 ATP + 6 NADH + 2 FADH2) $\rightarrow$ Electron Transport System (ETS) on inner mitochondrial cristae.
35. Anaerobic glycolysis in over-exerted skeletal muscles produces **Lactic Acid**; accumulation causes acute muscle fatigue and cramp; lactic acid is transported via bloodstream to the liver and resynthesised into glucose via the **Cori Cycle**.
36. Nitrogenous excretion types:
    - **Ammonotelic**: Excrete highly toxic **Ammonia** requiring copious water ($300–500\text{ mL/g}$); e.g. bony fish, aquatic amphibians (tadpoles), aquatic invertebrates.
    - **Ureotelic**: Excrete less toxic **Urea**; synthesised in the liver via the **Ornithine Cycle / Krebs-Henseleit Cycle** from ammonia and $CO_2$; e.g. mammals, adult amphibians, marine sharks.
    - **Uricotelic**: Excrete non-toxic, insoluble **Uric Acid** as a semi-solid paste/pellet with minimal water loss; e.g. birds, terrestrial reptiles, insects, land snails.
37. The structural and functional filtration unit of the human kidney is the **Nephron** (~1 to 1.2 million nephrons per kidney).
38. **Malpighian Body (Renal Corpuscle)**: Composed of a tuft of capillaries called the **Glomerulus** encased inside a double-walled cup called **Bowman's Capsule**.
39. **Ultrafiltration**: Glomerular capillary blood pressure forces water, glucose, amino acids, ions, and urea across the trilaminar filtration membrane into Bowman's capsule, forming **Glomerular Filtrate (180 litres/day; GFR = 125 mL/min)**; blood cells and plasma proteins (albumin) are retained.
40. **Selective Reabsorption in the Proximal Convoluted Tubule (PCT)**: PCT is lined by simple cuboidal brush-border epithelium with microvilli; **reabsorbs $\mathbf{70–80\%}$ of all filtered water and electrolytes, and $\mathbf{100\%}$ of filtered glucose and amino acids** via active transport.
41. **Loop of Henle & Counter-Current Multiplier**: Hairpin loop maintaining high osmotic medullary gradient; descending limb is permeable to water and impermeable to salts; ascending limb is impermeable to water and actively pumps out NaCl; operates alongside **Vasa Recta** to produce concentrated hypertonic urine.
42. **Hormonal Regulation of Excretion**:
    - **Antidiuretic Hormone (ADH / Vasopressin)**: Secreted by posterior pituitary; acts on DCT and collecting ducts to insert aquaporins, promoting water reabsorption; deficiency causes **Diabetes Insipidus** (profuse dilute urine).
    ...
    - **Atrial Natriuretic Factor (ANF)**: Secreted by heart atria in response to high blood pressure; promotes sodium excretion (natriuresis) and vasodilation, antagonising RAAS.
43. Normal human urine is slightly acidic (**pH $\mathbf{\sim 6.0}$**); pale yellow colour is due to the pigment **Urochrome** (derived from the metabolic breakdown of haemoglobin).
...
| Digestive Gland / Source | Secreted Juice / Enzyme | Substrate Acted Upon | End Products Formed | Optimum pH |
|--------------------------|-------------------------|----------------------|---------------------|------------|
| **Salivary Glands** | **Ptyalin (Salivary Amylase)** | Cooked Starch (~30%) | Maltose, Isomaltose, $\alpha$-dextrins | 6.8 (Slightly acidic) |
| **Gastric Glands (Chief cells)** | **Pepsin** (from Pepsinogen) | Native Proteins | Proteoses and Peptones (Peptides) | 1.5–2.0 (Strongly acidic) |
| **Gastric Glands (Infants)** | **Rennin** (from Prorennin) | Milk protein Casein | Insoluble Calcium Paracaseinate | 1.5–2.0 |
| **Liver (Hepatocytes)** | **Bile** (NO enzymes) | Large fat globules | Emulsified fat micro-droplets | 7.6–8.6 (Alkaline) |
| **Pancreas (Exocrine Acini)** | **Pancreatic Amylase (Amylopsin)** | Remaining Starches | Maltose and Isomaltose | 7.5–8.5 |
| **Pancreas (Exocrine Acini)** | **Trypsin & Chymotrypsin** | Proteins, Peptones | Short Dipeptides & Tripeptides | 7.5–8.5 |
| **Pancreas (Exocrine Acini)** | **Steapsin (Pancreatic Lipase)**| Emulsified Triglycerides | Diglycerides, Monoglycerides, Fatty acids | 7.5–8.5 |
| **Pancreas (Exocrine Acini)** | **Carboxypeptidases** | Peptides at C-terminus | Free Amino Acids | 7.5–8.5 |
| **Small Intestine (Succus Entericus)** | **Enterokinase** | Trypsinogen | Active Trypsin (Master activator) | 7.8 |
| **Small Intestine (Succus Entericus)** | **Maltase** | Maltose | Glucose + Glucose | 7.8 |
| **Small Intestine (Succus Entericus)** | **Sucrase (Invertase)** | Sucrose | Glucose + Fructose | 7.8 |
| **Small Intestine (Succus Entericus)** | **Lactase** | Lactose | Glucose + Galactose | 7.8 |
| **Small Intestine (Succus Entericus)** | **Erepsin (Peptidases)** | Dipeptides | Individual Free Amino Acids | 7.8 |

### Respiratory Volumes & Capacities Breakdown

| Parameter | Clinical Definition | Standard Adult Volume |
|-----------|---------------------|-----------------------|
| **Tidal Volume (TV)** | Volume of air inspired or expired in a normal quiet respiration | **$\sim 500\text{ mL}$** |
| **Inspiratory Reserve Volume (IRV)** | Maximum extra volume inspired forcefully after quiet inspiration | **$2500–3000\text{ mL}$** |
| **Expiratory Reserve Volume (ERV)** | Maximum extra volume expired forcefully after quiet expiration | **$1000–1100\text{ mL}$** |
| **Residual Volume (RV)** | Volume of air remaining permanently inside lungs after maximal expiration | **$1100–1200\text{ mL}$** |
| **Vital Capacity (VC)** | Maximum air exhaled after maximal forced inspiration ($TV + IRV + ERV$) | **$3500–4500\text{ mL}$** |
| **Total Lung Capacity (TLC)** | Total volume of air in lungs after maximal inspiration ($VC + RV$) | **$5000–6000\text{ mL}$** |

### Nephron Segments & Functional Architecture

| Nephron Segment | Histological Lining | Primary Transport Process | Key Substances Moved |
|-----------------|---------------------|---------------------------|----------------------|
| **Glomerulus & Bowman's Capsule** | Podocytes with filtration slits | **Ultrafiltration** ($180\text{ L/day}$) | Filters water, glucose, salts, urea; retains blood cells and large proteins |
| **Proximal Convoluted Tubule (PCT)** | Simple cuboidal brush border | **Selective Reabsorption** ($70–80\%$) | $100\%$ Glucose, $100\%$ Amino acids, $70–80\%$ $Na^+, K^+, Cl^-$, $HCO_3^-$, Water |
| **Descending Limb of Henle** | Thin squamous epithelium | **Water reabsorption** | Highly permeable to water; completely impermeable to electrolytes |
...
## 4.1 Digestive Physiology: From Mouth to Absorption

- **The Human Mouth & Mechanical Mastication**:
  - Food is ingested into the buccal cavity, where it is mechanically masticated by teeth and lubricated by saliva to form a swallowed mass called a **Bolus**.
  - **Human Dentition Characteristics**:
    - **Thecodont**: Every tooth is embedded in a deep bony jaw socket (alveolus).
    - **Diphyodont**: Two sets of teeth during lifetime: deciduous / milk teeth (20 teeth) replaced by permanent adult teeth (32 teeth).
    - **Heterodont**: Four morphologically and functionally distinct types of teeth:
      - **Incisors ($I$)**: Chisel-shaped, for biting and cutting food.
      - **Canines ($C$)**: Dagger-shaped, sharp, for tearing meat (prominent in carnivores; absent in rodents $\rightarrow$ toothless gap termed **Diastema**).
      - **Premolars ($PM$)**: Bicuspid, for grinding and chewing food (absent in milk dentition).
      - **Molars ($M$)**: Broad, multicuspid, for crushing and grinding food; the 3rd molar on each side is the **Wisdom Tooth** (erupts at age 17–25; vestigial).
  - **Salivary Glands**: Three pairs of exocrine salivary glands secrete 1.0–1.5 litres of saliva per day:
    1. **Parotid Glands**: Largest pair, situated below and in front of the ears; opens via **Stensen's duct**; infection by Paramyxovirus causes painful swelling called **Mumps**.
    2. **Submandibular / Submaxillary Glands**: Located at the angles of the lower jaw; opens via **Wharton's duct**; secretes the majority of resting saliva.
    3. **Sublingual Glands**: Smallest pair, situated under the tongue; opens via **Ducts of Rivinus**.
    - Saliva contains **Ptyalin (Salivary Amylase)** which digests cooked starch into maltose, **Lysozyme** (bactericidal enzyme cleaving bacterial cell walls), secretory **IgA**, and bicarbonate buffer (pH 6.8).
- **Gastric Digestion in the Stomach**:
  - The stomach is a J-shaped muscular organ with 4 regions: Cardiac, Fundus, Body, and Pylorus. Guarded by the **Gastro-oesophageal sphincter** at the entry and the **Pyloric sphincter** at the exit.
  - Gastric mucosa contains branched tubular **Gastric Glands** possessing three major cell types:
    1. **Mucous Neck Cells**: Secrete protective alkaline mucus.
    2. **Peptic / Chief / Zymogenic Cells**: Secrete inactive proenzymes **Pepsinogen** and **Prorennin**.
    3. **Parietal / Oxyntic Cells**: Secrete **Hydrochloric Acid (HCl)** and **Castle's Intrinsic Factor** (indispensable for Vitamin B12 absorption in the ileum).
  - Functions of Gastric HCl: Creates a strongly acidic environment (pH 1.5–2.0); kills ingested food-borne bacteria; decalcifies bone fragments; converts inactive pepsinogen into active **Pepsin**.
  - **Pepsin** cleaves internal peptide bonds of dietary proteins, converting complex proteins into soluble **Proteoses and Peptones**.
  - Food is churned into an acidic, semi-fluid pulpy mass called **Chyme**.
- **Duodenal Digestion: Liver, Bile & Pancreas**:
  - Acid chyme enters the C-shaped **Duodenum** through the pyloric valve; triggers secretion of two local enterogastrone hormones:
    - **Secretin**: Discovered by **Bayliss and Starling (1902)** (the **first discovered hormone in history**); stimulates pancreatic secretion of watery bicarbonate juice to neutralise gastric acid.
    - **Cholecystokinin (CCK / Pancreozymin)**: Stimulates gall bladder contraction to eject bile, and stimulates pancreatic secretion of digestive enzymes.
  - **The Dual Pancreas**:
    - Endocrine Islets of Langerhans (1–2% mass): Insulin and Glucagon (Topic 3).
    - Exocrine Acinar Tissue (98% mass): Secretes complete pancreatic juice into the duodenum via the **Pancreatic Duct (Duct of Wirsung)**, joining the common bile duct to form the **Hepato-pancreatic Ampulla (Ampulla of Vater)**, guarded by the **Sphincter of Oddi**.
- **Intestinal Absorption & The Hepatic Portal Axis**:
  - The small intestine (Jejunum and Ileum) completes digestion via brush-border enzymes of the **Succus Entericus**.
  - Monosaccharides (glucose, galactose) and amino acids are actively transported across villus enterocytes into local blood capillaries; coalesce into the **Hepatic Portal Vein**, which transports newly absorbed nutrients directly to the **Liver** for metabolic sorting, storage, and detoxification before systemic circulation.
...
D. In liver triglycerides increase  
<details>
<summary>Show answer</summary>
...
iii.Its secretion is said to be complete digestive juice.
...
D. Succinic – Lysosomal dehydrogenase marker enzyme, hydrolyses metabolites.  
<details>
<summary>Show answer</summary>
