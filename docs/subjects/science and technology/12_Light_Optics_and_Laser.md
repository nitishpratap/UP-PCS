...
- **Albedo & Fresh Snow (UPPCS Pre 2021)**:
  - Fresh snow and clean ice have the highest albedo on Earth, reflecting **$80\%$ to $85\%$** of incident solar radiation.
...
## Master Tables & Core Optical Formulations

### Table 1: Master Summary of Image Formation by Spherical Mirrors
| Mirror Type | Position of Object | Position of Image | Nature of Image | Relative Size |
|---|---|---|---|---|
| **Concave** | At Infinity | At Focus ($F$) | Real and Inverted | Highly Diminished (Point) |
| **Concave** | Beyond Centre of Curvature ($C$) | Between $F$ and $C$ | Real and Inverted | Diminished |
| **Concave** | At Centre of Curvature ($C$) | At $C$ | Real and Inverted | **Same Size as Object** |
| **Concave** | Between $C$ and $F$ | Beyond $C$ | Real and Inverted | Magnified |
| **Concave** | At Focus ($F$) | At Infinity | Real and Inverted | Highly Magnified |
| **Concave** | Between Pole ($P$) and Focus ($F$) | Behind the Mirror | **Virtual and Erect** | **Magnified (Shaving / Dentist)** |
| **Convex** | Anywhere between $\infty$ and Pole ($P$) | Behind mirror (between $P$ & $F$) | **Virtual and Erect** | **Diminished (Rear-View Mirror)** |

---

### Table 2: Human Eye Defects, Optical Causes and Ophthalmic Corrections
| Eye Defect | Common Name | Nature of Vision Impairment | Optical Cause | Corrective Lens |
|---|---|---|---|---|
| **Myopia** | Near-sightedness | Close objects clear; distant objects blurred | Eyeball too long or cornea curvature too sharp; image forms **in front of retina** | **Concave (Diverging) Lens** (Negative power) |
| **Hypermetropia** | Far-sightedness | Distant objects clear; close objects blurred | Eyeball too short or lens curvature too flat; image forms **behind retina** | **Convex (Converging) Lens** (Positive power) |
| **Presbyopia** | Old-age vision | Inability to focus on near objects with aging | Loss of elasticity of crystalline lens and weakening of ciliary muscles | **Bifocal Lens** (Upper concave for distance, lower convex for reading) |
| **Astigmatism** | Astigmatism | Distorted or blurred vision in all directions | Cornea or lens has irregular curvature (aspherical) | **Cylindrical Lens** |
| **Cataract** | Cataract | Progressive clouding of vision | Opaque crystalline protein aggregation in natural lens | Surgical lens extraction & Intraocular Lens (IOL) implant |

---

### Table 3: Refractive Indices, Speed of Light & Critical Angles Matrix
| Medium | Absolute Refractive Index ($\mu$) | Speed of Light in Medium ($m/s$) | Critical Angle for Total Internal Reflection ($i_c$) |
|---|---|---|---|
| **Vacuum** | $1.0000$ (Standard) | $3.00 \times 10^8$ | — |
| **Air** | $1.0003$ | $\approx 3.00 \times 10^8$ | — |
| **Water** | $1.333$ ($4/3$) | $2.25 \times 10^8$ | $48.75^\circ$ |
| **Crown Glass** | $1.52$ | $1.97 \times 10^8$ | $41.14^\circ$ |
| **Flint Glass** | $1.66$ | $1.81 \times 10^8$ | $37.04^\circ$ |
| **Diamond** | **$2.42$** (Highest) | **$1.24 \times 10^8$** (Lowest) | **$24.41^\circ$** (Lowest) |

---

### Table 4: Master Colorimetry & Light Spectrum Matrix
| Color Band | Wavelength Range ($nm$) | Wavelength Range ($\text{\AA}$) | Deviation in Prism | Scattering Propensity | Energy per Photon ($eV$) |
|---|---|---|---|---|---|
| **Violet** | $380 - 450$ | $3800 - 4500$ | **Maximum** | **Maximum** ($I \propto 1/\lambda^4$) | High ($3.10 - 2.75\text{ eV}$) |
| **Indigo** | $450 - 485$ | $4500 - 4850$ | Very High | Very High | $2.75 - 2.56\text{ eV}$ |
| **Blue** | $485 - 500$ | $4850 - 5000$ | High | High (Gives sky blue color) | $2.56 - 2.48\text{ eV}$ |
| **Green** | $500 - 565$ | $5000 - 5650$ | Moderate | Moderate | $2.48 - 2.19\text{ eV}$ |
| **Yellow** | $565 - 590$ | $5650 - 5900$ | Moderate-Low | Moderate-Low | $2.19 - 2.10\text{ eV}$ |
| **Orange** | $590 - 625$ | $5900 - 6250$ | Low | Low | $2.10 - 1.98\text{ eV}$ |
