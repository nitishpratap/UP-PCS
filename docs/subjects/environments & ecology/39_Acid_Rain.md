...
- Acids form in the air, so acid rain is a **secondary pollution** problem.
- On the pH scale: **acidic < 7**, **neutral = 7**, **basic > 7**. Each step down is **10×** more H⁺.
...
**Ans: C** — All three dissolve (A treated true). R is true about air pollution but does **not** explain why **CO₂ gives only weak acid** while **SO₂/NOx drive strong acid rain**.
...
- **SO₂** from burning sulphur-rich **coal/oil** in thermal plants, refineries, smelters, brick kilns, and generators forms **H₂SO₄**.
- **NOx** from vehicles, power plants, and high-temperature combustion forms **HNO₃**.
...
| Soil | Nutrient leach + Al³⁺ |
| Forests | Conifer damage |
...
|------|------|
| FGD | SO₂ |
| Catalytic converter / BS-VI | NOx + fuel S |
| Fuel switch | Both |
...
|--------|-------|
| **Lines** | 571 |
| **Teaching blocks** | §39.1–39.4 (4 syllabus bullets) |
| **Practice Zone** | 30 questions |
| **PYQ Bank** | 10 questions |
| **Common Traps** | 10 |
| **Inline PYQs** | 2025 Q103, 2024 Q108, 2025 Q43 pattern |
...
| PYQ | Placement |
|-----|-----------|
| 2025 Q103 pH trap | §39.1 inline |
| 2024 Q108 A/R | §39.1 inline |
| 2025 Q43 SO₂ density | §39.2 note |
| 2025 Q61 lichens | §39.3 note |
