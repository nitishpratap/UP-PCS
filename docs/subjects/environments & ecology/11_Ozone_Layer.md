...
- **UV-C** is fully absorbed by ozone and oxygen under normal conditions.
- **Column ozone** is measured in **Dobson Units (DU)**. Global average is about **300 DU**.
...
| UVB | 280–320 nm | Sunburn, skin cancer, cataracts |
...
**Identity:** CFCs/ODS | Catalytic chlorine | Rowland–Molina 1974

- **Ozone depletion** is the sustained reduction of stratospheric ozone below natural levels.
- **Ozone-Depleting Substances (ODS)** contain chlorine and/or bromine that destroy ozone in the stratosphere.
- **CFCs** were used in refrigerants, aerosols, foam blowing, and solvents.
- CFCs are stable in the troposphere and take decades to reach the stratosphere.
- UV breaks CFC bonds and releases **chlorine atoms (Cl·)** that destroy ozone in a **catalytic cycle**.
- **One chlorine atom can destroy up to about 100,000 ozone molecules** before removal.
...
| ODS | Main use |
|-----|----------|
| CFCs | Refrigerants, aerosols, foam |
| Halons | Fire extinguishers |
| Carbon tetrachloride | Solvent |
| Methyl bromide | Pesticide/fumigant |
| HCFCs | Transitional refrigerants |

---

## 11.3 Ozone Hole

**Identity:** < 220 DU | Antarctic spring | PSCs | Not a physical hole
...
| Season | Sep–Oct (austral spring) | Mar–Apr if event occurs |
