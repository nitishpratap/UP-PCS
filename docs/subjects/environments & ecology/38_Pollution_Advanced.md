...
> **Exam weight:** ★★★ High — lichens; smog secondary; BOD; CGWB≠CPCB; Moradabad noise; fly ash  
...
> **Exam note:** Stubble smoke is a classic non-point seasonal source in north India.
...
> **Exam note:** Indicator ≠ thrives in dirty air.

---

## 38.3 Air Quality Index (AQI)

**Identity:** CPCB 0–500 | Health categories | Sub-indices

- India’s **AQI** (CPCB) runs from **0 to 500**.
...
> **Exam note:** Higher AQI = worse air.
...
> **Exam note:** NCAP = city clean-air programme, not a groundwater body.
...
- Exam wording often links smog to **oxides of nitrogen and sulphur**.
...
> **Exam note:** Smog = secondary. Fly ash = primary (and from thermal plants).

---

## 38.6 Photochemical Smog

**Identity:** NOx + VOC + sunlight → O₃ / PAN | LA type

- **Photochemical smog** forms when **NOx and VOCs** react in strong sunlight.
- It always involves **ozone** as a key secondary product; PAN and aldehydes also appear.
...
> **Exam note:** Photochemical smog ≠ classical London SO₂ fog.
...
- Control tools: ESPs, bag filters, FGD, stacks, and **CETPs** for clusters.
- UP exam geography: Kanpur tanneries (chromium/organics), Singrauli thermal belt, brick kilns.
...
> **Exam note:** Fly ash = thermal power primary pollutant; smog = secondary.
...
- Vehicles emit **CO, NOx, PM, VOCs**, and CO₂.
- India moved to **BS-VI** norms nationwide from **April 2020**.
...
> **Exam note:** BS-VI cut sulphur in fuel and tightened NOx/PM limits versus BS-IV.
...
> **Exam note:** Indoor air is a household health issue, not only an outdoor AQI story.
...
- Clean-ish river lock: **DO > ~6 mg/L**, **BOD < ~3 mg/L**.
- **Eutrophication:** excess **N and P** → algal bloom → DO crash → fish kill.
...
> **Exam note:** BOD = water organic pollution test, not blood oximetry.
...
- Groundwater contaminants include **arsenic, fluoride, nitrate, iron, salinity**, and industrial leachates.
- **Arsenic** contamination is classically associated with the **Bangladesh** / lower Gangetic basin story.
- **Fluoride** and **nitrate** affect many Indian districts (including UP pockets).
...
> **Exam note:** CGWB = groundwater. CPCB = pollution control board standards/monitoring.
...
> **Exam note:** Microbial and chemical risks are different drinking-water failure modes.
...
> **Exam note:** Drinking standard (IS 10500) ≠ ambient river class alone.
...
- Indo-Gangetic wheat–rice systems are high-input exam geography.

> **Exam note:** Fertiliser pollution is mostly nutrient overload, not heavy-metal tanning.
...
> **Exam note:** Silent Spring-era logic: persistent pesticides harm ecosystems.
...
- Key locks: **Pb** (batteries/paint), **Cd** (batteries/industry), **Cr** (tanneries — Kanpur), **Hg** (Minamata disease link).
...
| Pb | Neurotoxin; batteries |
| Cd | Kidney / bone risk |

> **Exam note:** Heavy metals ≠ biodegradable organics.

---

## 38.17 Sources of Noise Pollution

**Identity:** Traffic / industry / construction | Moradabad UNEP lock
...
> **Exam note:** Moradabad = noise PYQ city, not only brassware geography.
...
- CPCB ambient daytime limits (standard lock): **Silence 50**, **Residential 55**, **Commercial 65**, **Industrial 75** dB; night limits are lower.
...
> **Exam note:** Silence < Residential < Commercial < Industrial.
...
> **Exam note:** Coastal pollution is mostly land-origin, not only ship dumps.
...
- **MARPOL** is the key international ship-pollution convention.
...
> **Exam note:** Ocean pollution ≠ only mid-ocean dumping.
...
- **EPR** makes producers responsible for end-of-life plastic.
- India is among the world’s largest plastic-waste generators (~**3rd** in common exam framing).
...
**Q1.** Lichens grow well in polluted areas — True/False lock:
...
**Q13.** Residential daytime noise lock (CPCB):
...
**Q28.** Clean river DO lock (approx.):
...
**Q1. UPPCS 2025, Q61** — Lichens indicate pollution; do not grow well in polluted air → **Ans: D (Only 1)**

**Q2. UPPCS 2025, Q70** — Groundwater Quality Report = CGWB → **Ans: B**

**Q3. UPPCS 2023, Q103** — BOD = aquatic pollution assay → **Ans: A**

**Q4. UPPCS 2023, Q120** — Pesticide not biodegradable → **Ans: D**

**Q5. UPPCS 2022, Q46** — Photochemical smog contains ozone → **Ans: B**

**Q6. UPPCS 2022, Q81** — Moradabad 2nd noisiest → **Ans: B**

**Q7. UPPCS 2022, Q63** — Arsenic contamination = Bangladesh → **Ans: B**

**Q8. UPPCS 2022, Q115** — Noise zone matching → **Ans: C** (paper levels)

**Q9. UPPCS 2021, Q143** — Fly ash = thermal power → **Ans: C**

**Q10. UPPCS 2019, Q136 / 2018, Q121 / 2018, Q84** — Smog oxides; smog secondary; SAFAR Harsh Vardhan
...
| Arsenic only = India exclusive | Classic **Bangladesh** lock |
