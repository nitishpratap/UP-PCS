...
**Identity:** Natural/Anthropogenic | Terrestrial/Aquatic | Lentic/Lotic

| Basis | Categories |
|-------|------------|
| **Origin** | Natural vs **Anthropogenic** (human-modified) |
| **Medium** | **Terrestrial** (~29% Earth's surface) vs **Aquatic** (~71%) |
| **Water flow** (freshwater) | **Lentic** (standing) vs **Lotic** (flowing) |
...
- The **limnetic zone** is the open-water body of a lake or pond away from the shore.
- **Phytoplankton** grow abundantly in the limnetic zone because open water receives enough light for photosynthesis.
- The **profundal zone** lies below the lighted layer. Decomposers are important here because dead organic matter sinks down.

### Marine zones

- The **littoral (intertidal) zone** is the shore area alternately submerged and exposed by tides.
- The **neritic zone** covers the shallow continental shelf down to about 200 m. Fisheries and coral reefs are concentrated here.
- The **pelagic zone** is the open ocean water column away from the bottom.
...
## 2.4 Structure, Functions & Components

**Identity:** Biotic structure | Four ecosystem functions | Nutrient cycling
...
- **Climatic factors** include temperature, rainfall, sunlight, wind, and humidity.
- **Edaphic factors** relate to soil texture, minerals, pH, and moisture.
- **Topographic factors** include altitude, slope, and aspect of the land.
- **Aquatic abiotic factors** include salinity, dissolved oxygen, and water current.
- Abiotic factors decide which species can survive in a habitat. The scarcest limiting factor (Liebig) and tolerance range (Shelford) govern which organisms persist.

### Four functions of an ecosystem

| Function | What it means |
|----------|---------------|
| **Productivity** | Rate at which biomass or energy is produced |
...
**Ans: C** — More resources support **more** species, not fewer.

</details>

---

## 2.6 Ecological Principles
...
- **Primary succession** starts on bare lifeless substrate where no soil yet exists. Examples include cooled lava, bare rock, and new sand dunes.
- **Secondary succession** starts where soil and some organisms already remain after a disturbance. Examples include abandoned farmland, forest after fire, and flooded land once water recedes.
- **Pioneer species** are the first colonisers. Lichens on rock and moss on thin soil are classic terrestrial pioneers. Phytoplankton may pioneer a new pond.
...
## 2.10 Ecosystem Productivity

**Identity:** GPP | NPP | 1% sunlight rule | Standing crop

| Term | Meaning |
|------|---------|
| **GPP** (Gross Primary Productivity) | Total energy or biomass fixed by producers through photosynthesis |
| **R** | Energy lost by producers through respiration |
| **NPP** (Net Primary Productivity) | **GPP − R** = biomass actually available to consumers |
| **NSP** | NPP remaining after heterotroph consumption at producer level |
...
## 2.11 Ecological Efficiency

**Identity:** Lindeman 10% rule | Trophic levels | Energy loss as heat
...
**Ans: C** — Statement 1 = 1% capture by producers. Statement 2 = 10% transfer to next trophic level. Both true together.
...
## 2.12 Genetic, Species & Community Ecology

**Identity:** Three study levels below ecosystem | Population curves | Species interactions
...
- A **K-strategist** species produces few offspring and invests heavily in parental care. Elephants, whales, and tigers are examples.
