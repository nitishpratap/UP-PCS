...
**Identity:** Laughing gas | GWP ~265 | Fertilizer soils

- **N₂O** is a long-lived GHG with **GWP ≈ 265** (100-year) and lifetime ~**100+ years**.
- It contributes about **~6%** of anthropogenic GHG forcing.
- Main human source: **nitrogen fertilisers** in soils (nitrification/denitrification).
- Also from combustion, biomass burning, and some industry.
- Common name: **laughing gas** (medical anaesthetic use).
- Do not confuse with **NO/NO₂** (air pollutants) or **ammonia (NH₃)**.
- In Kyoto climate basket; **not** a classic Montreal ODS.

**PYQ — UPPCS Prelims 2023, Q105**
...
**Identity:** Most abundant natural GHG | Feedback, not primary driver
...
**Identity:** Tropospheric O₃ = GHG + pollutant | Stratospheric O₃ = UV shield
...
**Ans: A** — CO₂, CH₄, and O₃ are treated as natural GHGs here.
...
**Identity:** Synthetic GHG + ODS | Very high GWP | Montreal phase-out
...
**Identity:** CFC substitutes | GHG only | Kigali 2016
