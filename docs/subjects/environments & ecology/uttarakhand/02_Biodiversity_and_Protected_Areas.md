...
| Pair | Lock |
|------|------|
| Askot vs Binsar | Pithoragarh vs Almora |
| Govind 1989 vs 1990 | **1990** keyed; Gangotri keeps **1989** |
...
## 2.2 Flagship reserves and parks
...
- **Corbett (1936)** anchors Tarai tiger conservation history.
- **Rajaji (1983)** covers Shiwalik–dun elephant corridors.
...
Match sanctuaries with districts:
...
3. **R does not explain forest richness** → keyed that it does.
