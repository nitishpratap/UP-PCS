...
> **Weight:** ★★★ High — BR ↔ state; Nokrek ≠ Manipur; UP = zero BR
...
**Geography fact:** Nanda Devi BR is in **Uttarakhand**. UP itself has **zero** BRs.
...
- Famous icons: **Yellowstone (USA)**, **Serengeti–Ngorongoro (Tanzania)**, **Galápagos (Ecuador)**, **Lake Baikal (Russia)**, **Doñana (Spain)**, **Mount Kenya (Kenya)**.
