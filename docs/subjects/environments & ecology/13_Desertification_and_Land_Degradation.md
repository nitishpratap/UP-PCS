...
Desertification | Land Degradation | Soil Erosion
...
India aims to achieve land degradation neutrality by:
...
| Drought | Rainfall deficit event |
...
**Identity:** Productive capacity decline | Erosion + salinity + mining | Wasteland end-stage
...
- Continued degradation creates **wasteland** — land unsuitable for cultivation. All wasteland is degraded, but not all degraded land is yet wasteland.
- Consequences include **food insecurity**, **rural poverty**, **migration** (Bundelkhand to cities), **reservoir silting**, and **higher flood risk** on silted riverbeds.
- **Salinization and waterlogging** can often be reversed through drainage, gypsum, and drip irrigation. **Deep ravines** are hardest to restore.
...
|---------|----------------|
| Salinization | Punjab-Haryana canal belt |
| Mining degradation | Sonbhadra, Jharkhand |
| Waterlogging | Over-irrigated plains |
| Ravine formation | Chambal basin |

---

![Soil Erosion 4-Stage Water Progression & Wind Transport Dynamics](images/env_ch13_01_soil_erosion_water_wind_dynamics.png)
...
**Ans: D** — Statement 1 only. Earthworms have **5 pairs** of hearts, not 2.
