...
**Ans: B** — World Wildlife Day = **3 March**.

</details>

**PYQ — UPPCS Prelims 2025, Q143**
...
**Ans: D** — Nesting is **Nov–Feb**, not August.
...
- **Animal Welfare Board of India** was established in **1962** under the **Prevention of Cruelty to Animals Act, 1960** — not under EPA 1986.
...
> **Logic:** WPA = **1972**. Project Tiger = **1973**. Do not swap the two years. Schedule VI ≠ absolute cultivation ban.
...
**Identity:** CSS 1992 | 33 ERs | 150 corridors | No WPA statutory basis

- **Project Elephant** was launched in **1992** as a Centrally Sponsored Scheme.
- It aims to protect elephants, restore corridors, and reduce **human–elephant conflict**.
- It covers welfare of **wild Asian elephants and captive elephants** — “wild only” is a false stem.
- **Elephant Reserves** are notified by state governments on MoEFCC recommendation.
- India has **33 Elephant Reserves** across **14 states**.
- About **150 elephant corridors** have been identified for genetic exchange between herds.
- Elephant Reserves have **no separate statutory category under WPA 1972**.
- Legal protection inside an ER comes from overlapping sanctuaries, national parks, and forest laws.
- India's elephant population is estimated at about **30,000** (2020 census trend).
...
- To see gharials in a natural habitat, **Chambal River / National Chambal Sanctuary** is the standard answer among common options.
- The **mugger** is the most widespread Indian crocodilian and occurs in rivers, lakes, and tanks.
- The **saltwater crocodile** is the largest reptile and lives in coastal mangroves, notably at **Bhitar Kanika** (Odisha).
- The gharial is **Critically Endangered** on the IUCN Red List.
- **National Chambal Sanctuary** (UP–MP–Rajasthan) is India's main gharial stronghold.
- **Katarniaghat Wildlife Sanctuary** in Bahraich, UP, protects gharial on the Girwa river.
- **Whale shark** is India’s (and among the world’s) largest fish; seasonal aggregations off the **Gujarat** coast (about March–May); a dedicated protection programme began around **2004**.
- **Kharai camel** of Kutch can swim several kilometres in seawater and graze mangroves; it can be domesticated (statement “lives only wild / cannot be domesticated” is false).
- **Pugmark** technique estimates wild animal numbers from species-specific footprints.
- **Spider monkeys** occur in Central and South American tropical forests — they are **not** naturally found in India.
...
**Identity:** Gir, Gujarat only | Project Lion 2020 | Kuno second home planned

- The **Asiatic lion** (*Panthera leo persica*) survives in the wild only in the **Gir landscape of Gujarat**.
- India's wild Asiatic lion population is about **750+** (2025 trend).
- Historically lions ranged from Greece to Bihar. Hunting reduced them to Gir by the early 20th century.
- **Gir Conservation Programme** focused on habitat, prey base, and disease control after a **canine distemper** outbreak in 2018.
- **Project Lion** was launched in **August 2020** to strengthen Gir management and create a second population.
- **Kuno-Palpur Wildlife Sanctuary** in Madhya Pradesh is the planned second home for translocated lions.
...
- Poaching for horn remains the main threat despite strict anti-poaching in Kaziranga.
- **Indian Rhino Vision 2020 (IRV 2020)** aimed to spread rhinos across **7 protected areas**.
- Target sites include Kaziranga, Pobitora, Orang, and Manas in Assam, Jaldapara and Gorumara in West Bengal, and **Dudhwa** in UP.
- **Dudhwa National Park** in Lakhimpur Kheri received **reintroduced rhinos** under IRV 2020.
...
**Identity:** Diclofenac crisis | Vet ban 2006 | Action Plan 2006 | Pinjore breeding
...
**Wildlife conservation in India (250 words):** Define conservation vs protection. WPA 1972 framework and schedules. Flagship/umbrella/keystone species logic. Major programmes with years (Tiger 1973, Elephant 1992, Crocodile 1975, Snow Leopard 2009, Lion 2020, Vulture 2006). Statutory vs executive distinction (TR vs ER). Threats and community role. UP examples — Dudhwa tiger/rhino, Terai elephant, Katarniaghat gharial. Conclude with NTCA and species-programme layering over PA network.
...
| Metric | Value |
|--------|-------|
| **Lines** | ~720 (was ~1580 old format) |
| **Teaching blocks** | §7.1–7.9 (9 syllabus bullets) |
| **Practice Zone** | 30 questions |
| **PYQ Bank** | 7 questions (2018–2025) |
| **Common Traps** | 9 |
| **Inline PYQs** | 2025 Q62, Q143; 2018 Q131 in §7.9 |

### Syllabus coverage map

| Syllabus bullet | Section |
|-----------------|---------|
| Wildlife Conservation | §7.1 |
| Wildlife Protection | §7.2 |
| Project Tiger | §7.3 |
| Project Elephant | §7.4 |
| Crocodile Conservation Project | §7.5 |
| Asiatic Lion Conservation | §7.6 |
| Rhino Conservation | §7.7 |
| Snow Leopard Conservation | §7.8 |
| Vulture Conservation | §7.9 |

### Topic boundaries

- **Tiger Reserve legal rules** — brief here; PA comparison home is Topic 6
- **In-situ / ex-situ detail** — one line in §7.1; full home Topic 4 / Topic 20
- **CITES / CMS treaties** — Topic 18; only World Wildlife Day date cited here

### PYQ audit

| PYQ | Placement |
|-----|-----------|
| 2025 Q62 WWD date | §7.1 inline |
| 2025 Q143 Operation Olivia | §7.1 inline |
| 2018 Q131 diclofenac | §7.9 inline |
| 2018 Q46 Project Tiger | PYQ Bank Q3 |
| 2019 Q67 chronology | Practice Q16 + PYQ Bank Q5 |
| 2023 Q90 cheetah | PYQ Bank Q6 (related reintroduction context) |
