...
> **Exam weight:** ★★★ High — ozone = stratosphere; heating by longwave; N₂ ≠ GHG  
...
- By composition: **homosphere** (well mixed to ~**80 km**) and **heterosphere** (gases separate by mass above that).
...
> **Exam note:** “Atmosphere heated mainly by direct shortwave” is **false**.

---

## 35.2 Atmospheric Composition

**Identity:** N₂ 78% | O₂ 21% | Ar ~1% | CO₂ ~0.04% | Variable gases
...
- **Argon is not a GHG** (also locked in Topic 34 GHG questions).
...
> **Exam note:** Composition % ≠ greenhouse importance (CO₂ is tiny but powerful).
...
> **Exam note:** Learn **feature ↔ layer** matching, not only names.
...
> **Exam note:** Weather = troposphere only. Ozone shield ≠ troposphere.
...
- The **ozone layer (ozonosphere)** of maximum concentration sits mainly around **15–35 km** in the stratosphere.
- Stratospheric ozone protects life from harmful **UV-B/C**; tropospheric ozone is a pollutant.
...
> **Exam note:** Ozone max = **stratosphere**. Pair “ozone–troposphere” is always wrong.
...
> **Exam note:** Meteors = mesosphere; ozone ≠ mesosphere.
...
> **Exam note:** Hot ≠ dense. Thermosphere heat is not like tropospheric heat you feel.
...
**Q1. UPPCS 2023, Q52** — Ozone layer = Stratosphere → **Ans: C**

**Q2. UPPCS 2022, Q138** — Atmosphere heated by long-wave terrestrial radiation → **Ans: A**

**Q3. UPPCS 2018, Q52** — Max ozone = Stratosphere → **Ans: C**

**Q4. UPPCS 2018, Q57** — Ozone layer–Troposphere NOT matched

**Q5. UPPCS 2025, Q45** — Ozone protects from UV; depletion linked to CFCs → both correct

**Q6. UPPCS 2021, Q134** — Light diffusion due to dust particles → **Ans: B**

**Q7. UPPCS 2020, Q139** — Nitrogen oxide NOT the listed natural GHG → **Ans: A**

**Q8. Pattern** — Weather = troposphere only
