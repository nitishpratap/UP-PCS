...
- **Climate change** is a long-term change in the climate system — temperature, precipitation, extremes, sea level — lasting decades or longer.
- UNFCCC stresses human-driven change that alters atmospheric composition, beyond natural variability.
...
## 34.3 Global Climate Monitoring

**Identity:** WMO / NOAA / NASA | UNEP Emissions Gap | Global Carbon Project

- **WMO** publishes the **State of the Global Climate** report.
- **NOAA** and **NASA GISS** maintain key global temperature datasets.
- **Global Carbon Project** issues the annual **Global Carbon Budget**.
- **Emissions Gap Report** is published by **UNEP** — it measures the gap between NDCs and 1.5–2°C pathways.
...
**Ans: A** — HDR=UNDP; WEO=IMF; WIR=UNCTAD; Emissions Gap=**UNEP**.
...
**Identity:** CO₂-led basket | Absolute vs per capita | India rank traps
...
**Ans: B** — Paper answer **10th**. Absolute total emitter rank is commonly ~**3rd** — do not mix the two frames.
...
**Identity:** Surface temperature rise | AR6 ~1.1°C | Impacts subset
...
**Identity:** Cumulative CO₂ cap | 1.5°C / 2°C pathways | Net zero link

- A **carbon budget** is the cumulative CO₂ that can still be emitted while limiting warming to a chosen target.
- Smaller remaining budgets for **1.5°C** than for **2°C**.
...
**Identity:** Forests / oceans / soils | Net absorption | Blue carbon

- A **carbon sink** absorbs more CO₂ than it releases over a period.
- Major sinks: **forests**, **oceans**, **soils**, and **mangroves/blue carbon**.
...
## 34.12 Carbon Trading

**Identity:** Market for credits/allowances | Kyoto CDM | India CCTS 2023

- **Carbon trading** is buying and selling emission allowances or carbon credits.
- **Cap-and-trade** sets an emissions cap and lets the market discover the price.
- Kyoto enabled international trading via **CDM, JI, and Emissions Trading**.
...
## 34.13 Climate Change Mitigation
...
## 34.14 Climate Change Adaptation

**Identity:** Adjust to impacts | NAPCC missions | Disaster/heat plans
...
## 34.15 Climate Change Policy of India
...
## 34.16 IPCC Assessment Reports

**Identity:** Science assessment | AR1→AR6 | Not a treaty body

- **IPCC** (WMO + UNEP parents) assesses climate science; it does **not** negotiate treaties or set emission targets.
- Three Working Groups: **I** physical science, **II** impacts/adaptation, **III** mitigation; plus a **Synthesis Report**.
- Cycle: **AR1 (1990) → AR2 (1995) → AR3 (2001) → AR4 (2007) → AR5 (2014) → AR6 (2021–23)**.
- **AR6 Synthesis Report (March 2023)** consolidates ~**1.1°C** warming and urgency of action.
...
**Q10. Pattern** — India net zero 2070 / NAPCC 2008
