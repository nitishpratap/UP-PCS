...
![Global Climate and Environmental Governance: Apex Bodies and Multilateral Finance](images/env_ch19_01_global_climate_environmental_governance_architecture.png)
...
Emissions Gap Report → Options include UNEP (2), UNDP (3)

<details><summary>Show answer</summary>

**Ans: UNEP (2)** — Full match: HDR→UNDP(3), WEO→IMF(1), WIR→UNCTAD(4), Emissions Gap→UNEP(2) = **A (3 1 4 2)**.
...
**Ans: D (Only 1)** — GEF **1991** true; donors not **only** developed countries.
...
**Identity:** New York | HDR 1990 | HDI | Mahbub ul Haq + Amartya Sen

- **UNDP** is the UN's global **development** network working on poverty, governance, and SDG implementation.
- **Headquarters** is in **New York**.
- The first **Human Development Report (HDR)** was published in **1990** and introduced the **Human Development Index (HDI)**.
- **HDI** combines **life expectancy**, **education**, and **GNI per capita (PPP)**.
- HDI was developed by **Mahbub ul Haq** and **Amartya Sen** — **not** S. Priesner.
- UNDP supports **SDG localisation** and climate/biodiversity projects but is **not** the Emissions Gap publisher.
...
**Ans: D (Only 1)** — Statement 2 false; Sen not Priesner.
...
**Identity:** 1948 Gland | Red List | Threatened = VU+EN+CR | Not CITES

- **IUCN** is a global conservation union of states and NGOs, founded in **1948**.
...
**Identity:** NGO Gland | Living Planet Report | Panda logo | LPI
...
**Identity:** Rome HQ | SOFO | Rotterdam with UNEP | ag-environment link

- **FAO (Food and Agriculture Organization)** is a UN specialised agency for **food and agriculture**.
