...
- **IWRM** coordinates water, land, and related resources within a **river basin** to balance economy, society, and ecosystems.
- **Dublin Principles (1992):** freshwater is finite; participatory management; women central; water has **economic value**.
- **National Water Policy 2012:** river basin as planning unit; allocation priority **drinking water > ecology > agriculture > industry**.
- **Ecological flows (e-flows):** minimum release below dams for river ecology.
...
**Identity:** Capture + store/recharge | Tamil Nadu 2003 mandate | Dual flood + aquifer benefit

- **Rainwater harvesting** collects rooftop or surface runoff for **direct use** or **aquifer recharge** before it drains away.
- **Rooftop:** roof → filter → tank (or recharge pit).
- **Surface:** check dams, percolation tanks, farm ponds, contour trenches.
- **Traditional:** Rajasthan **johad** (community pond) and **taanka** (cistern).
- **Benefits:** reduces urban flood peaks, recharges groundwater, supplements municipal supply.
- **Tamil Nadu (2003)** first made RWH **mandatory** in new buildings — Chennai model widely cited.
- First-flush diversion improves stored water quality; RWH supplements, does not replace, bulk supply.
...
![Ridge-to-Valley Watershed Architecture & Traditional Rainwater Harvesting Geography](images/env_ch26_02_watershed_management_traditional_rainwater.png)
...
**Identity:** CGWB | Atal Bhujal 2019 | Over-extraction belt | Arsenic & fluoride
