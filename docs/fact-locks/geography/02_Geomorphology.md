...
## 1. Geomorphology — Basic Framework

**Geomorphology** = study of landforms + processes that form/modify them.
...
Individual rocks detach and fall on **steep cliffs / mountainous terrain**
...
## 18. Vertical vs Lateral Erosion

| Type | Course | Produces |
| --- | --- | --- |
...
Sharp knife-edge ridge between **two glacial cirques**
...
Rock shaped/polished by wind-driven sand abrasion
...
Stalactite + stalagmite join → column/pillar
...
**Wave erosion + transportation + deposition**
...
Arch roof collapses → stack remains
...
Shallow water separated from open sea by barrier/spit/sandbar

## 84. Tombolo

Sand/gravel bar connecting island to mainland or another island
...
## 87. Underground Features

| Feature | Agent/process |
| --- | --- |
...
## 88. Process → Landform Master Table
...
## 89. Agent → Signature Landform

| Agent | Signature chain |
| --- | --- |
