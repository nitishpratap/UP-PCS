...
> **Covers syllabus:** Indian Temple Architecture | Nagara Style | Dravida Style | Vesara Style | Temple Architecture | Gupta Period Temples | Pallava and Chola Temples | Buddhist Architecture | Stupa | Chaitya | Vihara | Rock-cut Architecture | Cave Architecture | Indo-Islamic Architecture | Mughal Architecture | Ancient Indian Architecture | Medieval Indian Architecture | Taj Mahal | Qutub Minar | Konark Sun Temple | Khajuraho Group of Monuments | Brihadeeswara Temple | Sanchi Stupa | Mahabalipuram | Ajanta & Ellora | Elephanta Caves  
> **Sources baked in:** NCERT An Introduction to Indian Art (Class 11), Themes in Indian History I–III, ASI/UNESCO publications, UPPCS/UPSC PYQs  
> **Exam weight:** ★★★ Very High — style matching, monument ↔ dynasty ↔ location, A/R on Mughal buildings  
...
```
TEMPLE STYLES (North → South → Hybrid):
  Nagara = curvilinear shikhara, NO gopuram, North India (Khajuraho, Odisha Konark)
  Dravida = pyramidal vimana + tall gopuram, South (Brihadeeswara, Mahabalipuram)
  Vesara = hybrid shikhara-vimana, Karnataka/Chalukya/Hoysala (Belur, Halebidu)

TEMPLE PARTS:
  Garbhagriha (womb) → Antarala (vestibule) → Mandapa (hall) → Shikhara/Vimana (tower)
  Pradakshina patha = circumambulatory passage | Gopuram = gateway tower (Dravida)

BUDDHIST TRIO:
  Stupa = relic mound (Sanchi, Bharhut) | Chaitya = prayer hall + apse stupa (Karla, Ajanta 26)
  Vihara = monastery cells (Ajanta, Nalanda tradition)

ROCK-CUT / CAVES:
  Ajanta (Mahayana paintings + chaitya 19,26) | Ellora (Buddhist 1-12, Hindu 13-29, Jain 30-34)
  Elephanta (Trimurti Shiva) | Mahabalipuram (Pallava rathas + Shore Temple)

PERIOD TRAP:
  Gupta = structural temple begins (Dashavatara Deogarh, Udayagiri)
  Pallava = rock-cut Mahabalipuram | Chola = structural Brihadeeswara (1010 CE, Thanjavur)

INDO-ISLAMIC vs MUGHAL:
  Indo-Islamic = arch, dome, minaret, jali (Qutub Minar, Quwwat-ul-Islam)
  Mughal = garden tomb, red sandstone + marble, charbagh (Humayun, Taj, Fatehpur Sikri)

UPPCS 2025 TRAPS:
  Buland Darwaza = Akbar, Fatehpur Sikri — for Gujarat victory (NOT Jahangir birth) → Ans C
  Mughal tombs: Babur-Kabul | Humayun-Delhi | Jahangir-Lahore | Shah Jahan-Agra → Ans A (4-3-2-1)

UP MONUMENTS:
  Taj Mahal (Agra) | Fatehpur Sikri + Buland Darwaza (Agra dist.) | Sarnath Dhamek Stupa
  Qutub Minar (Delhi, NOT UP) | Khajuraho (MP, NOT UP) — negative traps
```
...
|------|---------------------|-------|
| **Nagara vs Dravida** | Curvilinear **shikhara**, north, no gopuram vs pyramidal **vimana** + tall **gopuram**, south | नागर / द्रविड़ |
| **Shikhara vs Vimana** | Nagara tower over garbhagriha vs Dravida tower over sanctum | शिखर / विमान |
| **Vesara vs Nagara** | Karnataka hybrid with staggered/storeyed tower vs pure north Indian curvilinear form | वेसर / नागर |
| **Stupa vs Chaitya** | Solid relic mound for circumambulation vs rock-cut hall with apse stupa for congregation | स्तूप / चैत्य |
| **Chaitya vs Vihara** | Worship/prayer hall vs monastic residential cells around courtyard | चैत्य / विहार |
| **Rock-cut vs Structural** | Carved from living rock (Ajanta, Ellora) vs built with dressed stone blocks (Brihadeeswara) | शैल-kट / संरचनात्मक |
| **Latina vs Rekha Nagara** | Simple curvilinear tower vs Odisha-style vertical tower with amalaka | लतिन / रेखा |
| **Indo-Islamic vs Mughal** | Sultanate/provincial Indo-Muslim (Qutub) vs imperial Mughal synthesis (Taj, Fatehpur Sikri) | भारतीय-इस्लामी / मुग़ल |
| **Charbagh vs Panchayatana** | Islamic four-part garden (Taj, Humayun) vs Hindu five-shrine temple plan (Deogarh type) | चारबाग़ / पंचायतन |
| **Gopuram vs Shikhara** | Monumental Dravida gateway tower vs Nagara sanctum tower — exams swap these | गोपुरम् / शिखर |

### Memory Tricks

| Trick | Remembers |
|-------|-----------|
| **N-D-V = North to South** | Nagara (north) → Dravida (south) → Vesara (Deccan/Karnataka) |
| **S-C-V Buddhist trio** | Stupa (mound) → Chaitya (hall) → Vihara (monastery) |
| **A-E-E cave belt** | Ajanta (Buddhist art) → Ellora (3 religions) → Elephanta (Shiva) |
| **4-3-2-1 Mughal tombs** | Babur **4** Kabul → Humayun **3** Delhi → Jahangir **2** Lahore → Shah Jahan **1** Agra |
| **Buland = Victory not Birth** | Buland Darwaza = Gujarat campaign victory; Jahangir birth = wrong reason |
| **1010 Chola** | Rajaraja I → Brihadeeswara Temple, Thanjavur, **1010 CE** |
| **72.5 m Qutub** | Qutub Minar height ~72.5 m; Qutb-ud-din Aibak started; Iltutmish completed |
| **Konark = Odisha chariot** | Sun Temple = massive stone ratha; Narasimhadeva I; UNESCO 1984 |
| **Khajuraho = Chandela** | MP (not UP); Nagara; erotic + divine sculpture on shikhara temples |
| **Sanchi = Ashoka** | Great Stupa enlarged by Ashoka; toranas 1st c. BCE; NOT Buddha relic inside originally |
...
| Source | Definition |
|--------|------------|
| **General** | **Hindu temple architecture** = sacred built space organising worship of deity through **garbhagriha**, axial plan, sculptural programme, and cosmological symbolism |
| **NCERT / Standard** | Indian temples classified primarily by **regional style** — **Nagara** (north), **Dravida** (south), **Vesara** (Deccan hybrid) — sharing common ritual parts but differing in elevation and layout |
| **Exam usage** | Style ↔ region ↔ dynasty ↔ example temple; trap: calling Konark "Dravida" or Brihadeeswara "Nagara" |
...
1. **(UPSC Prelims 2020 — pattern)** With reference to Indian temple styles, consider:

   1. Nagara temples are characterised by curvilinear shikharas.  
   2. Dravida temples have prominent gopurams.

   → **Both correct.** Nagara = north + shikhara; Dravida = south + gopuram gateway.

2. **(UPSC Prelims 2016 — pattern)** Which style is Brihadeeswara Temple?

   A. Nagara  B. Dravida  C. Vesara  D. Indo-Islamic  
   → **B — Dravida** (Chola, Thanjavur).

### Examples (3.1)

| Example | What it teaches |
|---------|-----------------|
| **Khajuraho, MP** | Nagara group temples — Chandela, sandstone shikhara cluster |
| **Brihadeeswara, Thanjavur** | Dravida vimana — granite, Chola scale |
| **Belur Chennakeshava, Karnataka** | Vesara/Hoysala — intricate star-shaped plan, soapstone |
...
| Term | Meaning |
|------|---------|
| **Nagara** | North Indian temple style with **curvilinear or straight-edged shikhara** rising over garbhagriha; generally **no large gopuram** |
| **Shikhara** | Tower over sanctum in Nagara temples — latina (simple curve), rekha (Odisha vertical), phamsana (pyramidal stepped), valabhi (rectangular barrel-roof) |
| **Ratha** | Vertical offset projection on Odisha rekha deul walls — adds sculptural surface |
...
- Nagara = north India + **shikhara** (not gopuram-dominant)
...
1. **(UPSC Prelims 2019 — pattern)** Konark Sun Temple is an example of:

   A. Dravida  B. Nagara  C. Vesara  D. Gopuram style  
   → **B — Nagara** (Odisha rekha deul tradition).

2. **(UPSC Prelims 2014 — pattern)** Khajuraho temples were built by:

   A. Cholas  B. Chalukyas  C. Chandela  D. Pallavas  
   → **C — Chandela** dynasty; Nagara style.

### Examples (3.2)

| Example | Detail |
|---------|--------|
| **Kandariya Mahadeva, Khajuraho** | Tallest Chandela Nagara temple; ~900 sculptures |
| **Konark Sun Temple, Odisha** | Stone ratha with 24 wheels; UNESCO 1984 |
| **Lingaraj Temple, Bhubaneswar** | Rekha deul Nagara; active Shaiva centre |
...
| Term | Meaning |
|------|---------|
| **Dravida** | South Indian temple style with **pyramidal vimana** over garbhagriha and towering **gopurams** marking enclosure gateways |
| **Vimana** | Sanctum tower in Dravida architecture — stepped/pyramidal profile (distinct from Nagara shikhara curve) |
| **Gopuram** | Rectangular gateway tower, often taller than vimana in later periods; profusely sculpted |
...
- Dravida = **vimana + gopuram + concentric prakaras**
...
1. **(UPSC Prelims 2021 — pattern)** Brihadeeswara Temple was built by:

   A. Rajaraja I  B. Rajendra I  C. Krishnadevaraya  D. Narasimhadeva I  
   → **A — Rajaraja I**, Chola, **1010 CE**. Narasimhadeva = Konark (Nagara).

2. **(UPSC Prelims 2018 — pattern)** Shore Temple is located at:

   A. Kanchipuram  B. Mahabalipuram  C. Thanjavur  D. Madurai  
   → **B — Mahabalipuram** (Mamallapuram), Pallava Dravida.

### Examples (3.3)

| Example | Detail |
|---------|--------|
| **Brihadeeswara, Thanjavur** | Chola Dravida vimana; UNESCO 1987; 1010 CE |
| **Meenakshi Temple, Madurai** | Nayaka gopurams — colourful, towering |
| **Shore Temple, Mahabalipuram** | Pallava structural Dravida on coast |
...
| Term | Meaning |
|------|---------|
| **Vesara** | Hybrid temple style blending **Nagara shikhara** elements with **Dravida vimana** features; prevalent in **Deccan/Karnataka** |
| **Hoysala style** | Sub-tradition of Vesara — **star-shaped (stellate) plan**, intricate soapstone carving, multiple shrines on raised platform |
| **Chalukya style** | Early Vesara experimentation — Badami, Aihole, Pattadakal (UNESCO) |
...
- Often tested as "third style" besides Nagara and Dravida

### PYQs — Vesara Style

1. **(UPSC Prelims 2017 — pattern)** Hoysala temples are known for:

   A. Curvilinear shikhara in sandstone  B. Star-shaped plan in soapstone  C. Gopuram taller than vimana  D. Rock-cut chaitya halls  
   → **B — star-shaped plan, soapstone** (Vesara/Hoysala).

2. **(UPSC Prelims 2015 — pattern)** Pattadakal group of monuments is in:

   A. Tamil Nadu  B. Karnataka  C. Odisha  D. Madhya Pradesh  
   → **B — Karnataka**; Chalukya Vesara UNESCO site.

### Examples (3.4)

| Example | Detail |
|---------|--------|
| **Chennakeshava Temple, Belur** | Hoysala Vesara; commissioned 1117 by Vishnuvardhana |
| **Pattadakal temple complex** | Chalukya Vesara; UNESCO 1987 |
| **Hoysaleshwara Temple, Halebidu** | Twin shrines; intricate friezes |

---

## 3.5 Temple Architecture — Plans, Components & Ritual Layout

### Definitions

| Term | Meaning |
|------|---------|
| **Vastupurusha mandala** | Grid-based planning diagram for temple layout — cosmic man (purusha) on ground plan |
| **Ardhamandapa** | Half-hall / porch preceding main mandapa |
| **Grabhagriha orientation** | Sanctum usually faces east (dawn/sun association) — exceptions exist (west-facing Vishnu temples) |
...
- Natya-mandapa = dance hall (Chola temples)
- Dvarapalas guard sanctum doorway
- Temple tank = ritual + practical water source

### PYQs — Temple Architecture

1. **(UPSC Prelims 2020 — pattern)** Panchayatana style of temple architecture refers to:

   A. Four gateways  B. Five shrine plan  C. Seven-storey tower  D. Circular plan  
   → **B — five shrines** (one central + four corners).

2. **(UPSC Prelims 2013 — pattern)** Pradakshina in temple means:

   A. Offering flowers  B. Circumambulation  C. Prostration  D. Fasting  
   → **B — circumambulation** (clockwise around deity/sanctum).

### Examples (3.5)

| Example | Detail |
|---------|--------|
| **Dashavatara Temple, Deogarh** | Gupta panchayatana — raised platform, Vishnu |
| **Meenakshi Temple, Madurai** | Multiple prakaras + pradakshina paths |
| **Jagannath Puri** | Nagara plan with annual ratha festival axis |

---

## 3.6 Gupta Period Temples

### Definitions

| Term | Meaning |
|------|---------|
| **Gupta temple** | Early **structural** (free-standing stone) Hindu temple tradition emerging **4th–6th c. CE** — transition from rock-cut to built shrines |
| **Flat-roofed square cella** | Earliest Gupta shrines — simple square sanctum with shallow roof before tall shikhara evolution |
...
- Sandstone primary material
- Bridge between rock-cut tradition and mature Nagara
- Bhumara Shiva Temple = early shikhara experiment MP
- Post-Gupta Nagara evolves from Gupta cella + roof forms
- Deogarh on jagati raised platform

### PYQs — Gupta Period Temples

1. **(UPSC Prelims 2019 — pattern)** Dashavatara Temple is located at:

   A. Deogarh  B. Khajuraho  C. Aihole  D. Bhubaneswar  
   → **A — Deogarh** (UP), Gupta period.

2. **(UPSC Prelims 2016 — pattern)** Which period marks the beginning of structural temple building in India?

   A. Maurya  B. Gupta  C. Kushana  D. Chola  
   → **B — Gupta period** — first free-standing stone shrines.

### Examples (3.6)

| Example | Detail |
|---------|--------|
| **Dashavatara Temple, Deogarh, UP** | Gupta panchayatana Vishnu — UPPCS geography favourite |
| **Udayagiri Cave 5, MP** | Giant Varaha sculpture — Gupta patronage |
| **Temple 17, Sanchi** | Earliest structural shrine near Great Stupa |

---

## 3.7 Pallava and Chola Temples

### Definitions

| Term | Meaning |
|------|---------|
| **Pallava architecture** | 7th–9th c. south Indian tradition — pioneering **rock-cut rathas** and early **structural Dravida** at Mahabalipuram and Kanchipuram |
| **Chola architecture** | 9th–13th c. imperial Dravida — massive **granite vimanas**, elaborate mandapas, temple as royal legitimacy symbol |
...
- Pallava: Mahabalipuram rathas + Shore Temple + Kanchi Kailasanatha
- Pancha Rathas = monolithic rock-cut, named Draupadi/Arjuna/Bhima/Dharmaraja/Nakula-Sahadeva
- Shore Temple = structural Dravida, 8th c., coast
- Chola: Brihadeeswara Thanjavur **1010 CE**, Rajaraja I
...
1. **(UPSC Prelims 2021 — pattern)** Which Chola ruler built Brihadeeswara Temple at Thanjavur?

   A. Rajaraja I  B. Rajendra I  C. Parantaka I  D. Kulottunga I  
   → **A — Rajaraja I, 1010 CE.**

2. **(UPSC Prelims 2017 — pattern)** Pancha Rathas at Mahabalipuram are:

   A. Structural granite temples  B. Monolithic rock-cut temples  C. Buddhist viharas  D. Jain basadis  
   → **B — monolithic rock-cut** rathas, Pallava.

### Examples (3.7)

| Example | Detail |
|---------|--------|
| **Shore Temple, Mahabalipuram** | Pallava structural Dravida on Bay of Bengal |
| **Brihadeeswara, Thanjavur** | Chola imperial vimana — 1010 CE |
| **Gangaikondacholapuram** | Rajendra I — Chola capital temple |

---

## 3.8 Buddhist Architecture

### Definitions

| Source | Definition |
|--------|------------|
| **General** | **Buddhist architecture** = built forms supporting **stupa worship**, **sangha residence**, and **congregational ritual** — distinct from Hindu temple cosmology |
| **NCERT** | Three key forms: **Stupa** (relic mound), **Chaitya** (prayer hall), **Vihara** (monastery) — evolved from pre-Buddhist burial mounds |
| **Exam usage** | Match form ↔ function ↔ site; trap: calling chaitya a "temple" in Hindu sense |
...
### PYQs — Buddhist Architecture

1. **(UPSC Prelims 2020 — pattern)** Which Buddhist architectural form is used for monastic residence?

   A. Stupa  B. Chaitya  C. Vihara  D. Torana  
   → **C — Vihara** = monastery cells.

2. **(UPSC Prelims 2014 — pattern)** Sanchi Stupa is famous for:

   A. Rock-cut chaitya  B. Toranas  C. Gopuram  D. Minaret  
   → **B — Toranas** (gateways); Sanchi is structural brick stupa, not rock-cut.

### Examples (3.8)

| Example | Detail |
|---------|--------|
| **Sanchi, MP** | Ashokan stupa + toranas — UNESCO 1989 |
| **Karla Chaitya, Maharashtra** | Largest rock-cut chaitya hall |
| **Ajanta vihara caves** | Monastic cells with paintings |
...
| Term | Meaning |
|------|---------|
| **Stupa** | Buddhist **relic mound** — hemispherical solid structure for circumambulation and merit accumulation |
| **Anda** | Hemispherical dome/body of stupa |
| **Harmika** | Railing/enclosure at dome top — supports chhatra |
| **Chhatra** | Umbrella-like finial tiers symbolising sovereignty of dharma |
...
- Parts: vedika, pradakshina, anda, harmika, chhatra
...
1. **(UPSC Prelims 2018 — pattern)** The hemispherical part of a stupa is called:

   A. Harmika  B. Anda  C. Medhi  D. Torana  
   → **B — Anda** = dome. Harmika = railing on top; Torana = gateway.

2. **(UPSC Prelims 2016 — pattern)** Dhamek Stupa is at:

   A. Kushinagar  B. Sarnath  C. Bodh Gaya  D. Lumbini  
   → **B — Sarnath, UP** (first sermon).

### Examples (3.9)

| Example | Detail |
|---------|--------|
| **Great Stupa, Sanchi** | Toranas, UNESCO, Mauryan-Shunga |
| **Dhamek Stupa, Sarnath, UP** | Cylindrical mass; first sermon memorial |
| **Amaravati Stupa, AP** | Nagarjunakonda-Amaravati school reliefs |
...
| Term | Meaning |
|------|---------|
| **Chaitya hall** | Rock-cut or structural **Buddhist prayer hall** with **apse** at one end containing stupa/object of worship |
| **Apse** | Semicircular/circular end of chaitya where **stupa shrine** stands — focus of congregation |
| **Wooden imitation** | Rock-cut chaityas replicate timber architecture — ribbed vault, horseshoe window |
...
- Chaitya = prayer hall + apse stupa
- Karla = largest rock-cut chaitya (Maharashtra)
- Horseshoe window above entrance (gavaksha)
- Nave + aisles with stone columns
- Ceiling ribs imitate wooden architecture
- Ajanta 9, 10, 19, 26 = chaitya caves
- Bhaja, Bedsa = early chaitya examples
- Mahayana chaitya adds Buddha image in apse
- Western Ghats basalt = primary rock-cut zone
- Different function from solid stupa mound

### PYQs — Chaitya

1. **(UPSC Prelims 2019 — pattern)** Karla caves are famous for:

   A. Jain basadi  B. Buddhist chaitya hall  C. Hindu temple  D. Mughal tomb  
   → **B — Buddhist chaitya** (largest rock-cut example).

2. **(UPSC Prelims 2015 — pattern)** Which Ajanta caves are chaitya halls?

   A. 1–5  B. 9, 10, 19, 26  C. 16–20  D. 21–25  
   → **B — 9, 10, 19, 26** are chaityas; 1–20 mostly viharas with paintings.

### Examples (3.10)

| Example | Detail |
|---------|--------|
| **Karla Chaitya, Lonavala** | Largest chaitya; lion capitals |
| **Ajanta Cave 26** | Mahayana chaitya with Buddha image |
| **Bhaja Caves** | Early chaitya, Pune district |
...
| Term | Meaning |
|------|---------|
| **Vihara** | Buddhist **monastery** — residential cells for monks arranged around **open courtyard** |
| **Mahavihara** | Large monastery-university complex (Nalanda, Vikramashila) — vihara scaled to institutional learning |
| **Rainy-season retreat (vassa)** | Monastic code requiring settled residence — vihara architecture supports 3-month rains retreat |
...
- Vihara = monastery cells around courtyard
...
- Rock-cut viharas have verandah + carved benches
- Destroyed mahaviharas ~12th–13th c. (Khilji invasions)

### PYQs — Vihara

1. **(UPSC Prelims 2020 — pattern)** Ajanta caves were primarily used as:

   A. Hindu temples  B. Buddhist viharas  C. Jain shrines  D. Royal palaces  
   → **B — Buddhist viharas** (monasteries); some chaityas too.

2. **(UPSC Prelims 2017 — pattern)** Nalanda was a:

   A. Stupa  B. Mahavihara  C. Chaitya hall  D. Fort  
   → **B — Mahavihara** (monastic university).

### Examples (3.11)

| Example | Detail |
|---------|--------|
| **Ajanta Cave 17** | Painted vihara — finest murals |
| **Nalanda ruins, Bihar** | Mahavihara layout — cells + monasteries |
| **Ellora Cave 12 (Teen Thal)** | Three-storey Buddhist vihara |

---

## 3.12 Rock-cut Architecture

### Definitions

| Term | Meaning |
|------|---------|
| **Rock-cut architecture** | Structures **carved from living rock** (cliff/basalt hill) — subtractive method (remove stone) vs structural additive building |
| **Monolithic** | Entire structure cut from **single rock mass** — Pallava rathas, Kailasa Ellora |
| **Excavation sequence** | Craftsmen carve from top-down or front-back — no separate foundation needed |
...
- Rock-cut = carved from living rock (subtractive)
- Buddhist belt: Western Ghats (Maharashtra)
- Ajanta + Ellora + Elephanta = Maharashtra rock-cut cluster
- Kailasa Cave 16 Ellora = monolithic Shiva temple, Rashtrakuta
- Pancha Rathas Mahabalipuram = monolithic Pallava
...
1. **(UPSC Prelims 2021 — pattern)** Kailasa temple at Ellora was carved under:

   A. Chalukyas  B. Rashtrakutas  C. Pallavas  D. Cholas  
   → **B — Rashtrakutas** (Krishna I, Cave 16).

2. **(UPSC Prelims 2016 — pattern)** Pancha Rathas are examples of:

   A. Structural temples  B. Rock-cut monolithic temples  C. Stupas  D. Islamic tombs  
   → **B — rock-cut monolithic**, Pallava Mahabalipuram.

### Examples (3.12)

| Example | Detail |
|---------|--------|
| **Kailasa Temple, Ellora** | Monolithic Shiva temple — Rashtrakuta |
| **Pancha Rathas, Mahabalipuram** | Five monolithic Pallava rathas |
| **Karla Chaitya** | Rock-cut Buddhist worship hall |

---

## 3.13 Cave Architecture

### Definitions

| Term | Meaning |
|------|---------|
| **Cave architecture** | Sacred/ residential spaces **excavated in natural rock** — subset of rock-cut tradition with emphasis on **interior chamber planning** |
| **Vihara cave** | Residential monastic cave with cells around courtyard |
| **Chaitya cave** | Worship cave with apse and nave |
...
- Interior columns imitate timber proportions

### PYQs — Cave Architecture

1. **(UPSC Prelims 2019 — pattern)** Ellora caves include monuments of:

   A. Buddhism only  B. Buddhism and Hinduism  C. Buddhism, Hinduism, and Jainism  D. Hinduism only  
   → **C — all three** faiths in 34 caves.

2. **(UPSC Prelims 2014 — pattern)** Ajanta paintings are primarily:

   A. Mughal miniatures  B. Buddhist mural paintings  C. Rajput portraits  D. Frescoes of Ellora  
   → **B — Buddhist murals** in vihara/chaitya caves.

### Examples (3.13)

| Example | Detail |
|---------|--------|
| **Ajanta Cave 1** | Painted vihara — Bodhisattva Padmapani famous |
| **Ellora Cave 16 (Kailasa)** | Hindu monolithic temple cave |
| **Elephanta Cave 1** | Trimurti Mahesh sculpture |

---

## 3.14 Indo-Islamic Architecture

### Definitions

| Term | Meaning |
|------|---------|
| **Indo-Islamic architecture** | Building tradition synthesising **Islamic forms** (arch, dome, minaret, iwan) with **Indian materials and decorative motifs** from Delhi Sultanate onward |
| **Iwan** | Large vaulted **recessed portal** — dominant façade element in Timurid-influenced design |
| **Jali** | Perforated stone/lattice screen — light filtration + privacy; hallmark of Indo-Islamic craft |
...
- Jaunpur Atala Masjid = Sharqi Sultanate **UP**
- Mihrab = Mecca-facing prayer niche
- Jali = perforated stone screen
- Pre-Mughal Indo-Islamic ≠ Mughal garden-tomb style

### PYQs — Indo-Islamic Architecture

1. **(UPSC Prelims 2020 — pattern)** Qutub Minar was begun by:

   A. Iltutmish  B. Qutb-ud-din Aibak  C. Alauddin Khalji  D. Babur  
   → **B — Qutb-ud-din Aibak, 1199**; Iltutmish added storeys.

2. **(UPSC Prelims 2018 — pattern)** Gol Gumbaz is in:

   A. Hyderabad  B. Bijapur  C. Ahmedabad  D. Jaunpur  
   → **B — Bijapur**, Karnataka (Adil Shahi).

### Examples (3.14)

| Example | Detail |
|---------|--------|
| **Qutub Minar, Delhi** | Indo-Islamic minaret — UNESCO 1993 |
| **Atala Masjid, Jaunpur, UP** | Sharqi Sultanate — tall prayer hall |
| **Gol Gumbaz, Bijapur** | Massive dome — whispering gallery |

---

## 3.15 Mughal Architecture

### Definitions

| Term | Meaning |
|------|---------|
| **Mughal architecture** | Imperial Indo-Islamic style (16th–18th c.) combining **Persian planning**, **Indian craftsmanship**, **garden tombs**, **red sandstone + white marble** |
| **Charbagh** | **Four-part walled garden** divided by water channels — symbol of paradise; Mughal tomb setting |
| **Pietra dura** | **Inlaid stone work** — floral motifs in marble (Taj Mahal, Itimad-ud-Daulah) |
...
1. **(UPPCS Prelims 2025 — Q49)** Assertion (A): Mughal Emperor Akbar got the Buland Darwaza constructed at Fatehpur Sikri. Reason (R): Akbar got this monument constructed in memory of the birth of his son Jahangir.  
   → **Ans: C — (A) true, (R) false.** Buland Darwaza commemorates **Gujarat victory**, not Jahangir's birth.

2. **(UPPCS Prelims 2025 — Q57)** Match Mughal emperors to tomb cities: Babur-Kabul | Humayun-Delhi | Jahangir-Lahore | Shah Jahan-Agra.  
   → **Ans: A — 4 3 2 1** (Babur-4 Kabul, Humayun-3 Delhi, Jahangir-2 Lahore, Shah Jahan-1 Agra).

### Examples (3.15)

| Example | Detail |
|---------|--------|
| **Taj Mahal, Agra, UP** | Shah Jahan marble charbagh tomb — UNESCO 1983 |
| **Fatehpur Sikri, UP** | Akbar red sandstone capital — Buland Darwaza |
| **Humayun's Tomb, Delhi** | Proto-Mughal garden tomb — UNESCO 1993 |

---

## 3.16 Ancient Indian Architecture

### Definitions

| Term | Meaning |
|------|---------|
| **Ancient Indian architecture** | Built environment from **Harappan urbanism** through **Mauryan/Gupta** periods — secular + sacred, wood-brick-stone transition |
| **Harappan grid town** | **Orthogonal street layout**, drainage, citadel/lower town — earliest Indian urban architecture |
...
- Harappan: grid cities, brick, covered drains, Great Bath
- Mauryan: Ashoka pillars, polished chunar sandstone
- Barabar caves = earliest rock-cut (Mauryan donation)
- Gupta = structural temple begins (Deogarh)
- Ancient phase = stupa + cave before Hindu shikhara maturity
- Corbel arch (not true arch) in pre-Islamic India
- Alamgirpur UP = IVC site
- Megasthenes describes Mauryan wooden palace Pataliputra
- Bharhut/Sanchi = Shunga stupa art
- Ancient = IVC through Gupta (~1900 BCE–6th c. CE)

### PYQs — Ancient Indian Architecture

1. **(UPSC Prelims 2019 — pattern)** Great Bath is associated with:

   A. Varanasi  B. Mohenjo-daro  C. Pataliputra  D. Ujjain  
   → **B — Mohenjo-daro**, Harappan.

2. **(UPSC Prelims 2016 — pattern)** Ashoka pillars are made of:

   A. Granite  B. Chunar sandstone  C. Marble  D. Basalt  
   → **B — polished Chunar sandstone.**

### Examples (3.16)

| Example | Detail |
|---------|--------|
| **Mohenjo-daro Great Bath** | Harappan ritual tank architecture |
| **Ashoka pillar, Sarnath** | Mauryan polished sandstone — UP |
| **Barabar Caves, Bihar** | Earliest donated rock-cut caves |

---

## 3.17 Medieval Indian Architecture

### Definitions

| Term | Meaning |
|------|---------|
| **Medieval Indian architecture** | **7th–18th c.** built traditions — mature Hindu temple styles, Indo-Islamic Sultanate, Mughal imperial, regional kingdoms |
| **Regional kingdoms** | Vijayanagara, Bahmani, Rajput forts/palaces, Bengal Sultanate — parallel to Mughal narrative |
...
- Bengal Sultanate bangla roof mosques
- Bahmani capitals: Bidar, Gulbarga
- Medieval ends with decline of Mughal central authority (~18th c.)
- UP medieval: Fatehpur Sikri, Jaunpur, Agra Fort, Taj

### PYQs — Medieval Indian Architecture

1. **(UPSC Prelims 2020 — pattern)** Vitthala Temple with stone chariot is at:

   A. Madurai  B. Hampi  C. Thanjavur  D. Konark  
   → **B — Hampi**, Vijayanagara.

2. **(UPSC Prelims 2017 — pattern)** Atala Masjid is in:

   A. Delhi  B. Jaunpur  C. Agra  D. Lucknow  
   → **B — Jaunpur, UP** (Sharqi Sultanate).

### Examples (3.17)

| Example | Detail |
|---------|--------|
| **Vitthala Temple, Hampi** | Vijayanagara medieval — stone chariot |
| **Atala Masjid, Jaunpur, UP** | Sharqi medieval Indo-Islamic |
| **Khajuraho temples** | Chandela medieval Nagara |
...
| Term | Meaning |
|------|---------|
| **Taj Mahal** | Shah Jahan's **marble mausoleum** for **Mumtaz Mahal** (d. 1631) at **Agra** — apex of Mughal funerary architecture |
| **Rauza-i-Munawwara** | "Illumined Tomb" — Persian name for Taj Mahal complex |
...
1. **(UPSC Prelims 2021 — pattern)** Taj Mahal was built by:

   A. Akbar  B. Jahangir  C. Shah Jahan  D. Aurangzeb  
   → **C — Shah Jahan** for Mumtaz Mahal.

2. **(UPSC Prelims 2016 — pattern)** Makrana marble is associated with:

   A. Red Fort  B. Taj Mahal  C. Qutub Minar  D. Konark  
   → **B — Taj Mahal** white marble from Makrana, Rajasthan.

### Examples (3.18)

| Example | Detail |
|---------|--------|
| **Taj Mahal, Agra** | UPPCS UP geography — Yamuna river monument |
| **Itimad-ud-Daulah, Agra** | Proto-marble inlay tomb — "Baby Taj" |
| **Taj Museum, Agra** | Displays construction drawings, inlay samples |
...
| Term | Meaning |
|------|---------|
| **Qutub Minar** | **73 m** tapering victory tower in **Qutub complex, Mehrauli, Delhi** — Indo-Islamic minaret icon |
| **Qutub complex** | UNESCO site including **Quwwat-ul-Islam Mosque**, **Iron Pillar**, **Alai Darwaza** |
...
1. **(UPSC Prelims 2020 — pattern)** Iron Pillar at Mehrauli belongs to:

   A. Mauryan  B. Gupta  C. Kushana  D. Sultanate  
   → **B — Gupta period** (4th c. CE inscription).

2. **(UPSC Prelims 2018 — pattern)** Qutub Minar was constructed by:

   A. Only Iltutmish  B. Qutb-ud-din Aibak and Iltutmish  C. Alauddin Khalji  D. Firoz Shah Tughlaq alone  
   → **B — Aibak began, Iltutmish continued**; Tughlaq repaired.

### Examples (3.19)

| Example | Detail |
|---------|--------|
| **Qutub Minar, Delhi** | Indo-Islamic minaret — NOT in UP |
| **Iron Pillar, Qutub complex** | Gupta metallurgy in Sultanate mosque |
| **Alai Darwaza** | True dome introduction |

---

## 3.20 Konark Sun Temple

### Definitions

| Term | Meaning |
|------|---------|
| **Konark Sun Temple** | **13th c.** Odisha **Nagara rekha** temple designed as colossal **stone chariot of Surya** — UNESCO WH |
| **Natyamandapa** | Dance hall of Konark — elaborate carving platform |
...
### PYQs — Konark Sun Temple

1. **(UPSC Prelims 2019 — pattern)** Konark Sun Temple was built by:

   A. Rajaraja I  B. Narasimhadeva I  C. Krishnadevaraya  D. Chandela ruler  
   → **B — Narasimhadeva I**, Ganga dynasty.

2. **(UPSC Prelims 2015 — pattern)** Konark temple is dedicated to:

   A. Shiva  B. Vishnu  C. Surya  D. Jagannath  
   → **C — Surya** (Sun).
...
| Example | Detail |
|---------|--------|
| **Konark Sun Temple** | Chariot-form Nagara — 24 wheels |
| **Lingaraj Temple, Bhubaneswar** | Same Odisha Nagara school |
| **Jagannath Puri** | Eastern Odisha temple cluster |

---

## 3.21 Khajuraho Group of Monuments

### Definitions

| Term | Meaning |
|------|---------|
| **Khajuraho** | **Chandela dynasty** temple group (10th–11th c.) in **Madhya Pradesh** — Nagara sandstone shikhara cluster |
| **Kandariya Mahadeva** | Largest Khajuraho temple — Shiva, ~900 sculptures |
...
- Western (Hindu) + Eastern (Jain) groups
- UNESCO **1986**
- Mithuna sculpture famous but minority of panels
- Lakshmana + Vishvanatha key temples
- Chausath Yogini = circular earliest shrine

### PYQs — Khajuraho

1. **(UPSC Prelims 2020 — pattern)** Khajuraho temples are in:

   A. Uttar Pradesh  B. Madhya Pradesh  C. Rajasthan  D. Gujarat  
   → **B — Madhya Pradesh.**

2. **(UPSC Prelims 2014 — pattern)** Khajuraho was built by:

   A. Pallavas  B. Cholas  C. Chandelas  D. Chalukyas  
   → **C — Chandela** dynasty.
...
| Example | Detail |
|---------|--------|
| **Kandariya Mahadeva** | Tallest Khajuraho shikhara |
| **Lakshmana Temple** | Vaishnava Chandela patronage |
| **Parsvanath Temple** | Jain group — eastern Khajuraho |

---

## 3.22 Brihadeeswara Temple

### Definitions

| Term | Meaning |
|------|---------|
| **Brihadeeswara / Brihadisvara** | Chola **Shiva temple** at **Thanjavur, Tamil Nadu** — **Dravida vimana** masterpiece, **1010 CE** |
| **Peruvudaiyar Kovil** | Tamil name — "Great Lord's Temple" |
...
1. **(UPSC Prelims 2021 — pattern)** Brihadeeswara Temple was completed in:

   A. 850 CE  B. 1010 CE  C. 1250 CE  D. 1500 CE  
   → **B — 1010 CE**, Rajaraja I.

2. **(UPSC Prelims 2018 — pattern)** Great Living Chola Temples UNESCO site includes:

   A. Khajuraho  B. Brihadeeswara  C. Konark  D. Hampi  
   → **B — Brihadeeswara** (+ Gangaikondacholapuram, Darasuram).

### Examples (3.22)

| Example | Detail |
|---------|--------|
| **Brihadeeswara, Thanjavur** | Chola Dravida apex — 1010 CE |
| **Gangaikondacholapuram** | Rajendra I companion Chola temple |
| **Darasuram Airavatesvara** | Later Chola — musical steps |
...
| Term | Meaning |
|------|---------|
| **Sanchi Stupa (Stupa 1)** | **Great Stupa** at **Sanchi, MP** — Mauryan origin, Shunga enlargement, **four toranas** |
| **Torana** | Ceremonial gateway with triple architraves — rich narrative sculpture |
...
1. **(UPSC Prelims 2019 — pattern)** Sanchi Stupa is in:

   A. Uttar Pradesh  B. Madhya Pradesh  C. Bihar  D. Maharashtra  
   → **B — Madhya Pradesh.**

2. **(UPSC Prelims 2016 — pattern)** Toranas at Sanchi depict:

   A. Mughal court scenes  B. Jataka stories  C. Rajput battles  D. Harappan seals  
   → **B — Jataka stories** and Buddha life aniconically.

### Examples (3.23)

| Example | Detail |
|---------|--------|
| **Great Stupa, Sanchi** | Toranas — UNESCO 1989 |
| **Dhamek Stupa, Sarnath, UP** | Contrast — first sermon site in UP |
| **Bharhut Stupa remains** | Related Shunga railing art (MP museum) |
...
| Term | Meaning |
|------|---------|
| **Mahabalipuram (Mamallapuram)** | **Pallava** port city **Tamil Nadu coast** — rock-cut rathas, Shore Temple, UNESCO |
| **Pancha Rathas** | Five monolithic rock-cut temples named after Pandavas |
...
1. **(UPSC Prelims 2021 — pattern)** Shore Temple is at:

   A. Mamallapuram  B. Kanchipuram  C. Madurai  D. Rameswaram  
   → **A — Mamallapuram (Mahabalipuram).**

2. **(UPSC Prelims 2017 — pattern)** Arjuna's Penance is a:

   A. Mughal miniature  B. Rock relief  C. Stupa  D. Mosque façade  
   → **B — open-air rock relief** at Mahabalipuram.

### Examples (3.24)

| Example | Detail |
|---------|--------|
| **Pancha Rathas** | Monolithic Pallava five temples |
| **Shore Temple** | Structural Dravida on Bay of Bengal |
| **Arjuna's Penance** | Giant narrative rock relief |
...
| Term | Meaning |
|------|---------|
| **Ajanta** | **30 Buddhist caves** (2nd c. BCE–6th c. CE) with **mural paintings** + vihara/chaitya — Aurangabad, Maharashtra |
| **Ellora** | **34 caves** (5th–11th c.) — **Buddhist, Hindu, Jain** — includes monolithic **Kailasa** |
...
1. **(UPSC Prelims 2020 — pattern)** Kailasa temple is at:

   A. Ajanta  B. Ellora  C. Elephanta  D. Badami  
   → **B — Ellora Cave 16.**

2. **(UPSC Prelims 2016 — pattern)** Ajanta caves are famous for:

   A. Mughal architecture  B. Buddhist paintings  C. Jain bronzes  D. Rajput miniatures  
   → **B — Buddhist mural paintings.**

### Examples (3.25)

| Example | Detail |
|---------|--------|
| **Ajanta Cave 1** | Padmapani Bodhisattva painting |
| **Ellora Cave 16 (Kailasa)** | Monolithic Shiva temple |
| **Ellora Cave 32 (Indra Sabha)** | Jain lotus ceiling |

---

## 3.26 Elephanta Caves

### Definitions

| Term | Meaning |
|------|---------|
| **Elephanta Caves** | **Shaiva rock-cut** complex on **Gharapuri island**, Mumbai harbour — **Trimurti Shiva** masterpiece |
| **Trimurti (Maheshmurti)** | **6 m** three-faced Shiva sculpture — Creator-Preserver-Destroyer aspects |
...
1. **(UPSC Prelims 2019 — pattern)** Trimurti sculpture is at:

   A. Ellora  B. Elephanta  C. Ajanta  D. Mahabalipuram  
   → **B — Elephanta Cave 1.**

2. **(UPSC Prelims 2015 — pattern)** Elephanta Caves are located near:

   A. Chennai  B. Mumbai  C. Kolkata  D. Goa  
   → **B — Mumbai harbour** (Gharapuri island).

### Examples (3.26)

| Example | Detail |
|---------|--------|
| **Trimurti, Elephanta Cave 1** | Iconic three-faced Shiva |
| **Ardhanarishvara panel, Elephanta** | Shiva-Shakti unity sculpture |
| **Kailasa, Ellora** | Contrast — monolithic temple not cave hall relief |

---

## Consolidated Reference — Everything in One Place

### Temple Style — Master Comparison

| Feature | Nagara | Dravida | Vesara |
|---------|--------|---------|--------|
| **Region** | North/Central/Odisha | Tamil Nadu, AP, Kerala | Karnataka/Deccan |
| **Tower** | Curvilinear **shikhara** | Pyramidal **vimana** | Hybrid staggered tower |
| **Gateway** | Minor/no gopuram | Monumental **gopuram** | Moderate gopuram |
| **Plan** | Linear axial | Concentric prakaras | Star-shaped (Hoysala) |
| **Material** | Sandstone common | Granite (Chola) | Soapstone (Hoysala) |
| **Examples** | Khajuraho, Konark | Brihadeeswara, Shore Temple | Belur, Pattadakal |

### Buddhist Architectural Forms — Comparison

| Form | Function | Structure | Key Example |
|------|----------|-----------|-------------|
| **Stupa** | Relic worship, pradakshina | Solid mound + torana | Sanchi Great Stupa |
| **Chaitya** | Congregational prayer | Rock-cut hall + apse stupa | Karla, Ajanta 26 |
| **Vihara** | Monastic residence | Cells around courtyard | Ajanta 17, Nalanda |

### UNESCO World Heritage — Architecture Sites (Exam List)

| Site | State | Style/Type | WH Year |
|------|-------|------------|---------|
| **Taj Mahal** | UP (Agra) | Mughal tomb | 1983 |
| **Agra Fort** | UP | Mughal fort | 1983 |
| **Fatehpur Sikri** | UP | Mughal city | 1986 |
| **Ajanta Caves** | Maharashtra | Buddhist cave | 1983 |
| **Ellora Caves** | Maharashtra | Buddhist/Hindu/Jain | 1986 |
| **Elephanta Caves** | Maharashtra | Shaiva rock-cut | 1987 |
| **Khajuraho** | MP | Nagara temples | 1986 |
| **Konark Sun Temple** | Odisha | Nagara chariot | 1984 |
| **Mahabalipuram** | Tamil Nadu | Pallava rock/structural | 1984 |
| **Brihadeeswara (Chola Temples)** | Tamil Nadu | Dravida | 1987 |
| **Hampi** | Karnataka | Vijayanagara | 1986 |
| **Pattadakal** | Karnataka | Vesara | 1987 |
| **Sanchi** | MP | Buddhist stupa | 1989 |
| **Qutub Minar complex** | Delhi | Indo-Islamic | 1993 |
| **Humayun's Tomb** | Delhi | Mughal garden tomb | 1993 |

### Mughal Tombs — Location Table (UPPCS 2025 Q57)

| Emperor | Tomb Location | City Code |
|---------|---------------|-----------|
| **Babur** | Kabul (Afghanistan) | 4 |
| **Humayun** | Delhi | 3 |
| **Jahangir** | Lahore (Pakistan) | 2 |
| **Shah Jahan** | Agra (UP) | 1 |

### Important Dates — Architecture

| Date/Year | Event |
|-----------|-------|
| **3rd c. BCE** | Ashoka enlarges Sanchi Stupa |
| **1st c. BCE** | Sanchi toranas carved |
| **1010 CE** | Brihadeeswara Temple completed (Rajaraja I) |
| **~1250 CE** | Konark Sun Temple (Narasimhadeva I) |
| **1199** | Qutub Minar construction begins (Aibak) |
| **1576–77** | Buland Darwaza (Gujarat victory) |
| **1632–53** | Taj Mahal construction |
| **1983** | Taj Mahal + Ajanta UNESCO |
| **1984** | Konark + Mahabalipuram UNESCO |
| **1986** | Khajuraho + Ellora + Fatehpur Sikri UNESCO |
| **1987** | Brihadeeswara + Elephanta UNESCO |
| **1989** | Sanchi UNESCO |
| **1993** | Qutub complex + Humayun's Tomb UNESCO |

### UP Focus — Indian Architecture

| Element | UP Detail |
|---------|-----------|
| **Mughal monuments** | Taj Mahal, Agra Fort, Fatehpur Sikri, Buland Darwaza, Sikandra (Akbar tomb), Itimad-ud-Daulah |
| **Buddhist UP** | **Sarnath Dhamek Stupa** (first sermon); Kushinagar Mahaparinirvana stupa |
| **Gupta temple UP** | **Dashavatara Temple, Deogarh** (Lalitpur district) |
| **Indo-Islamic UP** | **Atala Masjid, Jaunpur** (Sharqi Sultanate) |
| **NOT in UP traps** | Qutub Minar (Delhi), Khajuraho (MP), Sanchi (MP), Konark (Odisha), Ajanta/Ellora (Maharashtra) |
| **ASI circles** | Agra Circle (Taj, Sikri), Lucknow Circle (Sarnath, Jaunpur) |
| **HRIDAY heritage city** | Varanasi — ghats + religious architecture |
| **River alignment** | Taj on Yamuna; Varanasi ghats on Ganga |
| **Chunar fort** | Sandstone quarry tradition — Mughal building material source |
...
**Q1.** With reference to Indian temple architecture, which statements is/are correct?
...
**Ans: C** — Both correct. Nagara = shikhara (north); Dravida = gopuram (south).

</details>

---

**Q2.** Assertion (A): Buland Darwaza at Fatehpur Sikri was built by Akbar. Reason (R): It commemorates the birth of Jahangir.
...
**Ans: C** — UPPCS 2025 Q49 pattern. Buland Darwaza = **Gujarat victory**, not Jahangir birth.
...
**Ans: A** — UPPCS 2025 Q57: Babur-4 Kabul, Humayun-3 Delhi, Jahangir-2 Lahore, Shah Jahan-1 Agra.

</details>

---

**Q4.** With reference to Buddhist architecture, which statements is/are correct?

1. Stupa is a solid relic mound.  
2. Vihara is a prayer hall with apse.
...
**Ans: A** — Stupa = solid mound (true). Vihara = monastery, NOT prayer hall (chaitya = prayer hall).
...
1. Konark — Dravida style  
2. Khajuraho — Chandela dynasty  
3. Brihadeeswara — Rajaraja I

Options: A. Only 1  B. 1 and 2  C. 2 and 3  D. Only 2

<details>
<summary>Show answer</summary>

**Ans: A** — Only pair 1 wrong. Konark = **Nagara** (Odisha), not Dravida.

</details>

---

**Q6.** With reference to Ajanta and Ellora, which statements is/are correct?

1. Ajanta is primarily famous for Buddhist paintings.  
2. Ellora has caves of Buddhism, Hinduism, and Jainism.
...
**Ans: C** — Both correct. Trap: swapping Ajanta sculpture focus with Ellora paintings.

</details>

---

**Q7.** Assertion (A): Qutub Minar was begun by Qutb-ud-din Aibak. Reason (R): Iltutmish completed additional storeys of the minar.
...
**Ans: A** — Both true but R does not explain A (sequential builders, not cause-effect). Some papers accept A; UPPCS standard = both true, R not explanation of why Aibak began it.

</details>

---

**Q8.** Which monuments are located in Uttar Pradesh?

1. Taj Mahal  2. Qutub Minar  3. Fatehpur Sikri  4. Khajuraho

Options: A. 1 and 3  B. 1, 2 and 3  C. 2 and 4  D. 1, 3 and 4

<details>
<summary>Show answer</summary>

**Ans: A** — Taj + Fatehpur Sikri in UP. Qutub = Delhi; Khajuraho = MP.
...
List-I: A. Sanchi  B. Sarnath  C. Deogarh  D. Jaunpur  
List-II: 1. Gupta temple  2. Dhamek Stupa  3. Great Stupa toranas  4. Atala Masjid

Options: A. 3 2 1 4  B. 2 3 1 4  C. 3 1 2 4  D. 1 3 2 4

<details>
<summary>Show answer</summary>

**Ans: A** — Sanchi-3, Sarnath-2, Deogarh-1, Jaunpur-4.

</details>

---

**Q10.** With reference to rock-cut architecture, which statements is/are correct?

1. Kailasa temple at Ellora is monolithic.  
2. Pancha Rathas at Mahabalipuram are structural temples.
...
**Ans: A** — Kailasa monolithic = true. Pancha Rathas = **rock-cut monolithic**, not structural.

</details>

---

**Q11.** Which is/are correctly matched?

1. Elephanta — Trimurti Shiva  
2. Karla — Buddhist chaitya  
3. Belur — Hoysala Vesara
...
**Ans: C** — All three pairs correct.

</details>

---

**Q12.** Brihadeeswara Temple was built in:

Options: A. 850 CE  B. 1010 CE  C. 1250 CE  D. 1576 CE

<details>
<summary>Show answer</summary>

**Ans: B** — 1010 CE by Rajaraja I. 1250 = Konark; 1576 = Buland Darwaza.

</details>

---

**Q13.** With reference to Mughal architecture, which statements is/are correct?

1. Taj Mahal uses Makrana marble.  
2. Humayun's Tomb is the earliest major charbagh garden tomb in India.
...
**Q14.** Assertion (A): Konark Sun Temple is an example of Nagara architecture. Reason (R): It was built by the Chola ruler Rajaraja I.
...
**Ans: C** — Nagara = true. Builder = **Narasimhadeva I (Ganga)**, not Rajaraja Chola.

</details>

---

**Q15.** Which chaitya caves are at Ajanta?

Options: A. 1–5  B. 9, 10, 19, 26  C. 16–20  D. 30–34

<details>
<summary>Show answer</summary>

**Ans: B** — Ajanta chaityas = 9, 10, 19, 26. 30–34 = Jain Ellora.

</details>

---

**Q16.** With reference to Indo-Islamic architecture, which statements is/are correct?

1. Qutub Minar is approximately 72.5 metres high.  
2. Gol Gumbaz is in Bijapur.
...
List-I: A. Vesara  B. Nagara  C. Dravida  D. Indo-Islamic  
List-II: 1. Brihadeeswara  2. Belur  3. Khajuraho  4. Qutub Minar

Options: A. 2 3 1 4  B. 3 2 1 4  C. 2 1 3 4  D. 3 2 4 1

<details>
<summary>Show answer</summary>

**Ans: B** — Vesara-Belur(2), Nagara-Khajuraho(3), Dravida-Brihadeeswara(1), Indo-Islamic-Qutub(4).

</details>

---

**Q18.** Which stupa is at Sarnath, Uttar Pradesh?

Options: A. Great Stupa  B. Dhamek Stupa  C. Amaravati Stupa  D. Bharhut Stupa

<details>
<summary>Show answer</summary>

**Ans: B** — Dhamek Stupa marks first sermon site. Great Stupa = Sanchi.

</details>

---

**Q19.** With reference to Gupta architecture, which statements is/are correct?

1. Dashavatara Temple is at Deogarh, UP.  
2. Gupta period marks the beginning of structural stone temples.
...
**Q20.** Which UNESCO World Heritage Sites are in Maharashtra?

1. Ajanta  2. Ellora  3. Konark  4. Elephanta

Options: A. 1, 2 and 4  B. 1 and 2  C. 2 and 3  D. 1, 3 and 4

<details>
<summary>Show answer</summary>

**Ans: A** — Ajanta, Ellora, Elephanta in Maharashtra. Konark = Odisha.

</details>

---

**Q21.** Assertion (A): Shore Temple at Mahabalipuram is a structural Dravida temple. Reason (R): It was built by the Pallava dynasty.
...
**Ans: A** — Both true; Pallava patronage explains Shore Temple's Dravida coastal form.

</details>

---

**Q22.** Parts of a stupa include:

Options: A. Anda, Harmika, Chhatra  B. Gopuram, Vimana, Mandapa  C. Mihrab, Minbar, Iwan  D. Torana only

<details>
<summary>Show answer</summary>

**Ans: A** — Stupa parts. B = temple; C = mosque; D incomplete.

</details>

---

**Q23.** With reference to medieval architecture, which statements is/are correct?

1. Vitthala Temple stone chariot is at Hampi.  
2. Atala Masjid is in Jaunpur, UP.
...
**Ans: C** — Both correct — Vijayanagara + Sharqi UP.

</details>

---

**Q24.** Kailasa temple was carved under which dynasty?

Options: A. Pallava  B. Rashtrakuta  C. Chola  D. Chandela

<details>
<summary>Show answer</summary>

**Ans: B** — Rashtrakuta Krishna I, Ellora Cave 16.
...
1. Iron Pillar — Gupta period  
2. Khajuraho — Uttar Pradesh  
3. Panchayatana — five-shrine plan
...
**Ans: A** — Khajuraho is in **MP**, not UP.

</details>

---

**Q26.** With reference to cave architecture, which statements is/are correct?

1. Ajanta has 30 caves.  
2. Ellora Cave 16 is called Kailasa.
...
List-I: A. 1983  B. 1984  C. 1986  D. 1989  
List-II: 1. Sanchi  2. Taj Mahal  3. Konark  4. Khajuraho
...
**Ans: A** — 1983-Taj(2), 1984-Konark(3), 1986-Khajuraho(4), 1989-Sanchi(1).

</details>

---

**Q28.** Assertion (A): Elephanta Caves are primarily Buddhist. Reason (R): The Trimurti sculpture depicts Shiva.
...
**Ans: B** — Elephanta = **Shaiva**, not Buddhist. R about Shiva is true but A is false.

</details>

---

**Q29.** With reference to temple components, which statements is/are correct?

1. Garbhagriha is the sanctum sanctorum.  
2. Pradakshina patha means clockwise circumambulation.
...
**Q30.** Hoysala temples are examples of:

Options: A. Nagara  B. Dravida  C. Vesara  D. Indo-Islamic

<details>
<summary>Show answer</summary>

**Ans: C** — Hoysala = Vesara sub-school (Belur, Halebidu).

</details>

---

**Q31.** Which monument was built by Narasimhadeva I?

Options: A. Brihadeeswara  B. Konark Sun Temple  C. Kandariya Mahadeva  D. Shore Temple

<details>
<summary>Show answer</summary>

**Ans: B** — Narasimhadeva I (Ganga) = Konark. Others = Rajaraja, Chandela, Pallava.

</details>

---

**Q32.** With reference to ancient architecture, which statements is/are correct?

1. Harappan cities had grid-planned streets.  
2. Ashoka pillars are made of polished sandstone.
...
List-I: A. Chaitya  B. Vihara  C. Stupa  D. Charbagh  
List-II: 1. Monastery  2. Four-part garden  3. Prayer hall  4. Relic mound

Options: A. 3 1 4 2  B. 3 4 1 2  C. 4 1 3 2  D. 3 1 2 4

<details>
<summary>Show answer</summary>

**Ans: A** — Chaitya-3 (prayer hall), Vihara-1 (monastery), Stupa-4 (relic mound), Charbagh-2 (four-part garden).

</details>

---

**Q34.** Taj Mahal was built during the reign of:
...
**Ans: C** — Shah Jahan, 1632–53.

</details>

---

**Q35.** With reference to Pallava architecture, which statements is/are correct?

1. Pancha Rathas are monolithic.  
2. Arjuna's Penance is a rock relief at Mahabalipuram.
...
**Q36.** Which is NOT a Chola temple?

Options: A. Brihadeeswara  B. Gangaikondacholapuram  C. Konark  D. Darasuram

<details>
<summary>Show answer</summary>

**Ans: C** — Konark = Ganga dynasty Odisha Nagara.

</details>

---

**Q37.** Assertion (A): Sanchi Great Stupa has four toranas. Reason (R): Toranas were added in the 1st century BCE.
...
**Ans: A** — Four toranas added ~1st c. BCE explains their presence.

</details>

---

**Q38.** Quwwat-ul-Islam Mosque is part of:

Options: A. Taj complex  B. Qutub complex  C. Fatehpur Sikri  D. Red Fort

<details>
<summary>Show answer</summary>

**Ans: B** — Qutub complex, Mehrauli, Delhi.

</details>

---

**Q39.** With reference to Vesara style, which statements is/are correct?

1. Pattadakal is a UNESCO site in Karnataka.  
2. Vesara is a pure form of Nagara without Dravida elements.
...
**Ans: A** — Pattadakal correct. Vesara = **hybrid**, not pure Nagara.

</details>

---

**Q40.** Which Buddhist site is in Uttar Pradesh?

Options: A. Sanchi  B. Ajanta  C. Sarnath  D. Karla

<details>
<summary>Show answer</summary>

**Ans: C** — Sarnath UP. Sanchi MP; Ajanta/Karla Maharashtra.
...
List-I: A. Shah Jahan  B. Akbar  C. Qutb-ud-din Aibak  D. Rajaraja I  
List-II: 1. Qutub Minar begun  2. Taj Mahal  3. Brihadeeswara  4. Buland Darwaza

Options: A. 2 4 1 3  B. 3 2 1 4  C. 2 4 3 1  D. 4 2 1 3

<details>
<summary>Show answer</summary>

**Ans: A** — Shah Jahan-2 (Taj), Akbar-4 (Buland Darwaza), Aibak-1 (Qutub), Rajaraja-3 (Brihadeeswara).

</details>

---

**Q42.** With reference to Khajuraho, which statements is/are correct?

1. Temples were built by the Chandela dynasty.  
2. Khajuraho is in Madhya Pradesh.
...
**Ans: C** — Both correct. UP trap = MP location.

</details>

---

**Q43.** The hemispherical part of a stupa is called:

Options: A. Harmika  B. Anda  C. Torana  D. Medhi

<details>
<summary>Show answer</summary>

**Ans: B** — Anda = dome. Harmika = railing on top; Torana = gateway.

</details>

---

**Q44.** Assertion (A): Fatehpur Sikri was built by Akbar. Reason (R): It is a UNESCO World Heritage Site inscribed in 1986.
...
**Ans: A** — Akbar built Sikri (true); WH 1986 (true) but WH status doesn't explain why Akbar built it.

</details>

---

**Q45.** Which monuments are examples of rock-cut architecture?

1. Ajanta  2. Taj Mahal  3. Ellora  4. Elephanta

Options: A. 1, 3 and 4  B. 1 and 2  C. 2 and 3  D. 1, 2, 3 and 4

<details>
<summary>Show answer</summary>

**Ans: A** — Ajanta, Ellora, Elephanta = rock-cut. Taj = structural Mughal marble.
...
**Q1. UPPCS Prelims 2025 — Mughal Architecture (Q49)**
...
**Ans: C** — A true (Akbar built Buland Darwaza). R false — commemorates **Gujarat victory 1576–77**, not Jahangir's birth.

</details>

---

**Q2. UPPCS Prelims 2025 — Mughal Tombs (Q57)**

Match List-I with List-II and select the correct answer using the code given below the lists.

List-I (Emperor): A. Babur  B. Humayun  C. Jahangir  D. Shah Jahan  
List-II (City where tomb is situated): 1. Agra  2. Lahore  3. Delhi  4. Kabul
...
**Ans: A** — Babur-4 Kabul, Humayun-3 Delhi, Jahangir-2 Lahore, Shah Jahan-1 Agra.

</details>

---

**Q3. UPSC Prelims 2021 — pattern**

Brihadeeswara Temple was built by:

Options: A. Rajaraja I  B. Rajendra I  C. Krishnadevaraya  D. Narasimhadeva I

<details>
<summary>Show answer</summary>

**Ans: A** — Rajaraja I, Chola, 1010 CE. Narasimhadeva = Konark.
...
Kailasa temple is located at:

Options: A. Ajanta  B. Ellora  C. Elephanta  D. Mahabalipuram

<details>
<summary>Show answer</summary>

**Ans: B** — Ellora Cave 16, Rashtrakuta monolithic temple.

</details>

---

**Q5. UPSC Prelims 2020 — pattern**

Which Buddhist architectural form is used for monastic residence?

Options: A. Stupa  B. Chaitya  C. Vihara  D. Torana

<details>
<summary>Show answer</summary>

**Ans: C** — Vihara = monastery. Chaitya = prayer hall; Stupa = relic mound.
...
Konark Sun Temple is an example of:

Options: A. Dravida  B. Nagara  C. Vesara  D. Gopuram style

<details>
<summary>Show answer</summary>

**Ans: B** — Nagara (Odisha rekha deul). Geographic south ≠ Dravida style.
...
Trimurti sculpture is located at:

Options: A. Ellora  B. Elephanta  C. Ajanta  D. Badami

<details>
<summary>Show answer</summary>

**Ans: B** — Elephanta Cave 1, Mumbai harbour.
...
Options: A. Kanchipuram  B. Mahabalipuram  C. Thanjavur  D. Madurai

<details>
<summary>Show answer</summary>

**Ans: B** — Mamallapuram (Mahabalipuram), Pallava Dravida.

</details>

---

**Q9. UPSC Prelims 2018 — pattern**

The hemispherical part of a stupa is called:

Options: A. Harmika  B. Anda  C. Medhi  D. Torana

<details>
<summary>Show answer</summary>

**Ans: B** — Anda = dome body of stupa.
...
Hoysala temples are known for:

Options: A. Curvilinear shikhara in sandstone  B. Star-shaped plan in soapstone  C. Gopuram taller than vimana  D. Rock-cut chaitya halls

<details>
<summary>Show answer</summary>

**Ans: B** — Hoysala Vesara — star-shaped plan, soapstone carving.
...
Pancha Rathas are examples of:

Options: A. Structural temples  B. Rock-cut monolithic temples  C. Stupas  D. Islamic tombs

<details>
<summary>Show answer</summary>

**Ans: B** — Pallava monolithic rock-cut rathas, Mahabalipuram.
...
Options: A. Cholas  B. Chalukyas  C. Chandelas  D. Pallavas

<details>
<summary>Show answer</summary>

**Ans: C** — Chandela dynasty, 10th–11th c., MP.
...
| Trap | Correct answer |
|------|----------------|
| Konark = Dravida style? | **NO** — **Nagara** (Odisha rekha deul) |
| Khajuraho in UP? | **NO** — **Madhya Pradesh** (Chhatarpur) |
| Qutub Minar in UP? | **NO** — **Delhi** (Mehrauli) |
| Sanchi in UP? | **NO** — **Madhya Pradesh** — **Sarnath Dhamek = UP** |
| Buland Darwaza for Jahangir's birth? | **NO** — **Gujarat victory 1576–77** (UPPCS 2025) |
| Brihadeeswara built by Narasimhadeva? | **NO** — **Rajaraja I, 1010 CE** |
| Konark built by Rajaraja Chola? | **NO** — **Narasimhadeva I (Ganga)** |
| Taj Mahal built by Akbar? | **NO** — **Shah Jahan, 1632–53** |
| Vihara = prayer hall? | **NO** — **Chaitya = prayer hall; Vihara = monastery** |
| Stupa = hollow worship hall? | **NO** — **Solid relic mound** — chaitya is the hall |
| Pancha Rathas = structural temples? | **NO** — **Monolithic rock-cut** |
| Elephanta = Buddhist caves? | **NO** — **Shaiva** (Trimurti Shiva) |
| Ajanta = three-religion caves like Ellora? | **NO** — **Ajanta = Buddhist only** |
| Iron Pillar = Sultanate? | **NO** — **Gupta period** (4th c. CE) |
| Qutub Minar built only by Iltutmish? | **NO** — **Aibak began 1199; Iltutmish added storeys** |
| Vesara = pure Nagara? | **NO** — **Hybrid Nagara-Dravida** (Karnataka) |
| Deogarh temple in MP? | **NO** — **Deogarh, Lalitpur district, UP** |
| Gopuram = Nagara feature? | **NO** — **Dravida gateway tower** — Nagara uses shikhara |
| Khajuraho built by Cholas? | **NO** — **Chandela dynasty** |
| Mughal tomb of Babur in Agra? | **NO** — **Kabul** (UPPCS 2025 tomb matching) |
